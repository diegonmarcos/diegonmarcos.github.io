...
# ║                                                                  ║
# ║   Source : 1_cicd/src/scripts/front-sw-init.sh
...
#      (9_others/src/templates/script-service-worker.ts)
...
TEMPLATE="$REPO_ROOT/9_others/src/templates/script-service-worker.ts"
