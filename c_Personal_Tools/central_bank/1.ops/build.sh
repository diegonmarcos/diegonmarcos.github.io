...
print_usage() {
    ...
    printf "${BLUE}---------------------------------------------------------------------------${NC}\n"
    printf "  ${CYAN}%-12s${NC}  %-10s  %-10s  %-10s  ${CYAN}%-14s${NC}  ${YELLOW}%s${NC}\n" "CentralBank" "Vanilla" "Tailwind" "TypeScript" "Vite :${PORT}" "HMR"
    printf "${BLUE}---------------------------------------------------------------------------${NC}\n"
    printf "\n"
}
