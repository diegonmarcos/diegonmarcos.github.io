...
step_derive() {
  ...
  local cloud_dist_url="https://raw.githubusercontent.com/diegonmarcos/cloud/main/1_front-configs/dist"
  local cloud_dist_local="$HOME/git/cloud/1_front-configs/dist"
