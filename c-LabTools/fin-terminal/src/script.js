...
(() => {
  ...
  var lightweight_charts_production_exports = {};
  __export(lightweight_charts_production_exports, {
    AreaSeries: () => Ue,
    BarSeries: () => Ye,
    BaselineSeries: () => Fe,
    ...
    createChart: () => ae,
    createChartEx: () => he,
    createImageWatermark: () => mr,
    createOptionsChart: () => Be,
    createSeriesMarkers: () => Lr,
    createTextWatermark: () => _r,
    createUpDownMarkers: () => jr,
    createYieldCurveChart: () => De,
    customSeriesDefaultOptions: () => qr,
    defaultHorzScaleBehavior: () => le,
    isBusinessDay: () => Ki,
    isUTCTimestamp: () => Zi,
    version: () => Yr
  });
  ...
  function f(t, ...i) {
    for (const n of i)
      for (const i2 in n)
        void 0 !== n[i2] && Object.prototype.hasOwnProperty.call(n, i2) && !["__proto__", "constructor", "prototype"].includes(i2) && ("object" != typeof n[i2] || void 0 === t[i2] || Array.isArray(n[i2]) ? t[i2] = n[i2] : f(t[i2], n[i2]));
    return t;
  }
  function p(t) {
  ...
  function M(t) {
    ...
    for (s in n = Array.isArray(i) ? [] : {}, i)
      i.hasOwnProperty(s) && (e2 = i[s], n[s] = e2 && "object" == typeof e2 ? M(e2) : e2);
    return n;
  }
  function g(t) {
    return null !== t;
  ...
  function L(t, i, n, s, e2, r3) {
    t.fillRect(i + r3, n, s - 2 * r3, r3), t.fillRect(i + r3, n + e2 - r3, s - 2 * r3, r3), t.fillRect(i, n, r3, e2), t.fillRect(i + s - r3, n, r3, e2);
  }
  function z(t, i, n, s, e2, r3) {
    t.save(), t.globalCompositeOperation = "copy", t.fillStyle = r3, t.fillRect(i, n, s, e2), t.restore();
  }
  function O(t, i, n, s, e2, r3) {
    t.beginPath(), t.roundRect ? t.roundRect(i, n, s, e2, r3) : (t.lineTo(i + s - r3[1], n), 0 !== r3[1] && t.arcTo(i + s, n, i + s, n + r3[1], r3[1]), t.lineTo(i + s, n + e2 - r3[2]), 0 !== r3[2] && t.arcTo(i + s, n + e2, i + s - r3[2], n + e2, r3[2]), t.lineTo(i + r3[3], n + e2), 0 !== r3[3] && t.arcTo(i, n + e2, i, n + e2 - r3[3], r3[3]), t.lineTo(i, n + r3[0]), 0 !== r3[0] && t.arcTo(i, n, i + r3[0], n, r3[0]));
  }
  function N(t, i, n, s, e2, r3, h2 = 0, a2 = [0, 0, 0, 0], l2 = "") {
    if (t.save(), !h2 || !l2 || l2 === r3)
      return O(t, i, n, s, e2, a2), t.fillStyle = r3, t.fill(), void t.restore();
    const o2 = h2 / 2;
    var _2;
    O(t, i + o2, n + o2, s - h2, e2 - h2, (_2 = -o2, a2.map((t2) => 0 === t2 ? t2 : t2 + _2))), "transparent" !== r3 && (t.fillStyle = r3, t.fill()), "transparent" !== l2 && (t.lineWidth = h2, t.strokeStyle = l2, t.closePath(), t.stroke()), t.restore();
  }
  function F(t, i, n, s, e2, r3, h2) {
    t.save(), t.globalCompositeOperation = "copy";
    const a2 = t.createLinearGradient(0, 0, 0, e2);
    a2.addColorStop(0, r3), a2.addColorStop(1, h2), t.fillStyle = a2, t.fillRect(i, n, s, e2), t.restore();
  }
  function G(t) {
  ...
  function vt(t, i, n, s) {
    const e2 = Number.isFinite(i), r3 = Number.isFinite(n);
    return e2 && r3 ? t(i, n) : e2 || r3 ? e2 ? i : n : s;
  }
  function Tt(t, i, n, s, e2 = 0, r3 = i.length) {
    let h2 = r3 - e2;
    for (; 0 < h2; ) {
      const r4 = h2 >> 1, a2 = e2 + r4;
      s(i[a2], n) === t ? (e2 = a2 + 1, h2 -= r4 + 1) : h2 = r4;
    }
    return e2;
  }
  function Et(t, i) {
  ...
  function Ii(t, i, n, s) {
    let e2 = null;
    for (const r3 of t) {
      let t2 = r3.Qs?.(i, n, s) ?? null;
      if (null === t2) {
        const e3 = r3.Tt(s);
        t2 = null !== e3 && e3.Qs ? e3.Qs(i, n) : null;
      }
      if (null !== t2) {
        const i2 = { gu: r3, Mu: t2 };
  ...
  function Bi(t, i, n) {
    const s = [t, ...t.Dt()].reverse(), e2 = function(t2, i2, n2) {
      ...
      for (const l2 of t2) {
        ...
        for (const i3 of t3) {
          const t4 = Ri(i3);
          h3 = i3.zOrder, a2 = s2?.zOrder, (!a2 || "top" === h3 && "top" !== a2 || "normal" === h3 && "bottom" === a2 || i3.zOrder === s2?.zOrder && void 0 !== e3 && Pi(t4, e3) || i3.zOrder === s2?.zOrder && void 0 === e3) && (s2 = i3, e3 = t4, r4 = l2);
        }
      }
      var h3, a2;
      return s2 && r4 && e3 ? { Mu: e3, bu: s2, lu: r4 } : null;
    }(s, i, n);
    if ("top" === e2?.bu.zOrder)
      return Di(e2);
    let r3 = null, h2 = null;
    for (const a2 of s) {
      if (e2 && e2.lu === a2 && "bottom" !== e2.bu.zOrder && !e2.bu.isBackground)
        return r3 ?? Di(e2);
      if (Vi(a2)) {
        const s2 = Ii(a2.jn(t), i, n, t);
        if (null !== s2) {
          const t2 = { lu: a2, gu: s2.gu, wu: Ti(s2.Mu), mu: s2.Mu.mu, ee: s2.Mu.ee ?? "primitive" };
          (null === r3 || Pi(s2.Mu, h2)) && (r3 = t2, h2 = s2.Mu);
        }
      }
      if (e2 && e2.lu === a2 && "bottom" !== e2.bu.zOrder && e2.bu.isBackground)
        return r3 ?? Di(e2);
    }
    return null !== r3 ? r3 : e2?.bu ? Di(e2) : null;
  }
  function Li(t, i) {
  ...
  function an(t, i) {
    ...
    if (t.getUTCDate() !== i.getUTCDate())
      return 50;
    for (let n = rn.length - 1; n >= 0; --n)
      if (Math.floor(i.getTime() / rn[n].gf) !== Math.floor(t.getTime() / rn[n].gf))
        return rn[n].bf;
    return 0;
  }
  function ln(t) {
  ...
  function Ln(t, i, n, s) {
    if (!t.length)
      return;
    let e2 = 0;
    const r3 = t[0].$t(s, true);
    let h2 = 1 === i ? n / 2 - (t[0].Hi() - r3 / 2) : t[0].Hi() - r3 / 2 - n / 2;
    h2 = Math.max(0, h2);
    for (let r4 = 1; r4 < t.length; r4++) {
      const a2 = t[r4], l2 = t[r4 - 1], o2 = l2.$t(s, false), _2 = a2.Hi(), u2 = l2.Hi();
      if (1 === i ? _2 > u2 - o2 : _2 < u2 + o2) {
        const s2 = u2 - o2 * i;
        a2.Ui(s2);
        const r5 = s2 - i * o2 / 2;
        if ((1 === i ? r5 < 0 : r5 > n) && h2 > 0) {
          const s3 = 1 === i ? -1 - r5 : r5 - n, a3 = Math.min(s3, h2);
          for (let n2 = e2; n2 < t.length; n2++)
            t[n2].Ui(t[n2].Hi() + i * a3);
          h2 -= a3;
        }
      } else
        e2 = r4, h2 = 1 === i ? u2 - o2 - _2 : _2 - (u2 + o2);
    }
  }
  function On(t, i) {
    return t.Ka?.(i) ?? [];
  ...
  function ts(t, i, n, s) {
    const e2 = n.value, r3 = { $n: i, wt: t, Wt: [e2, e2, e2, e2], Qr: s };
    return void 0 !== n.color && (r3.R = n.color), r3;
  }
  function is(t, i, n, s) {
    const e2 = n.value, r3 = { $n: i, wt: t, Wt: [e2, e2, e2, e2], Qr: s };
    return void 0 !== n.lineColor && (r3.vt = n.lineColor), void 0 !== n.topColor && (r3.ah = n.topColor), void 0 !== n.bottomColor && (r3.oh = n.bottomColor), r3;
  }
  function ns(t, i, n, s) {
    const e2 = n.value, r3 = { $n: i, wt: t, Wt: [e2, e2, e2, e2], Qr: s };
    return void 0 !== n.topLineColor && (r3._h = n.topLineColor), void 0 !== n.bottomLineColor && (r3.uh = n.bottomLineColor), void 0 !== n.topFillColor1 && (r3.dh = n.topFillColor1), void 0 !== n.topFillColor2 && (r3.fh = n.topFillColor2), void 0 !== n.bottomFillColor1 && (r3.ph = n.bottomFillColor1), void 0 !== n.bottomFillColor2 && (r3.mh = n.bottomFillColor2), r3;
  }
  function ss(t, i, n, s) {
  ...
  function rs(t, i, n, s, e2) {
    const r3 = _(e2)(n), h2 = Math.max(...r3), a2 = Math.min(...r3), l2 = r3[r3.length - 1], o2 = [l2, h2, a2, l2], { time: u2, color: c2, ...d2 } = n;
  ...
  function ls(t) {
    return (i, n, s, e2, r3, h2) => function(t2, i2) {
      return i2 ? i2(t2) : Jn(t2);
    }(s, h2) ? as({ wt: i, $n: n, Qr: e2 }, s) : as(t(i, n, s, e2, r3), s);
  }
  function os(t) {
  ...
  function bs(t, i, n, s, e2, r3) {
    const h2 = e2 - n, a2 = r3 - s;
    if (0 === h2 && 0 === a2)
      return Math.hypot(t - n, i - s);
  ...
  function ys(t, i, n, s, e2, r3, h2) {
    if (null === i || i.from >= i.to || 0 === t.length)
      return null;
    const a2 = e2 / 2 + r3, l2 = ms(t, n - a2, i.from, i.to), o2 = ws(t, n + a2, l2, i.to);
    if (l2 >= o2)
      return null;
    let _2 = Number.POSITIVE_INFINITY;
    for (let a3 = l2; a3 < o2; a3++) {
      const l3 = t[a3], o3 = a3 > i.from ? t[a3 - 1] : void 0, u2 = a3 < i.to - 1 ? t[a3 + 1] : void 0, c2 = xs(l3, o3, e2) - r3, d2 = Cs(l3, u2, e2) + r3;
      if (n < c2 || n > d2)
        continue;
      h2(l3, Ss);
      const f2 = Ss[0], p2 = Ss[1], v2 = Math.min(f2, p2), m2 = Math.max(f2, p2), w2 = v2 - r3, M2 = m2 + r3;
      if (s >= v2 && s <= m2)
        _2 = Math.min(_2, 0);
      else if (s >= w2 && s <= M2) {
  ...
  function Ts(t, i, n) {
    const s = i.Oa(), e2 = i.bi(), r3 = Rt(t, s, ks), h2 = Dt(t, e2, Ps);
    if (!n)
      return { from: r3, to: h2 };
    let a2 = r3, l2 = h2;
    return r3 > 0 && r3 < t.length && t[r3].wt >= s && (a2 = r3 - 1), h2 > 0 && h2 < t.length && t[h2 - 1].wt <= e2 && (l2 = h2 + 1), { from: a2, to: l2 };
  }
  function Is(t) {
    switch (t) {
      case "point":
  ...
  function _e(t, i, n, s, e2, r3, h2, a2 = 0) {
    ...
    if (s.to - s.from < 2) {
      ...
      for (let h3 = s.from + 1; h3 < s.to; ++h3) {
        v2 = i[h3];
        const s2 = v2._t * o2, a3 = v2.ut * _2, u3 = r3(t, v2);
        switch (n) {
          case 0:
          ...
          case 2: {
            const [t2, n2] = fe(i, h3 - 1, h3), r4 = t2._t * o2, u4 = t2.ut * _2, c3 = n2._t * o2, d3 = n2.ut * _2;
            if (l2.bezierCurveTo(r4, u4, c3, d3, s2, a3), e3) {
              const t3 = i[h3 - 1], n3 = t3._t * o2, e4 = t3.ut * _2, l3 = oe(n3, e4, s2, a3), p3 = oe(n3, e4, r4, u4) + oe(r4, u4, c3, d3) + oe(c3, d3, s2, a3);
              f2 += (l3 + p3) / 2;
            }
            break;
          }
  ...
  function fe(t, i, n) {
    ...
    var r3, h2;
    return [(r3 = t[i], h2 = de(ce(t[n], t[s]), ue), { _t: r3._t + h2._t, ut: r3.ut + h2.ut }), ce(t[n], de(ce(t[e2], t[i]), ue))];
  }
  function pe(t, i) {
    const n = t.context;
  ...
  function we(t, i, n, s, e2) {
    const r3 = 1 - e2;
    return r3 * r3 * r3 * t + 3 * r3 * r3 * e2 * i + 3 * r3 * e2 * e2 * n + e2 * e2 * e2 * s;
  }
  function Me(t, i, n, s, e2) {
    if (2 === n) {
      const [n2, r3] = fe(s, e2 - 1, e2);
      return [Math.min(t._t, i._t, n2._t, r3._t), Math.max(t._t, i._t, n2._t, r3._t)];
    }
    return [Math.min(t._t, i._t), Math.max(t._t, i._t)];
  }
  function ge(t, i, n, s, e2, r3, h2, a2) {
    switch (e2) {
      case 1: {
        const e3 = bs(t, i, n._t, n.ut, s._t, n.ut), r4 = bs(t, i, s._t, n.ut, s._t, s.ut), h3 = Math.min(e3, r4);
        return h3 <= a2 ? h3 : null;
      }
      case 2: {
        const [e3, l2] = fe(r3, h2 - 1, h2), o2 = function(t2, i2, n2) {
          let s2 = Number.POSITIVE_INFINITY, e4 = n2[0];
          for (let r4 = 1; r4 <= 12; r4++) {
            const h3 = r4 / 12, a3 = { _t: we(n2[0]._t, n2[1]._t, n2[2]._t, n2[3]._t, h3), ut: we(n2[0].ut, n2[1].ut, n2[2].ut, n2[3].ut, h3) };
  ...
  function Ee(t, i, n, s, e2) {
    const { context: r3, horizontalPixelRatio: h2, verticalPixelRatio: a2 } = i;
    r3.lineTo(e2._t * h2, t * a2), r3.lineTo(s._t * h2, t * a2), r3.closePath(), r3.fillStyle = n, r3.fill();
  }
  function rr(t) {
    return { ...t, P: x(t.fontSize, t.fontFamily, t.fontStyle), lineHeight: t.lineHeight || 1.2 * t.fontSize, cS: 0, Fc: 0 };
  }
  function hr(t) {
    return { ...t, lines: t.lines.map(rr) };
  }
  function ar(t) {
    return { ...nr, ...t };
  }
  function lr(t) {
    return { ...ir, ...t, lines: t.lines?.map(ar) ?? [] };
  }
  function _r(t, i) {
    return new tr(t, new or(i));
  }
  function fr(t, i, n, s) {
    return { ...t, mS: i, MS: n, wS: s };
  }
  function pr(t) {
    return { ...ur, ...t };
  }
  ...
  function yr(t, i, n, s) {
    const e2 = (br("arrowUp", s) - 1) / 2 * n.VS, r3 = (ei(s / 2) - 1) / 2 * n.VS;
    i.beginPath(), t ? (i.moveTo(n._t - e2, n.ut), i.lineTo(n._t, n.ut - e2), i.lineTo(n._t + e2, n.ut), i.lineTo(n._t + r3, n.ut), i.lineTo(n._t + r3, n.ut + e2), i.lineTo(n._t - r3, n.ut + e2), i.lineTo(n._t - r3, n.ut)) : (i.moveTo(n._t - e2, n.ut), i.lineTo(n._t, n.ut + e2), i.lineTo(n._t + e2, n.ut), i.lineTo(n._t + r3, n.ut), i.lineTo(n._t + r3, n.ut - e2), i.lineTo(n._t - r3, n.ut - e2), i.lineTo(n._t - r3, n.ut)), i.fill();
  }
  function kr(t, i, n, s, e2, r3) {
    const h2 = (br("arrowUp", s) - 1) / 2, a2 = (ei(s / 2) - 1) / 2;
    if (e2 >= i - a2 - 2 && e2 <= i + a2 + 2 && r3 >= (t ? n : n - h2) - 2 && r3 <= (t ? n + h2 : n) + 2)
      return true;
    return (() => {
      if (e2 < i - h2 - 3 || e2 > i + h2 + 3 || r3 < (t ? n - h2 - 3 : n) || r3 > (t ? n : n + h2 + 3))
        return false;
      const s2 = Math.abs(e2 - i);
      return Math.abs(r3 - n) + 3 >= s2 / 2;
    })();
  }
  function Tr(t, i, n, s) {
    i.fillStyle = t.R, void 0 !== t.ri && function(t2, i2, n2, s2, e2, r3) {
      t2.save(), t2.scale(e2, r3), t2.fillText(i2, n2, s2), t2.restore();
      ...
      switch (t2.AS) {
        ...
        case "square":
          return void function(t3, i3, n3) {
            const s2 = br("square", n3), e2 = (s2 - 1) * i3.VS / 2, r3 = i3._t - e2, h2 = i3.ut - e2;
            t3.fillRect(r3, h2, s2 * i3.VS, s2 * i3.VS);
          }(i2, n2, t2.Th);
      }
      t2.AS;
  ...
  function Rr(t, i, n) {
    return !(void 0 === t.ri || !function(t2, i2, n2, s, e2, r3) {
      const h2 = s / 2;
      return e2 >= t2 && e2 <= t2 + n2 && r3 >= i2 - h2 && r3 <= i2 + h2;
      ...
      switch (t2.AS) {
        ...
        case "circle":
          return function(t3, i3, n3, s, e2) {
            const r3 = 2 + br("circle", n3) / 2, h2 = t3 - s, a2 = i3 - e2;
            return Math.sqrt(h2 * h2 + a2 * a2) <= r3;
          }(t2._t, t2.ut, t2.Th, i2, n2);
        case "square":
          return function(t3, i3, n3, s, e2) {
            const r3 = br("square", n3), h2 = (r3 - 1) / 2, a2 = t3 - h2, l2 = i3 - h2;
            return s >= a2 && s <= a2 + r3 && e2 >= l2 && e2 <= l2 + r3;
          }(t2._t, t2.ut, t2.Th, i2, n2);
      }
    }(t, i, n);
  }
  ...
  function Ir(t, i, n, s, e2, r3, h2, a2) {
    const l2 = function(t2, i2, n2) {
      if (Dr(i2.position) && void 0 !== i2.price)
        return i2.price;
      if ("value" in (s2 = t2) && "number" == typeof s2.value)
        return t2.value;
      var s2;
      if (function(t3) {
        return "open" in t3 && "high" in t3 && "low" in t3 && "close" in t3;
      }(t2)) {
        if ("inBar" === i2.position)
          return t2.close;
        if ("aboveBar" === i2.position)
          return n2 ? t2.low : t2.high;
        if ("belowBar" === i2.position)
          return n2 ? t2.high : t2.low;
      }
    ...
    switch (i.position) {
      case "inBar":
      case "atPriceMiddle":
        return t.ut = u(h2.priceToCoordinate(l2)), void (void 0 !== t.ri && (t.ri.ut = t.ut + f2 + r3 + 0.6 * e2));
      case "aboveBar":
      case "atPriceTop": {
        const i2 = o2 ? 0 : s.LS;
        return t.ut = u(h2.priceToCoordinate(l2)) - f2 - i2, void 0 !== t.ri && (t.ri.ut = t.ut - f2 - 0.6 * e2, s.LS += 1.2 * e2), void (o2 || (s.LS += d2 + r3));
      }
      case "belowBar":
      case "atPriceBottom": {
        const i2 = o2 ? 0 : s.zS;
        return t.ut = u(h2.priceToCoordinate(l2)) + f2 + i2, void 0 !== t.ri && (t.ri.ut = t.ut + f2 + r3 + 0.6 * e2, s.zS += 1.2 * e2), void (o2 || (s.zS += d2 + r3));
      }
    }
  }
  function Br(t) {
  ...
  var e, r2, h, d, S, C, P, T, R, D, V, B, E, A, W, H, U, $, j, q, Y, K, Z, X, J, Q, it, nt, st, et, rt, ht, at, lt, ot, _t, ut, ct, dt, ft, pt, mt, wt, Mt, gt, bt, St, xt, Ct, yt, kt, Pt, Rt, Dt, It, Vt, Bt, Lt, zt, Ot, Nt, Ft, Wt, Ht, $t, jt, qt, Xt, Jt, Qt, ti, ii, ri, hi, ai, li, wi, Mi, bi, Si, xi, Ci, ki, Ei, Ai, zi, Oi, Fi, Wi, Hi, Ui, $i, ji, qi, Gi, Ji, Qi, tn, nn, rn, hn, cn, dn, Mn, yn, Tn, Rn, zn, Hn, Un, jn, qn, Yn, Kn, Zn, Gn, ds, Ss, Rs, Ds, Vs, Es, As, js, qs, Ys, Ks, Zs, Xs, Js, Qs, te, ie, ne, ee, ue, ve, me, be, Se, xe, Ce, ke, Pe, Te, Re, Ve, Ae, Le, ze, Oe, Ne, Fe, We, He, Ue, $e, je, qe, Ye, Ke, Ze, Ge, Xe, Je, Qe, tr, ir, nr, sr, er, or, ur, cr, dr, vr, wr, Mr, Pr, Vr, Er, Ar, zr, Or, Nr, Fr, Hr, $r, qr;
  var init_lightweight_charts_production = __esm({
    "../../node_modules/lightweight-charts/dist/lightweight-charts.production.mjs"() {
      init_fancy_canvas();
      e = { title: "", visible: true, hitTestTolerance: 3, lastValueVisible: true, priceLineVisible: true, priceLineSource: 0, priceLineWidth: 1, priceLineColor: "", priceLineStyle: 2, baseLineVisible: true, baseLineWidth: 1, baseLineColor: "#B2B5BE", baseLineStyle: 0, priceFormat: { type: "price", precision: 2, minMove: 0.01 } };
      !function(t) {
      ...
      P = class {
        ...
        tt(t, i, n) {
          const [s, e2, r3, h2] = this.K(t), [a2, l2, o2, _2] = this.K(i), u2 = [y(s + n * (a2 - s)), y(e2 + n * (l2 - e2)), y(r3 + n * (o2 - r3)), (c2 = h2 + n * (_2 - h2), c2 <= 0 || c2 > 1 ? Math.min(Math.max(c2, 0), 1) : Math.round(1e4 * c2) / 1e4)];
          var c2;
        ...
        K(t) {
          ...
          if (!s) {
            if (this.q.length)
              for (const i2 of this.q) {
                const n2 = i2(t);
                if (n2)
                  return this.j.set(t, n2), n2;
              }
      ...
      D = class extends R {
        ...
        et({ context: t, horizontalPixelRatio: i, verticalPixelRatio: n }) {
          if (null === this.rt || null === this.rt.lt)
            return;
          const s = this.rt.lt, e2 = this.rt, r3 = Math.max(1, Math.floor(i)) % 2 / 2, h2 = (h3) => {
            t.beginPath();
            for (let a2 = s.to - 1; a2 >= s.from; --a2) {
              const s2 = e2.ot[a2], l2 = Math.round(s2._t * i) + r3, o2 = s2.ut * n, _2 = h3 * n + r3;
      ...
      B = class {
        ...
        Rt() {
          ...
          this.Pt(), i.forEach((i2, e2) => {
            const r3 = this.St[e2], h2 = i2.At(n), a2 = i2.Lt();
            !t && null !== h2 && i2.It() && null !== a2 ? (r3.vt = h2.zt, r3.ft = h2.ft, r3.ct = h2.Ot, r3.ot[0].Mt = h2.Mt, r3.ot[0].ut = i2.Ft().Nt(h2.Mt, a2.Wt), r3.dt = h2.Ht ?? this.O.Ut(r3.ot[0].ut / i2.Ft().$t()), r3.ot[0].wt = n, r3.ot[0]._t = s.jt(n), r3.lt = V) : r3.lt = null;
          });
        }
      };
      E = class extends R {
        ...
        et({ context: t, bitmapSize: i, horizontalPixelRatio: n, verticalPixelRatio: s }) {
          if (null === this.qt)
            return;
          const e2 = this.qt.Yt.It, r3 = this.qt.Kt.It;
          if (!e2 && !r3)
            return;
          ...
          }(t, h2, 0, i.height)), r3 && o2 >= 0 && (t.lineWidth = Math.floor(this.qt.Kt.ct * s), t.strokeStyle = this.qt.Kt.R, t.fillStyle = this.qt.Kt.R, a(t, this.qt.Kt.Zt), l(t, o2, 0, i.width));
        }
      };
      A = class {
        constructor(t, i) {
        ...
        Rt() {
          ...
          if (2 === i.mode)
            return n.Kt.It = false, void (n.Yt.It = false);
      ...
      W = class {
        ...
        st(t, i, n, s) {
          if (!this.qt.It || 0 === this.qt.ri.length)
            return;
          const e2 = this.qt.R, r3 = this.ei.G, h2 = t.useBitmapCoordinateSpace((t2) => {
            const h3 = t2.context;
            h3.font = i.P;
            const a2 = this.hi(t2, i, n, s), l2 = a2.ai;
            return a2.li ? N(h3, l2.oi, l2._i, l2.ui, l2.ci, r3, l2.di, [l2.ft, 0, 0, l2.ft], r3) : N(h3, l2.fi, l2._i, l2.ui, l2.ci, r3, l2.di, [0, l2.ft, l2.ft, 0], r3), this.qt.pi && (h3.fillStyle = e2, h3.fillRect(l2.fi, l2.mi, l2.wi - l2.fi, l2.Mi)), this.qt.gi && (h3.fillStyle = i.D, h3.fillRect(a2.li ? l2.bi - l2.di : 0, l2._i, l2.di, l2.Si - l2._i)), a2;
          });
        ...
        hi(t, i, n, s) {
          const { context: e2, bitmapSize: r3, mediaSize: h2, horizontalPixelRatio: a2, verticalPixelRatio: l2 } = t, o2 = this.qt.pi || !this.qt.ki ? i.C : 0, _2 = this.qt.Pi ? i.S : 0, u2 = i.A + this.ei.Ti, c2 = i.I + this.ei.Ri, d2 = i.V, f2 = i.B, p2 = this.qt.ri, v2 = i.k, m2 = n.Di(e2, p2), w2 = Math.ceil(n.Ii(e2, p2)), M2 = v2 + u2 + c2, g2 = i.S + d2 + f2 + w2 + o2, b2 = Math.max(1, Math.floor(l2));
          let S2 = Math.round(M2 * l2);
          S2 % 2 != b2 % 2 && (S2 += 1);
          const x2 = _2 > 0 ? Math.max(1, Math.floor(_2 * a2)) : 0, C2 = Math.round(g2 * a2), y2 = Math.round(o2 * a2), k2 = this.ei.Vi ?? this.ei.Bi ?? this.ei.Ei, P2 = Math.round(k2 * l2) - Math.floor(0.5 * l2), T2 = Math.floor(P2 + b2 / 2 - S2 / 2), R2 = T2 + S2, D2 = "right" === s, I2 = D2 ? h2.width - _2 : _2, V2 = D2 ? r3.width - x2 : x2;
          let B2, E2, A2;
          return D2 ? (B2 = V2 - C2, E2 = V2 - y2, A2 = I2 - o2 - d2 - _2) : (B2 = V2 + C2, E2 = V2 + y2, A2 = I2 + o2 + d2), { li: D2, ai: { _i: T2, mi: P2, Si: R2, ui: C2, ci: S2, ft: 2 * a2, di: x2, oi: B2, fi: V2, wi: E2, Mi: b2, bi: r3.width }, xi: { _i: T2 / l2, Si: R2 / l2, Ci: A2, yi: m2 } };
        }
      };
      H = class {
        constructor(t) {
      ...
      U = class extends H {
        ...
        Yi(t, i, n) {
          if (t.It = false, 2 === this.Jt.N().mode)
            return;
          const s = this.Jt.N().horzLine;
          if (!s.labelVisible)
            return;
          const e2 = this.Ki.Lt();
          if (!this.Jt.It() || this.Ki.Gi() || null === e2)
            return;
          const r3 = this.Ki.Xi().Z(s.labelBackgroundColor);
          n.G = r3.G, t.R = r3.X;
      ...
      j = class {
        ...
        st(t, i) {
          if (null === this.qt || false === this.qt.It || 0 === this.qt.ri.length)
            return;
          const n = t.useMediaCoordinateSpace(({ context: t2 }) => (t2.font = i.P, Math.round(i.Qi.Ii(t2, u(this.qt).ri, $))));
          if (n <= 0)
            return;
          const s = i.tn, e2 = n + 2 * s, r3 = e2 / 2, h2 = this.qt.nn;
          let a2 = this.qt.Ei, l2 = Math.floor(a2 - r3) + 0.5;
          l2 < 0 ? (a2 += Math.abs(0 - l2), l2 = Math.floor(a2 - r3) + 0.5) : l2 + e2 > h2 && (a2 -= Math.abs(h2 - (l2 + e2)), l2 = Math.floor(a2 - r3) + 0.5);
          ...
          t.useBitmapCoordinateSpace(({ context: t2, horizontalPixelRatio: n2, verticalPixelRatio: s2 }) => {
            const e3 = u(this.qt);
            t2.fillStyle = e3.G;
            const r4 = Math.round(l2 * n2), h3 = Math.round(0 * s2), a3 = Math.round(o2 * n2), c2 = Math.round(_2 * s2), d2 = Math.round(2 * n2);
            if (t2.beginPath(), t2.moveTo(r4, h3), t2.lineTo(r4, c2 - d2), t2.arcTo(r4, c2, r4 + d2, c2, d2), t2.lineTo(a3 - d2, c2), t2.arcTo(a3, c2, a3, c2 - d2, d2), t2.lineTo(a3, h3), t2.fill(), e3.pi) {
              const r5 = Math.round(e3.Ei * n2), a4 = h3, l3 = Math.round((a4 + i.C) * s2);
              t2.fillStyle = e3.R;
              const o3 = Math.max(1, Math.floor(n2)), _3 = Math.floor(0.5 * n2);
              t2.fillRect(r5 - _3, a4, o3, l3 - a4);
            }
          }), t.useMediaCoordinateSpace(({ context: t2 }) => {
            const n2 = u(this.qt), e3 = 0 + i.S + i.C + i.A + i.k / 2;
            t2.font = i.P, t2.textAlign = "left", t2.textBaseline = "middle", t2.fillStyle = n2.R;
            const r4 = i.Qi.Di(t2, "Apr0");
            t2.translate(l2 + s, e3 + r4), t2.fillText(n2.ri, 0, 0);
          });
        }
      };
      q = class {
        ...
        Rt() {
          const t = this.Gt;
          if (t.It = false, 2 === this.Ct.N().mode)
            return;
          ...
          const r3 = this.sn.Xi().Z(i.labelBackgroundColor);
          t.G = r3.G, t.R = r3.X, t.pi = n.N().ticksVisible;
        }
      };
      Y = class {
        constructor() {
      ...
      Z = class extends Y {
        ...
        Fn(t) {
          if (!this.yn.doNotSnapToHiddenSeriesIndices)
            return t;
          ...
          for (const n2 of i.Wn()) {
            ...
            const r4 = n2.Un().Hn(t, 1);
            if (r4) {
              if (r4.$n === t)
                return t;
              (null === e2 || r4.$n < e2) && (e2 = r4.$n);
            }
          }
          const r3 = [s, e2].filter(g);
          if (0 === r3.length)
            return t;
          const h2 = n.jt(t), a2 = r3.map((t2) => Math.abs(h2 - n.jt(t2)));
          return r3[a2.indexOf(Math.min(...a2))];
        }
        jn(t) {
          let i = this.Mn.get(t);
        ...
        Xn(t, i, n) {
          const s = this.bn, e2 = this.Sn, r3 = this.fn, h2 = this.pn, a2 = this.yt, l2 = this.Gn(n);
          this.pn = t, this.bn = isNaN(t) ? NaN : this.sn.Et().jt(t), this.yt = n;
          const o2 = null !== l2 ? l2.Lt() : null;
          return null !== l2 && null !== o2 ? (this.fn = i, this.Sn = l2.Nt(i, o2)) : (this.fn = NaN, this.Sn = NaN), s !== this.bn || e2 !== this.Sn || h2 !== this.pn || r3 !== this.fn || a2 !== this.yt;
        }
        On() {
      ...
      it = class extends J {
        constructor(t, i) {
          if (super(), i || (i = 1), p(t) && v(t) || (t = 100), t < 0)
        ...
        Ts(t) {
          ...
          if (i > 1) {
            let r3 = +(Math.round(t * i) - n * i).toFixed(this.Rs);
            r3 >= i && (r3 -= i, n += 1), s = Q + tt(+r3.toFixed(this.Rs) * this.ks, e2);
          } else
            n = Math.round(n * i) / i, e2 > 0 && (s = Q + tt(0, e2));
      ...
      rt = class {
        ...
        Ns(t, i, n) {
          ...
          if (this.Ls.has(e2))
            return _(this.Ls.get(e2)).Fs;
          if (this.Vs === this.zs) {
            const t2 = this.As[this.Es];
            delete this.As[this.Es], this.Ls.delete(t2), this.Es++, this.Vs--;
          }
          t.save(), t.textBaseline = "middle";
          const r3 = t.measureText(e2);
          return t.restore(), 0 === r3.width && i.length || (this.Ls.set(e2, { Fs: r3, Ws: this.Bs }), this.As[this.Bs] = e2, this.Vs++, this.Bs++), r3;
        }
      };
      ht = class {
        constructor(t) {
      ...
      _t = class extends ot {
        ...
        oe() {
          ...
          if (2 !== i && 3 !== i)
            return;
          const n = this.ae.N();
          if (!n.baseLineVisible || !this.ae.It())
            return;
          const s = this.ae.Lt();
      ...
      ut = class extends R {
        ...
        et({ context: t, horizontalPixelRatio: i, verticalPixelRatio: n }) {
          ...
          if (null === s)
            return;
          const e2 = Math.max(1, Math.floor(i)), r3 = e2 % 2 / 2, h2 = Math.round(s.ce.x * i) + r3, a2 = s.ce.y * n;
      ...
      ct = [{ me: 0, we: 0.25, Me: 4, ge: 10, be: 0.25, Se: 0, xe: 0.4, Ce: 0.8 }, { me: 0.25, we: 0.525, Me: 10, ge: 14, be: 0, Se: 0, xe: 0.8, Ce: 0 }, { me: 0.525, we: 1, Me: 14, ge: 14, be: 0, Se: 0, xe: 0, Ce: 0 }];
      dt = class {
        constructor(t) {
        ...
        De() {
          if (this.kt(), 2 === this.Te.N().lastPriceAnimation) {
            ...
            if (i > 0)
              return void (i < 650 && (this.Pe += 2600));
        ...
        Rt() {
          ...
          if (s.Le || !i.ze(s.$n))
            return;
          const e2 = { x: t.jt(s.$n), y: this.Te.Ft().Nt(s.Mt, n.Wt) }, r3 = s.R, h2 = this.Te.N().lineWidth, a2 = this.Oe(this.Ne(), r3);
          this.Xt.ht({ de: r3, fe: h2, pe: a2.pe, ve: a2.ve, ft: a2.ft, ce: e2 });
        }
        Be() {
          const t = this.Xt.ue();
          if (null !== t) {
        ...
        Oe(t, i) {
          ...
          return { pe: this.Fe(i, e2, s.be, s.Se), ve: this.Fe(i, e2, s.xe, s.Ce), ft: (r3 = e2, h2 = s.Me, a2 = s.ge, h2 + (a2 - h2) * r3) };
          var r3, h2, a2;
        }
      };
      ft = class extends ot {
        ...
        oe() {
          ...
          t.It = false;
          const i = this.ae.N();
          if (!i.priceLineVisible || !this.ae.It())
            return;
      ...
      pt = class extends H {
        ...
        Yi(t, i, n) {
          ...
          if (!s.It())
            return;
          const e2 = s.N(), r3 = e2.lastValueVisible, h2 = "" !== s.He(), a2 = 0 === e2.seriesLastValueMode, l2 = s.Ae(false);
          if (l2.Le)
            return;
          r3 && (t.ri = this.Ue(l2, r3, a2), t.It = 0 !== t.ri.length), (h2 || a2) && (i.ri = this.$e(l2, r3, h2, a2), i.It = i.ri.length > 0);
        ...
        $e(t, i, n, s) {
          let e2 = "";
          const r3 = this.Jt.He();
          return n && 0 !== r3.length && (e2 += `${r3} `), i && s && (e2 += this.Jt.Ft().je() ? t.qe : t.Ye), e2.trim();
        }
        Ue(t, i, n) {
      ...
      St = class extends H {
        ...
        Yi(t, i, n) {
          t.It = false, i.It = false;
          const s = this._r.N(), e2 = s.axisLabelVisible, r3 = "" !== s.title, h2 = this.Te;
          if (!e2 || !h2.It())
            return;
          const a2 = this._r.ur();
          if (null === a2)
            return;
          r3 && (i.ri = s.title, i.It = true), i.Ht = h2.Qt().Ut(a2 / h2.Ft().$t()), t.ri = this.cr(s.price), t.It = true;
      ...
      Ct = class {
        ...
        Sr(t, i, n) {
          ...
          if (t >= s)
            return 1;
          const e2 = s / t, r3 = Math.pow(2, Math.floor(Math.log2(e2)));
          return Math.min(r3, 512);
        }
        Cr(t, i, n, s = false, e2) {
          if (0 === t.length || i <= 1)
            return t;
          ...
          const h2 = this.kr(t);
          let a2 = h2.Pr.get(r3);
          return void 0 !== a2 || (a2 = this.Tr(t, r3, n, s, e2, h2.Pr), h2.Pr.set(r3, a2)), a2;
        }
        Rr(t, i, n, s, e2 = false, r3) {
          if (n < 1 || 0 === t.length)
            return t;
          const h2 = this.kr(t), a2 = h2.Pr.get(n);
          if (!a2)
            return this.Cr(t, n, s, e2, r3);
          const l2 = this.Dr(t, i, n, a2, e2, s, r3);
        ...
        Tr(t, i, n, s = false, e2, r3 = /* @__PURE__ */ new Map()) {
          if (2 === i)
            return this.Vr(t, 2, n, s, e2);
          const h2 = i / 2;
          let a2 = r3.get(h2);
          return a2 || (a2 = this.Tr(t, h2, n, s, e2, r3), r3.set(h2, a2)), this.Br(a2, n, s, e2);
        }
        Vr(t, i, n, s = false, e2) {
          const r3 = this.Er(t, i, n, s, e2);
          return this.Ar(r3, s);
        }
        Br(t, i, n = false, s) {
        ...
        Er(t, i, n, s = false, e2) {
          ...
          for (let h2 = 0; h2 < t.length; h2 += i) {
            if (t.length - h2 >= i) {
              ...
              i2.zr = false, r3.push(i2);
            } else if (0 === r3.length)
              r3.push(this.Or(t[h2], true));
            else {
              const i2 = r3[r3.length - 1];
              r3[r3.length - 1] = this.Nr(i2, t[h2], n, s, e2);
            }
          }
          return r3;
        }
        ...
        Lr(t, i, n, s = false, e2) {
          ...
          const r3 = n(this.Xr(t, e2), this.Xr(i, e2)), h2 = e2(r3), a2 = h2.length ? h2[h2.length - 1] : 0;
          return { Wr: t.$n, Hr: i.$n, Ur: t.wt, $r: i.wt, jr: t.Wt[0], qr: Math.max(t.Wt[1], a2), Yr: Math.min(t.Wt[2], a2), Kr: a2, Zr: this.Fr(t.Zr, i.Zr), Gr: r3, zr: false };
        }
        Nr(t, i, n, s = false, e2) {
          if (!s || !n || !e2)
            return { Wr: t.Wr, Hr: i.$n, Ur: t.Ur, $r: i.wt, jr: t.jr, qr: t.qr > i.Wt[1] ? t.qr : i.Wt[1], Yr: t.Yr < i.Wt[2] ? t.Yr : i.Wt[2], Kr: i.Wt[3], Zr: t.Zr + (i.Zr ?? 1), Gr: t.Gr, zr: false };
          const r3 = t.Gr, h2 = this.Xr(i, e2), a2 = r3 ? { data: r3, index: t.Wr, originalTime: t.Ur, time: t.Ur, priceValues: e2(r3) } : null, l2 = a2 ? n(a2, h2) : h2.data, o2 = a2 ? e2(l2) : h2.priceValues, _2 = o2.length ? o2[o2.length - 1] : 0;
          return { Wr: t.Wr, Hr: i.$n, Ur: t.Ur, $r: i.wt, jr: t.jr, qr: Math.max(t.qr, _2), Yr: Math.min(t.Yr, _2), Kr: _2, Zr: t.Zr + (i.Zr ?? 1), Gr: l2, zr: false };
        }
        Jr(t, i, n, s, e2, r3, h2 = false, a2) {
          const l2 = i === s ? e2 : t[i];
          if (n - i == 1)
            return this.Or(l2, true);
          const o2 = i + 1 === s ? e2 : t[i + 1];
          let _2 = this.Lr(l2, o2, r3, h2, a2);
          for (let l3 = i + 2; l3 < n; l3++) {
            const i2 = l3 === s ? e2 : t[l3];
            _2 = this.Nr(_2, i2, r3, h2, a2);
          }
          return _2;
        }
        Xr(t, i) {
      ...
      kt = { Bar: (t, i, n, s) => {
        const e2 = i.upColor, r3 = i.downColor, h2 = u(t(n, s)), a2 = c(h2.Wt[0]) <= c(h2.Wt[3]);
        return { sh: h2.R ?? (a2 ? e2 : r3) };
      }, Candlestick: (t, i, n, s) => {
        const e2 = i.upColor, r3 = i.downColor, h2 = i.borderUpColor, a2 = i.borderDownColor, l2 = i.wickUpColor, o2 = i.wickDownColor, _2 = u(t(n, s)), d2 = c(_2.Wt[0]) <= c(_2.Wt[3]);
        return { sh: _2.R ?? (d2 ? e2 : r3), eh: _2.Ht ?? (d2 ? h2 : a2), rh: _2.hh ?? (d2 ? l2 : o2) };
      ...
      Bt = class {
        ...
        Ah(t, i, n) {
          if (this.Gi())
            return null;
          let s = null;
          const e2 = u(this.Rh()), r3 = u(this.Qn()), h2 = Math.max(t, e2), a2 = Math.min(i, r3), l2 = Math.ceil(h2 / Vt) * Vt, o2 = Math.max(l2, Math.floor(a2 / Vt) * Vt);
          {
      ...
      Jt = class extends yt {
        constructor(t, i, n, s, e2) {
          ...
          const r3 = new pt(this);
          if (this.mn = [r3], this.pr = new at(r3, this, t), Xt.includes(this.wa) && (this.ua = new dt(this)), this.Ma(), this.Yh = s(this, this.Qt(), e2), "Custom" === this.wa) {
            const t2 = this.Yh;
            t2.ga && this.ba(t2.ga);
          }
        }
        ...
        Ae(t) {
          ...
          if (this.Qt().Et().Gi() || n.Gi() || this.qt.Gi())
            return i;
          ...
          if (t) {
            ...
            if (null === t2)
              return i;
            if (r3 = this.qt.Mh(t2.$n), null === r3)
              return i;
            h2 = t2.$n;
          }
          const a2 = r3.Wt[3], l2 = this.Sa().Sh(h2, { Wt: r3 }), o2 = n.Nt(a2, e2.Wt);
        ...
        vr(t) {
          ...
          const r3 = void 0 !== t.conflationThresholdFactor;
          f(this.yn, t), r3 && (this.va.clear(), this.Qt().mr()), void 0 !== e2 && (this.Ma(), i.Pa()), i.Ta(this), i.Ra(), this.Yh.kt("options");
        }
        ht(t, i) {
        ...
        Rr(t) {
          ...
          } : void 0, r3 = this.pa.Rr(this.qt.Bh(), t, i, s, n, e2), h2 = At();
          h2.ht(r3), this.va.set(i, h2);
        }
        Ha() {
        ...
        qn(t, i) {
          if (i !== this.hn && !this.Ya())
            return [];
          const n = [...this.mn];
          for (const t2 of this.oa)
            n.push(t2.gr());
        ...
        At(t) {
          if (!(("Line" === this.wa || "Area" === this.wa || "Baseline" === this.wa) && this.yn.crosshairMarkerVisible))
            return null;
          const i = this.qt.Mh(t);
          if (null === i)
            return null;
        ...
        ll() {
          if ("Custom" === this.wa)
            return (t) => this.Yh.Wa(t);
        }
        ol() {
          if ("Custom" === this.wa)
            return (t) => this.Yh._l(t);
        }
        ul() {
          return this.qt.Lh();
        }
        ...
        Da(t) {
          if ("Custom" === this.wa && (null === this.ma || !this.ll()))
            return;
          this.va.clear();
      ...
      ii = class {
        ...
        xl(t, i, n) {
          ...
          if (0 === this.yn.mode)
            return s;
          const e2 = n.Pn(), r3 = e2.Lt();
          if (null === r3)
            return s;
          const h2 = e2.Nt(t, r3), a2 = n.Cl().filter((t2) => t2 instanceof Jt).reduce((t2, s2) => {
            if (n.Zs(s2) || !s2.It())
              return t2;
            const e3 = s2.Ft(), r4 = s2.Un();
            if (e3.Gi() || !r4.ze(i))
              return t2;
            const h3 = r4.Mh(i);
            if (null === h3)
      ...
      ri = class extends R {
        ...
        et({ context: t, bitmapSize: i, horizontalPixelRatio: n, verticalPixelRatio: s }) {
          ...
          t.lineWidth = e2, function(t2, i2) {
            ...
            const r3 = u(this.qt);
            if (r3.yl) {
              t.strokeStyle = r3.kl, a(t, r3.Pl), t.beginPath();
              for (const s2 of r3.Tl) {
                const r4 = Math.round(s2.Rl * n);
                t.moveTo(r4, -e2), t.lineTo(r4, i.height + e2);
              }
              t.stroke();
            }
            if (r3.Dl) {
              t.strokeStyle = r3.Il, a(t, r3.Vl), t.beginPath();
              for (const n2 of r3.Bl) {
                const r4 = Math.round(n2.Rl * s);
                t.moveTo(-e2, r4), t.lineTo(i.width + e2, r4);
              }
              t.stroke();
            }
          });
      ...
      wi = class {
        ...
        Fl(t, i, n) {
          ...
          let e2 = Math.pow(10, Math.max(0, Math.ceil(Math.log10(t - i)))), r3 = 0, h2 = this.Ol[0];
          for (; ; ) {
            const t2 = si(e2, s, 1e-14) && e2 > s + 1e-14, i2 = si(e2, n * h2, 1e-14), a3 = si(e2, 1, 1e-14);
            if (!(t2 && i2 && a3))
              break;
            e2 /= h2, h2 = this.Ol[++r3 % this.Ol.length];
          }
          if (e2 <= s + 1e-14 && (e2 = s), e2 = Math.max(1, e2), this.Nl.length > 0 && (a2 = e2, l2 = 1, o2 = 1e-14, Math.abs(a2 - l2) < o2))
            for (r3 = 0, h2 = this.Nl[0]; si(e2, n * h2, 1e-14) && e2 > s + 1e-14; )
              e2 /= h2, h2 = this.Nl[++r3 % this.Nl.length];
          var a2, l2, o2;
          return e2;
        }
      };
      Mi = class {
        ...
        Fl(t, i) {
          ...
          const n = this.Ki.$t(), s = (t - i) * this.$l() / n, e2 = new wi(this.zl, [2, 2.5, 2]), r3 = new wi(this.zl, [2, 2, 2.5]), h2 = new wi(this.zl, [2.5, 2, 2]), a2 = [];
          return a2.push(e2.Fl(t, i, s), r3.Fl(t, i, s), h2.Fl(t, i, s)), function(t2) {
            if (t2.length < 1)
        ...
        jl() {
          ...
          if (null === i)
            return void (this.Wl = []);
          const n = t.$t(), s = this.Hl(n - 1, i), e2 = this.Hl(0, i), r3 = this.Ki.N().entireTextOnly ? this.ql() / 2 : 0, h2 = r3, a2 = n - 1 - r3, l2 = Math.max(s, e2), o2 = Math.min(s, e2);
          if (l2 === o2)
            return void (this.Wl = []);
          ...
          for (let t2 = 0; t2 < this.Wl.length; t2++)
            this.Wl[t2].io = c2[t2];
        }
        El() {
          return this.Wl;
        ...
        Yl(t, i, n, s, e2, r3) {
          ...
          for (let c2 = n - l2; c2 > s; c2 -= i) {
            ...
            null !== _2 && Math.abs(n2 - _2) < this.$l() || (n2 < e2 || n2 > r3 || (u2 < h2.length ? (h2[u2].Rl = n2, h2[u2].io = a2.no(c2), h2[u2].Jl = c2) : h2.push({ Rl: n2, io: a2.no(c2), Jl: c2 }), u2++, _2 = n2, a2.so() && (i = this.Fl(c2 * o2, s))));
          }
          h2.length = u2;
        }
        Xl(t, i, n, s, e2, r3) {
          const h2 = this.Wl, a2 = this.eo(t, n, e2, r3), l2 = this.eo(t, s, -r3, -e2), o2 = this.Ul(0, t, true) - this.Ul(i, t, true);
          h2.length > 0 && h2[0].Rl - a2.Rl < o2 / 2 && h2.shift(), h2.length > 0 && l2.Rl - h2[h2.length - 1].Rl < o2 / 2 && h2.pop(), h2.unshift(a2), h2.push(l2);
        }
        eo(t, i, n, s) {
          const e2 = (n + s) / 2, r3 = this.Hl(i + n, t), h2 = this.Hl(i + s, t), a2 = Math.min(r3, h2), l2 = Math.max(r3, h2), o2 = Math.max(0.1, this.Fl(l2, a2)), _2 = this.Hl(i + e2, t), u2 = _2 - _2 % o2, c2 = this.Ul(u2, t, true);
      ...
      Ci = class {
        ...
        Zo(t, i, n) {
          this.jo();
          const s = this.$o(), e2 = u(this.ar()), r3 = e2.Je(), h2 = e2.Qe(), a2 = this.Ho() - 1, l2 = this.zo(), o2 = a2 / (h2 - r3), _2 = void 0 === n ? 0 : n.from, c2 = void 0 === n ? t.length : n.to, d2 = this.Go();
          for (let n2 = _2; n2 < c2; n2++) {
            ...
            const _3 = s + o2 * (a3 - r3), u2 = l2 ? _3 : this.ho - 1 - _3;
            e3.ut = u2;
          }
        }
        Xo(t, i, n) {
          ...
          for (let n2 = _2; n2 < c2; n2++) {
            ...
            let c3 = s + o2 * (h3 - r3), f2 = l2 ? c3 : this.ho - 1 - c3;
            e3.Jo = f2, c3 = s + o2 * (a3 - r3), f2 = l2 ? c3 : this.ho - 1 - c3, e3.Qo = f2, c3 = s + o2 * (_3 - r3), f2 = l2 ? c3 : this.ho - 1 - c3, e3.t_ = f2, c3 = s + o2 * (u2 - r3), f2 = l2 ? c3 : this.ho - 1 - c3, e3.i_ = f2;
          }
        }
        Tn(t, i) {
          const n = this.Do(t, i);
        ...
        El() {
          ...
          if (null !== this.bo && (t || this.bo.h_ === t))
            return this.bo.El;
          this.Ro.jl();
          const i = this.Ro.El();
        ...
        dl() {
          ...
          let t = 1 / 0;
          this.wo = null;
          for (const i2 of this.mo)
            i2.ln() < t && (t = i2.ln(), this.wo = i2);
          let i = 100;
        ...
        g_() {
          ...
          if (this.Kl() && (s = Math.max(s, this.Gl()), e2 = Math.max(e2, this.Gl())), s === this.do && e2 === this.fo || (this.do = s, this.fo = e2, this.bo = null, this.Bo()), null !== i) {
            ...
            if (this.so()) {
              ...
              if (r3 = n2, h2 = this.Co, r3.Al !== h2.Al || r3.Ll !== h2.Ll) {
            ...
            null === this.rr && (this.Oo(new mt(-0.5, 0.5)), this.Co = mi(null));
          var r3, h2;
        }
        Go() {
      ...
      ki = class {
        ...
        au() {
          ...
          if (null !== s && s.Kh === t && s._u === i && s.uu === n)
            return s.cu;
          const e2 = function(t2, i2, n2) {
            if (!n2)
              return t2;
            const s2 = t2.indexOf(i2);
            if (-1 === s2 || s2 === t2.length - 1)
              return t2;
            const e3 = [];
        ...
        du(t, i) {
          ...
          for (const t2 of [this.D_, this.V_])
            t2.e_(), t2.dl();
          this.sn.mr();
        }
        Vt() {
      ...
      zi = class {
        ...
        Eu(t, i, n, s, e2) {
          const r3 = Math.ceil(i / t);
          return null !== this.Ls && this.Ls.Au === r3 && e2 === this.Ls.Lu && n === this.Ls.zu || (this.Ls = { Lu: e2, zu: n, El: this.Ou(r3, n, s), Au: r3 }), this.Ls.El;
        }
        Bu(t) {
          if (0 === t)
            return void this.Ru.clear();
          const i = [];
          this.Ru.forEach((n, s) => {
        ...
        Ou(t, i, n) {
          ...
          for (const i2 of Array.from(this.Ru.keys()).sort((t2, i3) => i3 - t2)) {
            ...
            for (let i3 = 0; i3 < l2; i3++) {
              ...
              if (o2 - _2 >= t && _2 - u2 >= t && e2(l3))
                s.push(l3), u2 = _2;
              else if (this.Du)
                return n2;
            }
            for (; h2 < r3; h2++)
              e2(n2[h2]) && s.push(n2[h2]);
          }
          return s;
        }
      };
      ...
      Fi = class {
        ...
        Tc(t, i) {
          ...
          for (let i2 = s; i2 < e2; i2++) {
            const s2 = t[i2].wt, e3 = n + this.rc - s2, r3 = this.C_ - (e3 + 0.5) * this.hc - 1;
            t[i2]._t = r3;
          }
        }
        Rc(t, i) {
        ...
        _c() {
          if (!this.yn.ignoreWhitespaceIndices)
            return;
          this.tc.clear();
          const t = this.sn.Jn();
          for (const i of t)
            for (const t2 of i.ul())
              this.tc.set(t2, true);
          this.nc++;
        }
        Qc() {
        ...
        wc() {
          if (!this.Ku)
            return;
          if (this.Ku = false, this.Gi())
            return void this.sd(Oi.Hu());
        ...
        oc() {
          if (!this.yn.enableConflation)
            return void (this.ec = 1);
        ...
        Vc(t) {
          const i = function* (t2) {
            ...
            let s = 1;
            for (; ; )
              n2 ? (yield i2 + s, yield i2 - s) : (yield i2 - s, yield i2 + s), s++;
          }(t), n = this.xc();
          for (; n; ) {
      ...
      qi = class {
        ...
        kd(t) {
          if (this.dd?.lu === t?.lu && this.dd?.wu?.te === t?.wu?.te && this.dd?.wu?.ie === t?.wu?.ie && this.dd?.mu === t?.mu && this.dd?.ee === t?.ee)
            return;
          const i = this.dd;
        ...
        Pd(t, i, n = 0) {
          ...
          if (void 0 === s)
            return;
          if ("left" === t)
            return f(this.yn, { leftPriceScale: i }), s.E_({ leftPriceScale: i }), this.fd.p(), void this.Pa();
          if ("right" === t)
            return f(this.yn, { rightPriceScale: i }), s.E_({ rightPriceScale: i }), this.fd.p(), void this.Pa();
        ...
        Bd(t, i) {
          ...
          const n = this.od[t], s = this.od.reduce((t2, i2) => t2 + i2.z_(), 0), e2 = this.od.reduce((t2, i2) => t2 + i2.$t(), 0), r3 = e2 - 30 * (this.od.length - 1);
          i = Math.min(r3, Math.max(30, i));
          const h2 = s / e2, a2 = n.$t();
          n.O_(i * h2);
          let l2 = i - a2, _2 = this.od.length - 1;
          for (const t2 of this.od)
            if (t2 !== n) {
              const i2 = Math.min(r3, Math.max(30, t2.$t() - l2 / _2));
              l2 -= t2.$t() - i2, _2 -= 1;
              const n2 = i2 * h2;
              t2.O_(n2);
            }
        ...
        Ad(t, i) {
          if (o(t >= 0 && t < this.od.length && i >= 0 && i < this.od.length, "Invalid pane index"), t === i)
            return;
        ...
        jd(t, i, n, s, e2) {
          this.Ct.In(t, i);
          let r3 = NaN, h2 = this.ia.Rc(t, true);
          const a2 = this.ia.Ee();
          null !== a2 && (h2 = Math.min(Math.max(a2.Oa(), h2), a2.bi())), h2 = this.Ct.Fn(h2);
          const l2 = s.Pn(), o2 = l2.Lt();
          if (null !== o2 && (r3 = l2.Tn(i, o2)), r3 = this.Md.xl(r3, h2, s), this.Ct.An(h2, r3, s), this.qa(), !e2) {
            const e3 = Bi(s, t, i);
            this.kd(e3 && { lu: e3.lu, wu: e3.wu, mu: e3.mu || null, ee: e3.ee }), this.pd.p(this.Ct.Bt(), { x: t, y: i }, n);
          }
        }
        qd(t, i, n) {
          const s = n.Pn(), e2 = s.Lt(), r3 = s.Nt(t, u(e2)), h2 = this.ia.vc(i, true), a2 = this.ia.jt(u(h2));
          this.jd(a2, r3, null, n, true);
        }
        Yd(t) {
        ...
        Kd(t, i, n) {
          ...
          const e2 = this.ia.Rn(0), r3 = this.ia.Pc(), h2 = this.ia.Ee();
          if (null !== h2 && null !== s && null !== e2) {
            const i2 = h2.ze(r3), a2 = this.xu.key(s) > this.xu.key(e2), l2 = null !== t && t > r3 && !a2, o2 = this.ia.N().allowShiftVisibleRangeOnWhitespaceReplacement, _2 = i2 && (!(void 0 === n) || o2) && this.ia.N().shiftVisibleRangeOnNewBar;
            if (l2 && !_2) {
              const i3 = t - r3;
        ...
        Ut(t) {
          ...
          if (i === n)
            return i;
          if (t = Math.max(0, Math.min(100, Math.round(100 * t))), null === this.vd || this.vd.ah !== n || this.vd.oh !== i)
            this.vd = { ah: n, oh: i, rf: /* @__PURE__ */ new Map() };
          else {
      ...
      tn = { df: "yyyy-MM-dd", ff: "%h:%m:%s", pf: " ", vf: "default" };
      nn = class {
        constructor(t = {}) {
          const i = { ...tn, ...t };
      ...
      rn = [{ gf: (hn = 1, 1e3 * hn), bf: 10 }, { gf: en(1), bf: 20 }, { gf: en(5), bf: 21 }, { gf: en(30), bf: 22 }, { gf: sn(1), bf: 30 }, { gf: sn(3), bf: 31 }, { gf: sn(6), bf: 32 }, { gf: sn(12), bf: 33 }];
      cn = class {
        options() {
          return this.yn;
        }
        ...
        fillWeightsForPoints(t, i) {
          !function(t2, i2 = 0) {
            ...
            for (let r3 = i2; r3 < t2.length; ++r3) {
              const i3 = t2[r3], h2 = new Date(1e3 * i3.time.Sf);
      ...
      Mn = class {
        ...
        vp(t) {
          ...
          }, this.dp.addEventListener("mousemove", i), this.np(t))
            return;
          const n = this.sp(t);
        ...
        gp(t) {
          ...
          if (null === i)
            return;
          if (this.Gf = xn(t), null !== this.jf)
            return;
          if (this.Kf)
            return;
          this.Yf = true;
          const n = this.rp(Sn(i), u(this.Af)), { bp: s, Sp: e2, ep: r3 } = n;
          if (this.Lf || !(r3 < 5)) {
            if (!this.Lf) {
        ...
        Tp(t) {
          ...
          if (this.hp(n, this.lp.Rp), ++this.Rf, this.Df && this.Rf > 1) {
            ...
            this.Of || (this.hp(n, this.lp.Dp), this.lp.Dp && bn(t));
      ...
      zn = class {
        constructor(i, n, s, e2) {
          ...
          const r3 = this.fm.canvasElement;
          r3.style.position = "absolute", r3.style.zIndex = "1", r3.style.left = "0", r3.style.top = "0", this.pm = Dn(this.lv, size({ width: 16, height: 16 })), this.pm.subscribeSuggestedBitmapSizeChanged(this.lm);
        ...
        bm() {
          ...
          const r3 = this.Ki.Lt();
          if (null !== r3 && null !== this.Qv && (2 !== (h2 = this.yn.crosshair).mode && h2.horzLine.visible && h2.horzLine.labelVisible)) {
            const i2 = this.Ki.Tn(1, r3), s2 = this.Ki.Tn(this.Qv.height - 2, r3);
            t = Math.max(t, this.im.Ii(n, this.Ki.Ji(Math.floor(Math.min(i2, s2)) + 0.11111111111111, r3)), this.im.Ii(n, this.Ki.Ji(Math.ceil(Math.max(i2, s2)) - 0.11111111111111, r3)));
          }
          var h2;
          n.restore();
          const a2 = t || 34;
        ...
        Mv(t) {
          if (null === this.Ki || this.Ki.Gi() || !this.yn.handleScale.axisPressedMouseMove.price)
            return;
          const i = this.yt.am().Qt(), n = this.yt.Sv();
          this.tm = true, i.G_(n, this.Ki, t.localY);
        }
        gv(t) {
          if (null === this.Ki || !this.yn.handleScale.axisPressedMouseMove.price)
            return;
        ...
        Tm({ context: t, bitmapSize: i }) {
          const { width: n, height: s } = i, e2 = this.yt.Sv().Qt(), r3 = e2.$(), h2 = e2.ef();
          r3 === h2 ? z(t, 0, 0, n, s, r3) : F(t, 0, 0, n, s, r3, h2);
        }
        Rm({ context: t, bitmapSize: i, horizontalPixelRatio: n }) {
          if (null === this.Qv || null === this.Ki || !this.Ki.N().borderVisible)
            return;
        ...
        Im(t) {
          if (null === this.Qv || null === this.Ki)
            return;
          const i = this.Ki.El(), n = this.Ki.N(), s = this.gm(), e2 = this.om ? this.Qv.width - s.C : 0;
          n.borderVisible && n.ticksVisible && t.useBitmapCoordinateSpace(({ context: t2, horizontalPixelRatio: r3, verticalPixelRatio: h2 }) => {
            t2.fillStyle = n.borderColor;
            const a2 = Math.max(1, Math.floor(h2)), l2 = Math.floor(0.5 * h2), o2 = Math.round(s.C * r3);
            t2.beginPath();
            for (const n2 of i)
              t2.rect(Math.floor(e2 * r3), Math.round(n2.Rl * h2) - l2, o2, a2);
            t2.fill();
          }), t.useMediaCoordinateSpace(({ context: t2 }) => {
            t2.font = this.Sm(), t2.fillStyle = n.textColor ?? this.ko.textColor, t2.textAlign = this.om ? "right" : "left", t2.textBaseline = "middle";
            const r3 = this.om ? Math.round(e2 - s.V) : Math.round(e2 + s.C + s.V), h2 = i.map((i2) => this.im.Di(t2, i2.io));
            for (let n2 = i.length; n2--; ) {
              const s2 = i[n2];
              t2.fillText(s2.io, r3, s2.Rl + h2[n2]);
            }
          });
        }
        Pm() {
          ...
          const r3 = this.Ki.Cl()[0], h2 = this.Ki;
          n.forEach((n2) => {
            const e3 = n2.qn(s, h2);
            e3.forEach((t2) => {
              t2.$i() && null === t2.Wi() && (t2.Ui(null), i.push(t2));
            }), r3 === n2 && e3.length > 0 && (t = e3[0].Ei());
          });
        ...
        Bm(t) {
          ...
          e2.length && n.push(e2);
          const r3 = this.gm(), h2 = this.om ? "right" : "left";
          n.forEach((i2) => {
            i2.forEach((i3) => {
              i3.Tt(u(this.Ki)).st(t, r3, this.im, h2);
            });
          });
        }
        Em(t) {
      ...
      Hn = class _Hn {
        constructor(i, n) {
          ...
          const r3 = this.pm.canvasElement;
          r3.style.position = "absolute", r3.style.zIndex = "2", r3.style.left = "0", r3.style.top = "0", this.av = document.createElement("tr"), this.av.appendChild(this.Jm), this.av.appendChild(this.Xm), this.av.appendChild(this.Qm), this.tw(), this.tv = new Mn(this.pm.canvasElement, this, { xp: () => null === this.jm && !this.qv.N().handleScroll.vertTouchDrag, Cp: () => null === this.jm && !this.qv.N().handleScroll.horzTouchDrag });
        }
        m() {
        ...
        Hp(t, i) {
          if (!this.qv.N().handleScale.pinch)
            return;
          const n = 5 * (i - this.Um);
        ...
        yp(t) {
          ...
          if (null === this.jm)
            ...
            this.qm = false;
            const s = u(this.Ym), e2 = s.x + (i - this.jm.x), r3 = s.y + (n - this.jm.y);
            this.rw(e2, r3, t);
          }
        }
        Rp(t) {
        ...
        Tm({ context: t, bitmapSize: i }) {
          const { width: n, height: s } = i, e2 = this.sn(), r3 = e2.$(), h2 = e2.ef();
          r3 === h2 ? z(t, 0, 0, n, s, h2) : F(t, 0, 0, n, s, r3, h2);
        }
        gw(t) {
        ...
        Cw(t, i, n, s) {
          const e2 = u(this.Zm), r3 = e2.Qt().ou(), h2 = null !== r3 && r3.lu === s, a2 = null !== r3 && h2 && void 0 !== r3.wu ? r3.wu.ie : void 0;
        ...
        hw() {
          if (!this.Zm)
            return;
          if (this.sn().cs(), document.activeElement !== document.body && document.activeElement !== document.documentElement)
        ...
        ow(t) {
          ...
          if (n.Gi())
            return;
          const s = this.qv.N(), e2 = s.handleScroll, r3 = s.kineticScroll;
          if ((!e2.pressedMouseMove || t.Zp) && (!e2.horzTouchDrag && !e2.vertTouchDrag || !t.Zp))
            return;
          ...
          if (null !== this.Nm || this.yw(t) || (this.Nm = { x: t.clientX, y: t.clientY, Sf: a2, kw: t.localX, Pw: t.localY }), null !== this.Nm && !this.Fm && (this.Nm.x !== t.clientX || this.Nm.y !== t.clientY)) {
            if (t.Zp && r3.touch || !t.Zp && r3.mouse) {
              const t2 = n.fl();
      ...
      Un = class {
        constructor(i, n, s, e2, r3) {
          this.xt = true, this.Qv = size({ width: 0, height: 0 }), this.hm = () => this.km(3), this.om = "left" === i, this.wd = s.Zd, this.yn = n, this.Tw = e2, this.Rw = r3, this.lv = document.createElement("div"), this.lv.style.width = "25px", this.lv.style.height = "100%", this.lv.style.overflow = "hidden", this.fm = Dn(this.lv, size({ width: 16, height: 16 })), this.fm.subscribeSuggestedBitmapSizeChanged(this.hm);
        }
        m() {
        ...
        km(t) {
          if (t < 3 && !this.xt)
            return;
          if (0 === this.Qv.width || 0 === this.Qv.height)
            return;
        ...
        Rm({ context: t, bitmapSize: i, horizontalPixelRatio: n, verticalPixelRatio: s }) {
          ...
          const e2 = Math.floor(this.wd.N().S * n), r3 = Math.floor(this.wd.N().S * s), h2 = this.om ? i.width - e2 : 0;
          t.fillRect(h2, 0, e2, r3);
        }
        Tm({ context: t, bitmapSize: i }) {
      ...
      Kn = class {
        ...
        jw(t, i) {
          ...
          for (const s of n)
            En(i, (i2) => Vn(i2, t, false, void 0), s, void 0);
          for (const s of n)
            En(i, (i2) => Bn(i2, t, false, void 0), s, void 0);
        }
        Tm({ context: t, bitmapSize: i }) {
        ...
        Im(t) {
          ...
          if (!n || 0 === n.length)
            return;
          const s = this.xu.maxTickMarkWeight(n), e2 = this.Uw(), r3 = i.N();
          r3.borderVisible && r3.ticksVisible && t.useBitmapCoordinateSpace(({ context: t2, horizontalPixelRatio: i2, verticalPixelRatio: s2 }) => {
            t2.strokeStyle = this.Yw(), t2.fillStyle = this.Yw();
            const r4 = Math.max(1, Math.floor(i2)), h2 = Math.floor(0.5 * i2);
            t2.beginPath();
            const a2 = Math.round(e2.C * s2);
            for (let s3 = n.length; s3--; ) {
              const e3 = Math.round(n[s3].coord * i2);
              t2.rect(e3 - h2, 0, r4, a2);
            }
            t2.fill();
          }), t.useMediaCoordinateSpace(({ context: t2 }) => {
        ...
        Kw(t, i, n) {
          const s = this.im.Ii(t, n), e2 = s / 2, r3 = Math.floor(i - e2) + 0.5;
          return r3 < 0 ? i += Math.abs(0 - r3) : r3 + s > this.Qv.width && (i -= Math.abs(this.Qv.width - (r3 + s))), i;
        }
        qw(t, i) {
          const n = this.Uw();
          for (const s of t)
            for (const t2 of s.dn())
              t2.Tt().st(i, n);
        }
        Yw() {
      ...
      Zn = !!dn && !!navigator.userAgentData && navigator.userAgentData.brands.some((t) => t.brand.includes("Chromium")) && !!dn && (navigator?.userAgentData?.platform ? "Windows" === navigator.userAgentData.platform : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
      Gn = class {
        constructor(t, i, n) {
          var s;
          ...
          let r3 = this.yn.width, h2 = this.yn.height;
          if (e2 || 0 === r3 || 0 === h2) {
            const i2 = t.getBoundingClientRect();
            r3 = r3 || i2.width, h2 = h2 || i2.height;
          }
          this.cM(r3, h2), this.dM(), t.appendChild(this.Hv), this.fM(), this.sn.Et().Zc().i(this.sn.Pa.bind(this.sn), this), this.sn.L_().i(this.sn.Pa.bind(this.sn), this);
        }
        Qt() {
          return this.sn;
        }
        ...
        cM(i, n, s = false) {
          ...
          const r3 = this.ho + "px", h2 = this.C_ + "px";
          if (this.wM() || (u(this.Hv).style.height = r3, u(this.Hv).style.width = h2), this.rM.style.height = r3, this.rM.style.width = h2, s) {
        ...
        xM(i, n) {
          let s = 0, e2 = 0;
          const r3 = this.Gw[0], h2 = (t, s2) => {
            let e3 = 0;
            for (let r4 = 0; r4 < this.Gw.length; r4++) {
              const h3 = this.Gw[r4], a3 = u("left" === t ? h3.Sw() : h3.xw()), l2 = a3.dv();
              if (null !== i && a3.fv(i, s2, e3, n), e3 += l2.height, r4 < this.Gw.length - 1) {
                const t2 = this.Xw[r4], n2 = t2.dv();
          ...
          for (let t = 0; t < this.Gw.length; t++) {
            const r4 = this.Gw[t], h3 = r4.dv();
            if (null !== i && r4.fv(i, s, e2, n), e2 += h3.height, t < this.Gw.length - 1) {
              const n2 = this.Xw[t], r5 = n2.dv();
              null !== i && n2.fv(i, s, e2), e2 += r5.height;
            }
          }
          if (s += r3.dv().width, this.kM()) {
            h2("right", s);
            s += u(r3.xw()).dv().width;
          }
          const a2 = (t, n2, s2) => {
          ...
          if (this.yn.timeScale.visible) {
            ...
            if (null !== i) {
              let s2 = 0;
              this.yM() && (a2("left", s2, e2), s2 = u(r3.Sw()).dv().width), this._M.fv(i, s2, e2, n), s2 += t.width, this.kM() && a2("right", s2, e2);
            }
            e2 += t.height;
          }
        ...
        DM() {
          let i = 0, n = 0, s = 0;
          for (const t of this.Gw)
            this.yM() && (n = Math.max(n, u(t.Sw()).bm(), this.yn.leftPriceScale.minimumWidth)), this.kM() && (s = Math.max(s, u(t.xw()).bm(), this.yn.rightPriceScale.minimumWidth)), i += t.z_();
          n = mn(n), s = mn(s);
          const e2 = this.C_, r3 = this.ho, h2 = Math.max(e2 - n - s, 0), a2 = 1 * this.Xw.length, l2 = this.yn.timeScale.visible;
          let o2 = l2 ? Math.max(this._M.Hw(), this.yn.timeScale.minimumHeight) : 0;
          var _2;
          o2 = (_2 = o2) + _2 % 2;
          const c2 = a2 + o2, d2 = r3 < c2 ? 0 : r3 - c2, f2 = d2 / i;
          let p2 = 0;
          ...
          for (let i2 = 0; i2 < this.Gw.length; ++i2) {
            ...
            e3.iw(this.sn.Zn()[i2]);
            let r4 = 0, a3 = 0;
            a3 = i2 === this.Gw.length - 1 ? Math.ceil((d2 - p2) * v2) / v2 : Math.round(e3.z_() * f2 * v2) / v2, r4 = Math.max(a3, 2), p2 += r4, e3.Cm(size({ width: h2, height: r4 })), this.yM() && e3.mw(n, "left"), this.kM() && e3.mw(s, "right"), e3.Sv() && this.sn.Id(e3.Sv(), r4);
          }
        ...
        aM(t) {
          if (!(0 !== t.deltaX && this.yn.handleScroll.mouseWheel || 0 !== t.deltaY && this.yn.handleScale.mouseWheel))
            return;
        ...
        zM(t, i, n, s) {
          ...
          const h2 = this.Qt().ou(), a2 = this.OM(s), l2 = function(t2, i2) {
            ...
            return null === t2 || void 0 === t2.ee ? { NM: n2, FM: s2 } : { NM: n2, FM: s2, WM: { ds: t2.ee, HM: (r4 = t2.lu, h3 = t2.ee, r4 instanceof ki ? "pane-primitive" : "marker" === h3 || "primitive" === h3 ? "series-primitive" : "series"), UM: vn(t2.ee, s2), U_: n2, $M: s2, jM: e3 } };
            var r4, h3;
          }(h2, a2);
          return { Qr: r3, $n: t ?? void 0, qM: i ?? void 0, jM: -1 !== a2 ? a2 : void 0, NM: l2.NM, YM: e2, FM: l2.FM, WM: l2.WM, KM: n ?? void 0 };
        }
        OM(t) {
          let i = -1;
          if (t)
      ...
      ds = class {
        ...
        sg(t, i) {
          ...
          if (void 0 !== e2)
            if (1 === this.tg.size)
              n = false, s = true, this.QM.clear();
            else
              for (const i2 of this.ng)
                i2.pointData.GM.delete(t) && (s = true);
          let r3 = [];
          if (0 !== i.length) {
            ...
            r3 = i.map((i2, r4) => {
              ...
              const c2 = h3(o2, u2.$n, i2, n2[r4], a2, l2);
              return u2.GM.set(t, c2), c2;
            });
          }
          n && this.eg(), this.rg(t, r3);
          let h2 = -1;
          if (s) {
            const t2 = [];
            this.QM.forEach((i2) => {
          ...
          return this.ag(t, h2, function(t2, i2, n2) {
            ...
            if (void 0 !== s2 && void 0 !== e3)
              return { lg: false, Ia: s2.JM >= e3.JM && s2.XM >= e3.XM };
        ...
        og(t, i, n) {
          ...
          const e2 = this.xu.createConverterToInternalObj([i])(i.time), r3 = this.ig.get(t);
          if (!n && void 0 !== r3 && this.xu.key(e2) < this.xu.key(r3))
            throw new Error(`Cannot update oldest data, last time=${r3}, new time=${e2}`);
          ...
          const l2 = os(t.bh()), o2 = t.ll(), _2 = t.ol(), u2 = l2(e2, h2.$n, i, s.Qr, o2, _2), c2 = !n && !a2 && void 0 !== r3 && this.xu.key(e2) === this.xu.key(r3);
          h2.GM.set(t, u2), n ? this._g(t, u2, h2.$n) : c2 && t.Na() && hs(u2) ? (t.Rr(u2), this.ug(t, u2)) : this.ug(t, u2);
          const d2 = { Ia: hs(u2), lg: n };
          if (!a2)
            return this.ag(t, -1, d2);
          ...
          for (let t2 = p2; t2 < this.ng.length; ++t2)
            fs(this.ng[t2].pointData, t2);
        ...
        cg(t, i) {
          ...
          for (const i2 of s) {
            ...
            if (n2 && (n2.GM.delete(t), 0 === n2.GM.size)) {
              ...
              for (let t2 = n2.$n; t2 < this.ng.length; ++t2)
                fs(this.ng[t2].pointData, t2);
            }
          }
        ...
        hg(t) {
          ...
          if (-1 === i && this.ng.length !== t.length && (i = Math.min(this.ng.length, t.length)), -1 === i)
            return -1;
          for (let n = i; n < t.length; ++n)
            fs(t[n].pointData, n);
      ...
      Vs = class extends Rs {
        ...
        Pg(t, i) {
          ...
          if (null != n)
            return { ne: (s = n).distance, se: Is(s.type), ee: "custom", mu: s.cursorStyle, te: s.objectId, ie: s.hitTestData };
          var s;
          const e2 = ys(this.bg, this.Sg, t, i, this.le.Et().fl(), this.ae.N().hitTestTolerance, (t2, i2) => {
            const n2 = t2.Lg;
            let s2 = NaN, e3 = NaN;
            if (void 0 !== n2 && !this.Yh.isWhitespace(n2))
              for (const t3 of this.Yh.priceValueBuilder(n2)) {
                const i3 = this.Ag(t3);
      ...
      js = { vertLine: { color: "#9598A1", width: 1, style: 3, visible: true, labelVisible: true, labelBackgroundColor: "#131722" }, horzLine: { color: "#9598A1", width: 1, style: 3, visible: true, labelVisible: true, labelBackgroundColor: "#131722" }, mode: 1, doNotSnapToHiddenSeriesIndices: false };
      qs = { vertLines: { color: "#D6DCDE", style: 0, visible: true }, horzLines: { color: "#D6DCDE", style: 0, visible: true } };
      Ys = { background: { type: "solid", color: "#FFFFFF" }, textColor: "#191919", fontSize: 12, fontFamily: S, panes: { enableResize: true, separatorColor: "#E0E3EB", separatorHoverColor: "rgba(178, 181, 189, 0.2)" }, attributionLogo: true, colorSpace: "srgb", colorParsers: [] };
      Ks = { autoScale: true, mode: 0, invertScale: false, alignLabels: true, borderVisible: true, borderColor: "#2B2B43", entireTextOnly: false, visible: false, ticksVisible: false, scaleMargins: { bottom: 0.1, top: 0.2 }, minimumWidth: 0, ensureEdgeTickMarksVisible: false, tickMarkDensity: 2.5 };
      Zs = { rightOffset: 0, barSpacing: 6, minBarSpacing: 0.5, maxBarSpacing: 0, fixLeftEdge: false, fixRightEdge: false, lockVisibleTimeRangeOnResize: false, rightBarStaysOnScroll: false, borderVisible: true, borderColor: "#2B2B43", visible: true, timeVisible: false, secondsVisible: true, shiftVisibleRangeOnNewBar: true, allowShiftVisibleRangeOnWhitespaceReplacement: false, ticksVisible: false, uniformDistribution: false, minimumHeight: 0, allowBoldLabels: true, ignoreWhitespaceIndices: false, enableConflation: false, conflationThresholdFactor: 1, precomputeConflationOnInit: false, precomputeConflationPriority: "background" };
      Xs = class {
        constructor(t, i, n) {
      ...
      Qs = { color: "#FF0000", price: 0, lineStyle: 2, lineWidth: 1, lineVisible: true, axisLabelVisible: true, title: "", axisLabelColor: "", axisLabelTextColor: "" };
      te = class {
        constructor(t) {
          this._r = t;
        }
      ...
      ie = class {
        constructor(t, i, n, s, e2, r3) {
          this.Hg = new d(), this.ae = t, this.Ug = i, this.$g = n, this.xu = e2, this.Fg = s, this.jg = r3;
        }
        m() {
          this.Hg.m();
        }
        ...
        barsInLogicalRange(t) {
          ...
          if (n.Gi())
            return null;
          const s = n.Hn(i.Oa(), 1), e2 = n.Hn(i.bi(), -1), r3 = u(n.Rh()), h2 = u(n.Qn());
          if (null !== s && null !== e2 && s.$n > e2.$n)
            return { barsBefore: t.from - r3, barsAfter: h2 - t.to };
          const a2 = { barsBefore: null === s || s.$n === r3 ? t.from - r3 : s.$n - r3, barsAfter: null === e2 || e2.$n === h2 ? h2 - t.to : h2 - e2.$n };
      ...
      ee = class {
        ...
        ub(t, i = {}, n = 0) {
          ...
          const s = f(M(e), M(t.defaultOptions), i), r3 = t.ob, h2 = new Jt(this.sv.Qt(), t.type, s, r3, t._b);
          this.sv.Qt().Gd(h2, n);
      ...
      ve = class extends R {
        ...
        et(t) {
          if (null === this.rt)
            return;
          const { ot: i, lt: n, wb: s, Mb: e2, ct: r3, Zt: h2, gb: l2 } = this.rt;
          if (null === n)
            return;
          const o2 = t.context;
          o2.lineCap = "butt", o2.lineWidth = r3 * t.verticalPixelRatio;
          const _2 = a(o2, h2);
          o2.lineJoin = "round";
          ...
          void 0 !== e2 && _e(t, i, e2, n, s, u2, pe, c2), l2 && function(t2, i2, n2, s2, e3) {
            if (s2.to - s2.from <= 0)
              return;
            const { horizontalPixelRatio: r4, verticalPixelRatio: h3, context: a2 } = t2;
            let l3 = null;
            const o3 = Math.max(1, Math.floor(r4)) % 2 / 2, _3 = n2 * h3 + o3;
            for (let n3 = s2.to - 1; n3 >= s2.from; --n3) {
              const s3 = i2[n3];
              if (s3) {
                const i3 = e3(t2, s3);
                i3 !== l3 && (null !== l3 && a2.fill(), a2.beginPath(), a2.fillStyle = i3, l3 = i3);
                const n4 = Math.round(s3._t * r4) + o3, u3 = s3.ut * h3;
      ...
      Se = class extends be {
        Pg(t, i) {
          const n = this.ae.N();
          return function(t2, i2, n2, s, e2, r3, h2, a2 = 0, l2 = 0) {
            if (null === i2 || i2.from >= i2.to || 0 === t2.length)
              return null;
            const o2 = Math.max(r3 / 2, h2 ?? 0) + l2;
            let _2 = Number.POSITIVE_INFINITY;
            if (void 0 !== h2) {
              const e3 = h2 + l2, r4 = ms(t2, n2 - e3, i2.from, i2.to), a3 = ws(t2, n2 + e3, r4, i2.to);
              for (let i3 = r4; i3 < a3; i3++) {
                const e4 = t2[i3];
                if (!gs(n2, e4._t, e4._t, h2 + l2))
                  continue;
                const r5 = Math.hypot(n2 - e4._t, s - e4.ut);
                r5 <= h2 + l2 && (_2 = Math.min(_2, r5));
              }
            }
            if (i2.to - i2.from < 2) {
              const e3 = t2[i2.from], r4 = Math.max(a2 / 2, o2), h3 = bs(n2, s, e3._t - r4, e3.ut, e3._t + r4, e3.ut);
            ...
            for (let i3 = f2; i3 < p2; i3++) {
              const r4 = t2[i3 - 1], h3 = t2[i3], [a3, l3] = Me(r4, h3, e2, t2, i3);
              if (!gs(n2, a3, l3, o2))
                continue;
              const _3 = ge(n2, s, r4, h3, e2, t2, i3, o2);
      ...
      ke = class {
        ...
        createConverterToInternalObj(t) {
          return this.yb(), (t2) => (t2 > this.kb && (this.kb = t2), t2);
        }
        key(t) {
          return t;
        }
        ...
        fillWeightsForPoints(t, i) {
          for (let s = i; s < t.length; ++s)
            t[s].timeWeight = (n = t[s].time) % 120 == 0 ? 10 : n % 60 == 0 ? 9 : n % 36 == 0 ? 8 : n % 12 == 0 ? 7 : n % 6 == 0 ? 6 : n % 3 == 0 ? 5 : n % 1 == 0 ? 4 : 0;
          var n;
          this.kb = t[t.length - 1].time, this.yb();
        }
        Tb(t) {
          if (this.yn.localization?.timeFormatter)
            return this.yn.localization.timeFormatter(t);
          if (t < 12)
            return `${t}M`;
      ...
      Pe = { yieldCurve: { baseResolution: 1, minimumTimeRange: 120, startTimeRange: 0 }, timeScale: { ignoreWhitespaceIndices: true }, leftPriceScale: { visible: true }, rightPriceScale: { visible: false }, localization: { priceFormatter: (t) => t.toFixed(3) + "%" } };
      Te = { lastValueVisible: false, priceLineVisible: false };
      Re = class extends ee {
        constructor(t, i) {
        ...
        addSeries(t, i = {}, n = 0) {
          if (t.isBuiltIn && false === ["Area", "Line"].includes(t.type))
        ...
        _initWhitespaceSeries() {
          ...
          let n;
          function s(s2) {
            const e2 = function(t2, i2) {
              return { me: Math.max(0, t2.startTimeRange), we: Math.max(0, t2.minimumTimeRange, i2 || 0), Rb: Math.max(1, t2.baseResolution) };
            }(t.options().yieldCurve, s2), r3 = (({ me: t2, we: i2, Rb: n2 }) => `${t2}~${i2}~${n2}`)(e2);
            r3 !== n && (n = r3, i.setData(function({ me: t2, we: i2, Rb: n2 }) {
              return Array.from({ length: Math.floor((i2 - t2) / n2) + 1 }, (i3, s3) => ({ time: t2 + s3 * n2 }));
            }(e2)));
          }
          s(0), t.Pb().i(s);
        }
      ...
      Ve = class {
        ...
        fillWeightsForPoints(t, i) {
          for (let s = i; s < t.length; ++s)
            t[s].timeWeight = (n = t[s].time) === 100 * Math.ceil(n / 100) ? 8 : n === 50 * Math.ceil(n / 50) ? 7 : n === 25 * Math.ceil(n / 25) ? 6 : n === 10 * Math.ceil(n / 10) ? 5 : n === 5 * Math.ceil(n / 5) ? 4 : n === Math.ceil(n) ? 3 : 2 * n === Math.ceil(2 * n) ? 1 : 0;
          var n;
        }
        Ds() {
      ...
      Ae = class extends R {
        ...
        et(t) {
          if (null === this.rt)
            return;
          const { ot: i, lt: n, wb: s, ct: e2, Zt: r3, Mb: h2 } = this.rt, l2 = this.rt.Db ?? (this.rt.Ib ? 0 : t.mediaSize.height);
          if (null === n)
            return;
          const o2 = t.context;
          o2.lineCap = "butt", o2.lineJoin = "round", o2.lineWidth = e2, a(o2, r3), o2.lineWidth = 1, _e(t, i, h2, n, s, this.Vb.bind(this), Ee.bind(null, l2));
        }
      };
      Le = class {
        Bb(t, i) {
          const n = this.Eb, { Ab: s, Lb: e2, zb: r3, Ob: h2, Db: a2, Nb: l2, Fb: o2 } = i;
          if (void 0 === this.Wb || void 0 === n || n.Ab !== s || n.Lb !== e2 || n.zb !== r3 || n.Ob !== h2 || n.Db !== a2 || n.Nb !== l2 || n.Fb !== o2) {
            ...
            if (f2.addColorStop(0, s), null != a2) {
              ...
              f2.addColorStop(t2, e2), f2.addColorStop(t2, r3);
            }
      ...
      ze = class extends Ae {
        ...
        Vb(t, i) {
          const n = this.rt;
          return this.Hb.Bb(t, { Ab: i.dh, Lb: i.fh, zb: i.ph, Ob: i.mh, Db: n.Db, Nb: n.Nb ?? 0, Fb: n.Fb ?? t.bitmapSize.height });
        }
      };
      Oe = class extends ve {
        constructor() {
        ...
        bb(t, i) {
          const n = this.rt;
          return this.Ub.Bb(t, { Ab: i._h, Lb: i._h, zb: i.uh, Ob: i.uh, Db: n.Db, Nb: n.Nb ?? 0, Fb: n.Fb ?? t.bitmapSize.height });
        }
      };
      Ne = class extends Se {
        constructor(t, i) {
          super(t, i), this.kg = new T(), this.$b = new ze(), this.jb = new Oe(), this.kg.nt([this.$b, this.jb]);
        }
        xb(t, i, n) {
          return { ...this.Sb(t, i), ...n.Sh(t) };
        }
        Bg() {
          ...
          if (null === this.Sg || 0 === this.bg.length)
            return;
          let e2, r3;
          if (i.relativeGradient) {
            e2 = this.bg[this.Sg.from].ut, r3 = this.bg[this.Sg.from].ut;
            for (let t2 = this.Sg.from; t2 < this.Sg.to; t2++) {
              const i2 = this.bg[t2];
              i2.ut < e2 && (e2 = i2.ut), i2.ut > r3 && (r3 = i2.ut);
            }
          }
          this.$b.ht({ ot: this.bg, ct: i.lineWidth, Zt: i.lineStyle, Mb: i.lineType, Db: n, Nb: e2, Fb: r3, Ib: false, lt: this.Sg, wb: s }), this.jb.ht({ ot: this.bg, ct: i.lineWidth, Zt: i.lineStyle, Mb: i.lineVisible ? i.lineType : void 0, gb: i.pointMarkersVisible ? i.pointMarkersRadius || i.lineWidth / 2 + 2 : void 0, Db: n, Nb: e2, Fb: r3, lt: this.Sg, wb: s });
        }
      };
      Fe = { type: "Baseline", isBuiltIn: true, defaultOptions: { baseValue: { type: "price", price: 0 }, relativeGradient: false, topFillColor1: "rgba(38, 166, 154, 0.28)", topFillColor2: "rgba(38, 166, 154, 0.05)", topLineColor: "rgba(38, 166, 154, 1)", bottomFillColor1: "rgba(239, 83, 80, 0.05)", bottomFillColor2: "rgba(239, 83, 80, 0.28)", bottomLineColor: "rgba(239, 83, 80, 1)", lineWidth: 3, lineStyle: 0, lineType: 0, lineVisible: true, crosshairMarkerVisible: true, crosshairMarkerRadius: 4, crosshairMarkerBorderColor: "", crosshairMarkerBorderWidth: 2, crosshairMarkerBackgroundColor: "", lastPriceAnimation: 0, pointMarkersVisible: false }, ob: (t, i) => new Ne(t, i) };
      We = class extends Ae {
        constructor() {
          super(...arguments), this.Hb = new Le();
        }
      ...
      $e = class extends R {
        ...
        et({ context: t, horizontalPixelRatio: i, verticalPixelRatio: n }) {
          ...
          let s = null;
          const e2 = this.Zb <= this.Kb && this.qt.fl >= Math.floor(1.5 * i);
          for (let r3 = this.qt.lt.from; r3 < this.qt.lt.to; ++r3) {
            const h2 = this.qt.Un[r3];
            s !== h2.sh && (t.fillStyle = h2.sh, s = h2.sh);
            const a2 = Math.floor(0.5 * this.Zb), l2 = Math.round(h2._t * i), o2 = l2 - a2, _2 = this.Zb, u2 = o2 + _2 - 1, c2 = Math.min(h2.Qo, h2.t_), d2 = Math.max(h2.Qo, h2.t_), f2 = Math.round(c2 * n) - a2, p2 = Math.round(d2 * n) + a2, v2 = Math.max(p2 - f2, this.Zb);
            t.fillRect(o2, f2, _2, v2);
            const m2 = Math.ceil(1.5 * this.Kb);
            if (e2) {
              if (this.qt.Jb) {
                const i3 = l2 - m2;
                let s3 = Math.max(f2, Math.round(h2.Jo * n) - a2), e4 = s3 + _2 - 1;
                e4 > f2 + v2 - 1 && (e4 = f2 + v2 - 1, s3 = e4 - _2 + 1), t.fillRect(i3, s3, o2 - i3, e4 - s3 + 1);
              }
              const i2 = l2 + m2;
              let s2 = Math.max(f2, Math.round(h2.i_ * n) - a2), e3 = s2 + _2 - 1;
              e3 > f2 + v2 - 1 && (e3 = f2 + v2 - 1, s2 = e3 - _2 + 1), t.fillRect(u2 + 1, s2, i2 - u2, e3 - s2 + 1);
            }
          }
        }
        Gb(t) {
      ...
      qe = class extends je {
        ...
        Bg() {
          const t = this.ae.N();
          this.kg.ht({ Un: this.bg, fl: this.le.Et().fl(), Jb: t.openVisible, Xb: t.thinBars, lt: this.Sg });
        }
      };
      Ye = { type: "Bar", isBuiltIn: true, defaultOptions: { upColor: "#26a69a", downColor: "#ef5350", openVisible: true, thinBars: true }, ob: (t, i) => new qe(t, i) };
      Ke = class extends R {
        constructor() {
        ...
        et(t) {
          ...
          if (this.Kb = function(t2, i2) {
            ...
            const n2 = 1 - 0.2 * Math.atan(Math.max(4, t2) - 4) / (0.5 * Math.PI), s2 = Math.floor(t2 * n2 * i2), e2 = Math.floor(t2 * i2), r3 = Math.min(s2, e2);
            return Math.max(Math.floor(i2), r3);
        ...
        iS(t, i, n) {
          if (null === this.qt)
            return;
          const { context: s, horizontalPixelRatio: e2, verticalPixelRatio: r3 } = t;
          ...
          for (let t2 = n.from; t2 < n.to; t2++) {
            ...
            const _2 = Math.round(Math.min(n2.Jo, n2.i_) * r3), u2 = Math.round(Math.max(n2.Jo, n2.i_) * r3), c2 = Math.round(n2.Qo * r3), d2 = Math.round(n2.t_ * r3);
        ...
        Rm(t, i, n) {
          ...
          for (let t2 = n.from; t2 < n.to; t2++) {
            ...
            const _2 = o2 + this.Kb - 1, u2 = Math.round(Math.min(n2.Jo, n2.i_) * r3), c2 = Math.round(Math.max(n2.Jo, n2.i_) * r3);
            if (null !== l2 && (o2 = Math.max(l2 + 1, o2), o2 = Math.min(o2, _2)), this.qt.fl * e2 > 2 * a2)
              L(s, o2, u2, _2 - o2 + 1, c2 - u2 + 1, a2);
            else {
              const t3 = _2 - o2 + 1;
        ...
        sS(t, i, n) {
          ...
          for (let t2 = n.from; t2 < n.to; t2++) {
            const n2 = i[t2];
            let l2 = Math.round(Math.min(n2.Jo, n2.i_) * r3), o2 = Math.round(Math.max(n2.Jo, n2.i_) * r3), _2 = Math.round(n2._t * e2) - Math.floor(0.5 * this.Kb), u2 = _2 + this.Kb - 1;
            if (n2.sh !== h2) {
              const t3 = n2.sh;
      ...
      Ge = { type: "Candlestick", isBuiltIn: true, defaultOptions: { upColor: "#26a69a", downColor: "#ef5350", wickVisible: true, borderVisible: true, borderColor: "#378658", borderUpColor: "#26a69a", borderDownColor: "#ef5350", wickColor: "#737375", wickUpColor: "#26a69a", wickDownColor: "#ef5350" }, ob: (t, i) => new Ze(t, i) };
      Xe = class extends R {
        constructor() {
        ...
        et({ context: t, horizontalPixelRatio: i, verticalPixelRatio: n }) {
          ...
          const s = Math.max(1, Math.floor(n)), e2 = Math.round(this.qt.hS * n) - Math.floor(s / 2), r3 = e2 + s;
          for (let i2 = this.qt.lt.from; i2 < this.qt.lt.to; i2++) {
            const h2 = this.qt.ot[i2], a2 = this.eS[i2 - this.qt.lt.from], l2 = Math.round(h2.ut * n);
            let o2, _2;
            t.fillStyle = h2.sh, l2 <= e2 ? (o2 = l2, _2 = r3) : (o2 = e2, _2 = l2 - Math.floor(s / 2) + s), t.fillRect(a2.Oa, o2, a2.bi - a2.Oa + 1, _2 - o2);
          }
        }
        rS(t) {
          if (null === this.qt || 0 === this.qt.ot.length || null === this.qt.lt)
          ...
          for (let i2 = this.qt.lt.from; i2 < this.qt.lt.to; i2++) {
            ...
            this.eS[i2 - this.qt.lt.from] = { Oa: r3, bi: h2, aS: e2, ce: s2._t * t, wt: s2.wt };
          }
      ...
      Qe = { type: "Histogram", isBuiltIn: true, defaultOptions: { color: "#26a69a", base: 0 }, ob: (t, i) => new Je(t, i) };
      tr = class {
        constructor(t, i) {
      ...
      ir = { visible: true, horzAlign: "center", vertAlign: "center", lines: [] };
      nr = { color: "rgba(0, 0, 0, 0.5)", fontSize: 48, fontFamily: S, fontStyle: "", text: "" };
      sr = class {
        constructor(t) {
          this._S = /* @__PURE__ */ new Map(), this.qt = t;
        }
        draw(t) {
          t.useMediaCoordinateSpace((t2) => {
            if (!this.qt.visible)
              return;
            const { context: i, mediaSize: n } = t2;
            let s = 0;
            for (const t3 of this.qt.lines) {
              if (0 === t3.text.length)
                continue;
              i.font = t3.P;
              const e3 = this.uS(i, t3.text);
              e3 > n.width ? t3.Fc = n.width / e3 : t3.Fc = 1, s += t3.lineHeight * t3.Fc;
            }
            let e2 = 0;
            ...
            for (const t3 of this.qt.lines) {
              i.save(), i.fillStyle = t3.color;
              let s2 = 0;
              switch (this.qt.horzAlign) {
                case "left":
                  i.textAlign = "left", s2 = t3.lineHeight / 2;
                  break;
                case "center":
                  i.textAlign = "center", s2 = n.width / 2;
                  break;
                case "right":
                  i.textAlign = "right", s2 = n.width - 1 - t3.lineHeight / 2;
              }
              i.translate(s2, e2), i.textBaseline = "top", i.font = t3.P, i.scale(t3.Fc, t3.Fc), i.fillText(t3.text, 0, t3.cS), i.restore(), e2 += t3.lineHeight * t3.Fc;
            }
          });
        }
        uS(t, i) {
        ...
        dS(t) {
          let i = this._S.get(t);
          return void 0 === i && (i = /* @__PURE__ */ new Map(), this._S.set(t, i)), i;
        }
      };
      er = class {
        constructor(t) {
      ...
      or = class {
        constructor(t) {
          this.yn = lr(t), this.fS = [new er(this.yn)];
        }
        updateAllViews() {
        ...
        vr(t) {
          this.yn = lr({ ...this.yn, ...t }), this.pS && this.pS();
        }
      };
      ur = { alpha: 1, padding: 0 };
      cr = class {
        constructor(t) {
          this.qt = t;
        }
        draw(t) {
          t.useMediaCoordinateSpace((t2) => {
            const i = t2.context, n = this.vS(this.qt, t2.mediaSize);
            n && this.qt.mS && (i.globalAlpha = this.qt.alpha ?? 1, i.drawImage(this.qt.mS, n._t, n.ut, n.nn, n.$t));
          });
        }
        vS(t, i) {
          const { maxHeight: n, maxWidth: s, wS: e2, MS: r3, padding: h2 } = t, a2 = Math.round(i.width / 2), l2 = Math.round(i.height / 2), o2 = h2 ?? 0;
          let _2 = i.width - 2 * o2, u2 = i.height - 2 * o2;
          n && (u2 = Math.min(u2, n)), s && (_2 = Math.min(_2, s));
          const c2 = _2 / r3, d2 = u2 / e2, f2 = Math.min(c2, d2), p2 = r3 * f2, v2 = e2 * f2;
          return { _t: a2 - 0.5 * p2, ut: l2 - 0.5 * v2, $t: v2, nn: p2 };
        }
      };
      dr = class {
        constructor(t) {
      ...
      vr = class {
        constructor(t, i) {
          this.TS = null, this.RS = t, this.yn = pr(i), this.fS = [new dr(this.yn)];
        }
        updateAllViews() {
        ...
        attached(t) {
          ...
          this.DS = i, this.TS = new Image(), this.TS.onload = () => {
            const t2 = this.TS?.naturalHeight ?? 1, i2 = this.TS?.naturalWidth ?? 1;
            this.fS.forEach((n) => n.xS({ yS: t2, CS: i2, kS: this.TS })), this.DS && this.DS();
          }, this.TS.src = this.RS;
        }
        detached() {
        ...
        vr(t) {
          this.yn = pr({ ...this.yn, ...t }), this.IS(), this.pS && this.pS();
        }
        pS() {
          this.DS && this.DS();
        }
      ...
      Mr = { autoScale: true, zOrder: "normal" };
      Pr = class {
        constructor() {
        ...
        Qs(t, i) {
          ...
          for (let n = this.qt.lt.from; n < this.qt.lt.to; n++) {
            ...
            if (s && Rr(s, t, i))
              return { zOrder: "normal", externalId: s.te ?? "", itemType: "marker" };
          }
          return null;
        }
        draw(t) {
      ...
      Vr = class {
        ...
        yg() {
          ...
          for (let s2 = this.qt.lt.from; s2 < this.qt.lt.to; s2++) {
            const e3 = i[s2];
            e3.time !== r3 && (a2.LS = h2, a2.zS = h2, r3 = e3.time);
      ...
      Er = class {
        ...
        autoscaleInfo(t, i) {
          if (this.yn.autoScale && this.Yh) {
            const t2 = this.QS();
            if (t2)
              return { priceRange: null, margins: t2 };
          }
          return null;
        }
        vr(t) {
        ...
        GS() {
          ...
          this.US = this.OS.map((i2, s) => {
            const e2 = t.timeToIndex(i2.time, true), r3 = e2 < n ? 1 : -1, h2 = u(this.Te).dataByIndex(e2, r3), a2 = { time: t.timeToIndex(u(h2).time, false), position: i2.position, shape: i2.shape, color: i2.color, id: i2.id, HS: s, text: i2.text, size: i2.size, price: i2.price, Qr: i2.time };
            if ("atPriceTop" === i2.position || "atPriceBottom" === i2.position || "atPriceMiddle" === i2.position) {
              if (void 0 === i2.price)
                throw new Error(`Price is required for position ${i2.position}`);
      ...
      zr = class {
        constructor(t) {
          this.OS = /* @__PURE__ */ new Map(), this.ix = t;
        }
        nx(t, i, n) {
          if (this.sx(i), void 0 !== n) {
            const s = window.setTimeout(() => {
              this.OS.delete(i), this.hx();
            }, n), e2 = { ...t, lx: s, ox: Date.now() + n };
            this.OS.set(i, e2);
          } else
            this.OS.set(i, { ...t, lx: void 0, ox: void 0 });
          this.hx();
        }
        sx(t) {
        ...
        _x() {
          for (const [t] of this.OS)
            this.sx(t);
        }
        ux() {
          const t = Date.now(), i = [];
          for (const [n, s] of this.OS)
            !s.ox || s.ox > t ? i.push({ time: s.time, sign: s.sign, value: s.value }) : this.sx(n);
          return i;
        }
        vx(t) {
          this.ix = t;
      ...
      Or = { positiveColor: "#22AB94", negativeColor: "#F7525F", updateVisibilityDuration: 5e3 };
      Nr = class {
        constructor(t, i, n, s) {
          this.qt = t, this.mx = i, this.wx = n, this.Mx = s;
        }
        draw(t) {
          t.useBitmapCoordinateSpace((t2) => {
            const i = t2.context, n = Math.max(1, Math.floor(t2.horizontalPixelRatio)) % 2 / 2, s = 4 * t2.verticalPixelRatio + n;
            this.qt.forEach((e2) => {
              const r3 = Math.round(e2._t * t2.horizontalPixelRatio) + n;
              i.beginPath();
              const h2 = this.gx(e2.bx);
              i.fillStyle = h2, i.arc(r3, e2.ut * t2.verticalPixelRatio, s, 0, 2 * Math.PI, false), i.fill(), e2.bx && (i.strokeStyle = h2, i.lineWidth = Math.floor(2 * t2.horizontalPixelRatio), i.beginPath(), i.moveTo((e2._t - 4.7) * t2.horizontalPixelRatio + n, (e2.ut - 7 * e2.bx) * t2.verticalPixelRatio), i.lineTo(e2._t * t2.horizontalPixelRatio + n, (e2.ut - 7 * e2.bx - 7 * e2.bx * 0.5) * t2.verticalPixelRatio), i.lineTo((e2._t + 4.7) * t2.horizontalPixelRatio + n, (e2.ut - 7 * e2.bx) * t2.verticalPixelRatio), i.stroke());
            });
          });
        }
        gx(t) {
      ...
      Fr = class {
        ...
        kt(t) {
          this.qt = t.map((t2) => {
            const i = this.Te.priceToCoordinate(t2.value);
            if (null === i)
              return null;
            return { _t: u(this.ia.timeToCoordinate(t2.time)), ut: i, bx: t2.sign };
          }).filter(g);
        }
        renderer() {
          const t = function(t2, i) {
            return /* @__PURE__ */ function(t3, i2) {
              return "Area" === i2;
            }(0, i) ? t2.lineColor : t2.color;
      ...
      Hr = class {
        constructor(t) {
          this.qv = void 0, this.Te = void 0, this.fS = [], this.xu = null, this.Sx = /* @__PURE__ */ new Map(), this.xx = new zr(() => this.pS()), this.yn = { ...Or, ...t };
        }
        vr(t) {
          this.yn = { ...this.yn, ...t }, this.pS();
        }
        FS(t) {
          this.xx._x();
          const i = this.xu;
          i && t.forEach((t2) => {
            this.xx.nx(t2, i.key(t2.time));
          });
        }
        XS() {
          return this.xx.ux();
        ...
        attached(t) {
          const { chart: i, series: n, requestUpdate: s, horzScaleBehavior: e2 } = t;
          this.qv = i, this.Te = n, this.xu = e2;
          const r3 = this.Te.seriesType();
          if ("Area" !== r3 && "Line" !== r3)
            throw new Error("UpDownMarkersPrimitive is only supported for Area and Line series types");
          this.fS = [new Fr(this.Te, this.qv.timeScale(), this.yn)], this.DS = s, this.pS();
        }
        detached() {
        ...
        ht(t) {
          ...
          const n = this.xu;
          n && t.forEach((t2) => {
            Qn(t2) && Wr(0, i) && this.Sx.set(n.key(t2.time), t2.value);
          }), _(this.Te).setData(t);
        }
        kt(t, i) {
          if (!this.Te || !this.xu)
          ...
          if (Jn(t) && this.Sx.delete(s), Qn(t) && Wr(0, n)) {
            const i2 = this.Sx.get(s);
            i2 && this.xx.nx({ time: t.time, value: t.value, sign: Ur(t.value, i2) }, s, this.yn.updateVisibilityDuration);
          }
  ...
  var ApiClient = class {
    ...
    async get(path) {
      ...
      if (!r3.ok)
        throw new ApiError(r3.status, await r3.text().catch(() => r3.statusText), path);
      return r3.json();
    }
    async post(path, body) {
      const r3 = await fetch(`${this.cfg.base}${path}`, {
        method: "POST",
    ...
    personas() {
      return this.get("/api/v1/personas");
    }
    scorePersona(id, body) {
      return this.post(`/api/v1/personas/${encodeURIComponent(id)}/score`, body);
    }
    topics() {
      return this.get("/api/v1/topics");
    }
    publishTopic(topic, value) {
      return this.post(`/api/v1/topics/${encodeURIComponent(topic)}/publish`, value);
    }
    peekTopic(topic) {
  ...
  var WsClient = class {
    constructor(url3, heartbeatMs = 25e3) {
      ...
      __publicField(this, "msgListeners", /* @__PURE__ */ new Set());
      __publicField(this, "stateListeners", /* @__PURE__ */ new Set());
      __publicField(this, "patterns", /* @__PURE__ */ new Set());
      __publicField(this, "heartbeat");
      __publicField(this, "reconnectTimer");
      __publicField(this, "retry", 0);
      __publicField(this, "explicitlyClosed", false);
    }
    open() {
    ...
    send(msg) {
      if (msg.op === "subscribe")
        this.patterns.add(msg.pattern);
      if (this.socket?.readyState === WebSocket.OPEN) {
        this.socket.send(JSON.stringify(msg));
      }
    }
    subscribe(pattern) {
      this.send({ op: "subscribe", pattern });
    }
    publish(topic, value) {
      this.send({ op: "publish", topic, value });
    }
    ping() {
      this.send({ op: "ping" });
    }
    onMessage(l2) {
      ...
      return () => this.msgListeners.delete(l2);
    }
    onStateChange(l2) {
      this.stateListeners.add(l2);
      l2(this.state);
      return () => this.stateListeners.delete(l2);
    }
    getState() {
      return this.state;
    }
    connect() {
      ...
      this.socket.onopen = () => {
        this.retry = 0;
        this.setState("open");
        for (const p2 of this.patterns)
          this.send({ op: "subscribe", pattern: p2 });
      ...
      this.socket.onmessage = (ev) => {
        ...
        for (const l2 of this.msgListeners)
          l2(parsed);
      };
      this.socket.onclose = () => {
        if (this.heartbeat)
    ...
    scheduleReconnect() {
      ...
      const delay = Math.min(3e4, 500 * 2 ** Math.min(this.retry, 6));
      this.retry++;
    ...
    setState(s) {
      if (s === this.state)
        return;
      this.state = s;
      for (const l2 of this.stateListeners)
        l2(s);
    }
  };
  ...
  // src/typescript/api/config.ts
  var FALLBACK = {
    base: "https://api.diegonmarcos.com/fin-api",
    ws: "wss://api.diegonmarcos.com/fin-api/api/v1/ws"
  };
  var cfg = build_default.api ?? {};
  var API_CONFIG = {
  ...
  // src/typescript/shell/dom.ts
  function el(tag, attrs = {}, children = []) {
    const node = document.createElement(tag);
    for (const [k2, v2] of Object.entries(attrs)) {
      if (k2 === "class")
        node.className = v2;
      else if (k2.startsWith("on"))
        node[k2] = v2;
      else
        node.setAttribute(k2, v2);
    }
    for (const c2 of children) {
      if (typeof c2 === "string")
        node.appendChild(document.createTextNode(c2));
      else
        node.appendChild(c2);
    }
    return node;
  ...
  // src/typescript/shell/command-bar.ts
  var CommandBar = class {
    constructor(opts) {
      ...
      const goBtn = el("button", { class: "command-bar__go", type: "button" }, ["<GO>"]);
      ...
      this.node = el("div", { class: "command-bar", role: "toolbar" }, [
        ...
        el("span", { class: "command-bar__prompt" }, ["\xBB"]),
        this.input,
        goBtn,
    ...
    setValue(v2) {
      this.input.value = v2.toUpperCase();
    }
    submit() {
  ...
  // src/typescript/shell/panel.ts
  var Panel = class {
    constructor(panelId) {
      __publicField(this, "node");
      __publicField(this, "chromeTitle");
    ...
    mount(title, modifierClass) {
      ...
      return {
        body: this.body,
        setTitle: (t) => {
          this.chromeTitle.textContent = t;
        }
      };
    }
  };
  function now() {
    ...
    return d2.toISOString().slice(11, 19) + " UTC";
  }

  // src/typescript/data/function-keys.json
  var function_keys_default = {
    description: "F1-F12 mapping inspired by Bloomberg's yellow market-sector keys. Maps function keys to existing screen IDs from screen-registry.json + screen-specs.json. F1=HELP is special (opens settings).",
    keys: [
      { key: "F1", label: "HELP", color: "action_key", screen: "settings" },
      { key: "F2", label: "EQUITY", color: "function_key", screen: "markets-dashboard" },
      { key: "F3", label: "GOVT", color: "function_key", screen: "fixed-income-curve" },
      { key: "F4", label: "CORP", color: "function_key", screen: "fixed-income-credit" },
      { key: "F5", label: "RSCH", color: "function_key", screen: "equity-research" },
      { key: "F6", label: "PORT", color: "function_key", screen: "portfolio" },
      { key: "F7", label: "CMDTY", color: "function_key", screen: "commodities" },
      { key: "F8", label: "INDEX", color: "function_key", screen: "markets-indices" },
      { key: "F9", label: "CRNCY", color: "function_key", screen: "forex-majors" },
      { key: "F10", label: "CRYPTO", color: "function_key", screen: "crypto" },
      { key: "F11", label: "NEWS", color: "function_key", screen: "news" },
      { key: "F12", label: "AI", color: "function_key", screen: "ai-chat" }
    ]
  };

  // src/typescript/shell/function-bar.ts
  var FunctionBar = class {
    constructor(onActivate) {
      __publicField(this, "node");
      __publicField(this, "keys");
      this.keys = function_keys_default.keys;
      this.node = el("div", { class: "function-bar", role: "toolbar" });
      for (const k2 of this.keys) {
        const colorClass = k2.color === "action_key" ? "function-bar__key--action" : k2.color === "cancel_key" ? "function-bar__key--cancel" : "function-bar__key--default";
        const btn = el("button", {
          class: `function-bar__key ${colorClass}`,
          type: "button",
          "data-screen": k2.screen,
          title: `${k2.key} \u2192 ${k2.screen}`
        }, [
          el("span", { class: "function-bar__key-label" }, [k2.key]),
          el("span", { class: "function-bar__key-name" }, [k2.label])
        ]);
        btn.addEventListener("click", () => onActivate(k2.screen));
        this.node.appendChild(btn);
      }
    }
    resolveKey(eventKey) {
      const found = this.keys.find((k2) => k2.key === eventKey);
      return found ? found.screen : null;
    }
  };

  // src/typescript/shell/status-bar.ts
  var StatusBar = class {
    constructor(onCycleTheme) {
      __publicField(this, "node");
      __publicField(this, "conn");
      __publicField(this, "connDot");
      __publicField(this, "connLabel");
      __publicField(this, "topics");
      __publicField(this, "latency");
      ...
      this.clock = el("span", { class: "status-bar__cell" }, [el("span", { class: "status-bar__value" }, [now2()])]);
    ...
    update(s) {
      if (s.connection !== void 0) {
        ...
        if (s.connection === "open")
          this.conn.classList.add("status-bar__cell--ok");
        else if (s.connection === "connecting" || s.connection === "reconnecting")
          this.conn.classList.add("status-bar__cell--warn");
        else
          this.conn.classList.add("status-bar__cell--down");
      }
      if (s.topics !== void 0)
        this.topics.lastElementChild.textContent = s.topics === null ? "\u2014" : String(s.topics);
      if (s.latency_ms !== void 0)
        this.latency.lastElementChild.textContent = s.latency_ms === null ? "\u2014" : `${s.latency_ms}ms`;
      if (s.user !== void 0)
        this.user.lastElementChild.textContent = s.user;
      if (s.build !== void 0)
        this.build.lastElementChild.textContent = s.build;
      if (s.themeName !== void 0)
        this.themeBtn.textContent = `theme: ${s.themeName}`;
    }
    setClock(t) {
      this.clock.lastElementChild.textContent = t;
    }
  };
  function now2() {
  ...
  var Nav = class {
    ...
    setActive(id) {
      for (const [k2, btn] of this.buttons) {
        btn.classList.toggle("nav__item--active", k2 === id);
      }
    }
  };
  ...
  var themes_default = {
    default: "bloomberg-dark",
    themes: [
      {
        id: "bloomberg-dark",
        name: "Bloomberg Dark",
        file: "palette-bloomberg-dark.json"
      },
      {
        id: "egui-dark",
        name: "egui \u2014 GitHub Dark",
        file: "palette-egui-dark.json",
        source_of_truth: "fin-api/src/code/assets/themes/dark.json",
        description: "Copied verbatim from the egui desktop's dark theme (GitHub-dark palette). Diff-guarded by tests."
      }
    ]
  };

  // src/typescript/data/palette-bloomberg-dark.json
  var palette_bloomberg_dark_default = {
    id: "bloomberg-dark",
    name: "Bloomberg Dark",
    description: "Authentic Bloomberg-terminal amber-on-black. Sunshade #FFA028 default text on true black, hard rectangles, monospace everywhere.",
    palette: {
      background: "#000000",
      surface: "#0a0a0a",
      surface_alt: "#141414",
    ...
    fonts: {
      monospace_family: "'IBM Plex Mono', 'JetBrains Mono', 'SF Mono', Menlo, Consolas, 'Courier New', monospace",
      size_small: 11,
      size_body: 12,
      size_heading: 14,
      size_data: 12
  ...
  // src/typescript/data/palette-egui-dark.json
  var palette_egui_dark_default = {
    name: "dark",
    mode: "dark",
    palette: {
      background: "#0d1117",
  ...
  // src/typescript/shell/theme.ts
  var PAYLOADS = {
    "bloomberg-dark": palette_bloomberg_dark_default,
    "egui-dark": palette_egui_dark_default
  };
  var REQUIRED_PALETTE_KEYS = [
    "background",
    "surface",
    "surface_alt",
    "text",
  ...
  function loadTheme(id) {
    ...
    if (!raw)
      throw new Error(`no inline payload for theme: ${id}`);
    return normalize(entry.id, entry.name, raw);
  }
  function normalize(id, name, raw) {
    const palette = raw.palette ?? raw;
    for (const k2 of REQUIRED_PALETTE_KEYS) {
      if (!palette[k2])
        throw new Error(`palette ${id} missing required key: ${k2}`);
    }
    const fonts = raw.fonts ?? {};
    return { id, name, palette, fonts };
  }
  function applyTheme(t, root2 = document.documentElement) {
    const p2 = t.palette;
    const setVar = (k2, v2) => {
      if (v2)
        root2.style.setProperty(k2, v2);
    };
    setVar("--color-background", p2["background"]);
    setVar("--color-surface", p2["surface"]);
    setVar("--color-surface-alt", p2["surface_alt"]);
    setVar("--color-border", p2["border"] ?? p2["grid"]);
    setVar("--color-text", p2["text"]);
    setVar("--color-text-muted", p2["text_muted"]);
    setVar("--color-text-primary", p2["text_primary"] ?? p2["text"]);
    setVar("--color-accent", p2["accent"]);
    setVar("--color-positive", p2["positive"]);
    setVar("--color-negative", p2["negative"]);
    setVar("--color-warning", p2["warning"]);
    setVar("--color-info", p2["info"] ?? p2["accent"]);
    setVar("--color-function-key", p2["function_key"] ?? p2["warning"]);
    setVar("--color-action-key", p2["action_key"] ?? p2["positive"]);
    setVar("--color-cancel-key", p2["cancel_key"] ?? p2["negative"]);
    setVar("--color-grid", p2["grid"]);
    if (t.fonts?.monospace_family)
      setVar("--font-mono", t.fonts.monospace_family);
    if (t.fonts?.size_small)
      setVar("--font-size-small", `${t.fonts.size_small}px`);
    if (t.fonts?.size_body)
      setVar("--font-size-body", `${t.fonts.size_body}px`);
    if (t.fonts?.size_heading)
      setVar("--font-size-heading", `${t.fonts.size_heading}px`);
    if (t.fonts?.size_data)
      setVar("--font-size-data", `${t.fonts.size_data}px`);
    document.body.dataset["theme"] = t.id;
  }
  var STORAGE_KEY = "fin-terminal:theme";
  ...
  var screen_registry_default = {
    ...
    custom: [
      ...
      { id: "crypto", title: "Crypto", category: "crypto", module: "crypto" },
      { id: "economics", title: "Economics", category: "economics", module: "economics" },
      { id: "settings", title: "Settings", category: "system", module: "settings" }
    ]
  };

  // src/typescript/data/screen-specs.json
  var screen_specs_default = {
    note: "41 spec-driven screens interpreted by crates/ui/ui-screens::SpecScreen. Custom screens (10 Phase-8 ones) live as their own structs in ui-screens. Total: 51 screens matching upstream FinceptTerminal v4.",
    specs: [
      { id: "markets-indices", title: "Markets \u2014 Indices", category: "markets", summary: "S&P 500, NASDAQ, Dow, world indices with change + range." },
      { id: "markets-sectors", title: "Markets \u2014 Sectors", category: "markets", summary: "Sector rotation heatmap (tech, finance, energy, healthcare\u2026)." },
      { id: "markets-heatmap", title: "Markets \u2014 Heatmap", category: "markets", summary: "Colour-graded grid of constituents by % change." },
      { id: "markets-breadth", title: "Markets \u2014 Breadth", category: "markets", summary: "Advance/decline, new highs/lows, %-above-MA50." },
      { id: "news-by-symbol", title: "News by Symbol", category: "news", summary: "Filtered news stream for the selected watchlist symbol." },
      { id: "news-sentiment", title: "News Sentiment", category: "news", summary: "Adanos-style sentiment aggregator across retail + finance news." },
      { id: "portfolio-blotter", title: "Portfolio Blotter", category: "portfolio", summary: "Trade blotter \u2014 every fill with P&L attribution." },
      { id: "portfolio-allocation", title: "Portfolio Allocation", category: "portfolio", summary: "Holdings breakdown by sector / region / currency." },
      { id: "portfolio-performance", title: "Portfolio Performance", category: "portfolio", summary: "Equity curve, drawdown, benchmark overlay." },
      { id: "trading-orders", title: "Open Orders", category: "trading", summary: "Live order book across registered brokers." },
      { id: "trading-fills", title: "Fills", category: "trading", summary: "Execution log with VWAP vs mid slippage." },
      { id: "trading-orderbook", title: "Order Book", category: "trading", summary: "Top-of-book L1/L2 depth for selected symbol." },
      { id: "equity-screener", title: "Equity Screener", category: "research", summary: "Filter universe by P/E, ROE, growth, moat." },
      { id: "equity-valuation", title: "Valuation Model", category: "research", summary: "DCF, peer multiples, persona-driven recommendation." },
      { id: "equity-peers", title: "Peer Analysis", category: "research", summary: "Side-by-side comps across peer set." },
      { id: "equity-insider", title: "Insider Activity", category: "research", summary: "SEC EDGAR insider transactions timeline." },
      { id: "crypto-exchanges", title: "Crypto Exchanges", category: "crypto", summary: "Spot + futures across Kraken, Binance, Coinbase." },
      { id: "crypto-defi", title: "DeFi", category: "crypto", summary: "TVL, yields, protocol ranking via DefiLlama." },
      { id: "crypto-onchain", title: "On-Chain", category: "crypto", summary: "Large transfers, whale tracking, chain metrics." },
      { id: "economics-calendar", title: "Economics Calendar", category: "economics", summary: "Upcoming macro releases with consensus + prior." },
      { id: "economics-indicators", title: "Key Indicators", category: "economics", summary: "GDP, CPI, unemployment, PMI, yield curve snapshot." },
      { id: "forex-majors", title: "Forex \u2014 Majors", category: "forex", summary: "EUR/USD, GBP/USD, USD/JPY\u2026 with carry + volatility." },
      { id: "forex-crosses", title: "Forex \u2014 Crosses", category: "forex", summary: "All cross-rates grid." },
      { id: "commodities", title: "Commodities", category: "commodities", summary: "Energies, metals, ags \u2014 futures curves + spreads." },
      { id: "options-chain", title: "Options Chain", category: "derivatives", summary: "Strikes \xD7 expiries grid with Greeks + IV." },
      { id: "options-builder", title: "Strategy Builder", category: "derivatives", summary: "Multi-leg strategy P&L + payoff chart." },
      { id: "futures-curve", title: "Futures Curve", category: "derivatives", summary: "Term-structure plot per underlying." },
      { id: "fixed-income-curve", title: "Yield Curve", category: "fixedincome", summary: "Spot/forward/zero curves, US + major sovereigns." },
      { id: "fixed-income-credit", title: "Credit Spreads", category: "fixedincome", summary: "IG vs HY OAS, CDS basis, TED spread." },
      { id: "maritime-vessels", title: "Vessel Tracker", category: "geo", summary: "AIS-style live vessel map with filters." },
      { id: "maritime-chokepoints", title: "Chokepoints", category: "geo", summary: "Suez, Panama, Malacca \u2014 throughput + delays." },
      { id: "geopolitics-events", title: "Geopolitical Events", category: "geo", summary: "ACLED + HDX events on a live map." },
      { id: "ai-chat", title: "AI Chat", category: "ai", summary: "Multi-provider LLM chat with DataHub context." },
      { id: "ai-agent-config", title: "Agent Config", category: "ai", summary: "Edit persona weights, pick providers, set guardrails." },
      { id: "ai-backtest-lab", title: "Backtest Lab", category: "ai", summary: "Run factor + RL backtests and compare Sharpe." },
      { id: "node-editor", title: "Node Editor", category: "automation", summary: "Visual workflow builder \u2014 graph serializes to JSON." },
      { id: "mcp-inspector", title: "MCP Inspector", category: "automation", summary: "Inspect MCP tool calls, schemas, + live request log." },
      { id: "reports-builder", title: "Report Builder", category: "reports", summary: "Templated equity/macro/strategy reports to PDF." },
      { id: "reports-history", title: "Report History", category: "reports", summary: "Past generated reports with re-run." },
      { id: "developer-datahub", title: "DataHub Inspector", category: "developer", summary: "Live topic/subscriber/in-flight stats (Phase 1 stats API)." },
      { id: "auth-profile", title: "Profile & Sessions", category: "auth", summary: "Active profile, session expiry, PIN reset." }
    ]
  };

  // src/typescript/screens/spec-screen.ts
  function renderSpecScreen(host, _ctx, spec) {
  ...
  // src/typescript/widgets/ticker-item.ts
  ...
  function pct(n) {
    const v2 = (n * 100).toFixed(2);
    return `${n >= 0 ? "+" : ""}${v2}%`;
  }

  // src/typescript/widgets/ticker-bar.ts
  function renderTickerBar(items) {
    const bar = el("div", { class: "ticker-bar", role: "marquee" });
    for (const t of items)
      bar.appendChild(renderTickerItem(t));
    return bar;
  }

  // src/typescript/widgets/kpi.ts
  function renderKpiGrid(items) {
    const grid = el("div", { class: "kpi-grid" });
    for (const k2 of items)
      grid.appendChild(renderKpi(k2));
    return grid;
  }
  function renderKpi(k2) {
    const toneClass = k2.tone === "pos" ? "t-pos" : k2.tone === "neg" ? "t-neg" : k2.tone === "warn" ? "t-warn" : k2.tone === "info" ? "t-info" : "t-white";
    return el("div", { class: "kpi-tile" }, [
      el("span", { class: "kpi-tile__label" }, [k2.label]),
      el("span", { class: `kpi-tile__value ${toneClass}` }, [k2.value]),
      ...k2.hint ? [el("span", { class: "t-muted t-small" }, [k2.hint])] : []
    ]);
  }

  // src/typescript/screens/dashboard.ts
  function renderDashboard(host, _ctx) {
    host.appendChild(el("h2", {}, ["Dashboard"]));
    host.appendChild(renderTickerBar([
      { symbol: "AAPL", price: 187.5, change_percent: 0.0125 },
      { symbol: "TSLA", price: 245.3, change_percent: -83e-4 },
  ...
  // src/typescript/widgets/data-table.ts
  function renderDataTable(opts) {
    ...
    for (const row of sorted)
      tbody.appendChild(bodyRow(opts.columns, row));
    return el("table", { class: "data-table" }, [thead, tbody]);
  }
  function headerRow(cols, sort) {
    const tr2 = el("tr");
    for (const c2 of cols) {
      const isSorted = sort?.key === c2.key;
      const arrow = isSorted ? sort.dir === "asc" ? "\u25B2" : "\u25BC" : "";
      const th = el("th", {
        class: `is-sortable${c2.numeric ? " numeric" : ""}`,
        "data-key": c2.key
      }, [
        c2.label,
  ...
  function bodyRow(cols, row) {
    const tr2 = el("tr");
    for (const c2 of cols) {
      const raw = row[c2.key];
      const formatted = c2.format ? c2.format(raw, row) : defaultFormat(raw, c2);
      const numClass = c2.numeric ? " numeric" : "";
      let signClass = "";
      if (c2.signed && typeof raw === "number")
        signClass = raw >= 0 ? " t-pos" : " t-neg";
      tr2.appendChild(el("td", { class: `${numClass}${signClass}`.trim() }, [formatted]));
    }
    return tr2;
  }
  function defaultFormat(v2, c2) {
    if (v2 === null || v2 === void 0)
      return "\u2014";
    if (typeof v2 === "number" && c2.numeric) {
      return v2.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 4 });
    }
    return String(v2);
  }
  function sortRows(rows, sort) {
    ...
    const out = [...rows];
    out.sort((a2, b2) => {
      const av = a2[sort.key], bv = b2[sort.key];
      if (typeof av === "number" && typeof bv === "number")
        return sort.dir === "asc" ? av - bv : bv - av;
      const as2 = String(av ?? ""), bs2 = String(bv ?? "");
      return sort.dir === "asc" ? as2.localeCompare(bs2) : bs2.localeCompare(as2);
    });
    return out;
  }

  // src/typescript/data/markets-data.json
  var markets_data_default = {
    description: "Bloomberg-style market sections shown by the Markets dashboard. Mirrors the universe defined in c-LabTools/market_watch/src/typescript/data.ts. Live values are filled in at render time (synthetic until DataHub wires).",
    sections: {
      dm_indexes: {
        title: "DEVELOPED MARKETS (DM)",
        panel: "indices",
        rows: [
          { ticker: "SPX Index", name: "S&P 500" },
          { ticker: "CCMP Index", name: "NASDAQ 100" },
          { ticker: "INDU Index", name: "DOW JONES" },
          { ticker: "SX5E Index", name: "EURO STOXX 50" },
          { ticker: "UKX Index", name: "FTSE 100" },
          { ticker: "DAX Index", name: "DAX (GER)" },
          { ticker: "CAC Index", name: "CAC 40 (FRA)" },
          { ticker: "NKY Index", name: "NIKKEI 225" },
          { ticker: "AS51 Index", name: "ASX 200" }
        ]
      },
      em_indexes: {
        title: "EMERGING MARKETS (EM)",
        panel: "indices",
        rows: [
          { ticker: "IBOV Index", name: "IBOVESPA" },
          { ticker: "SHCOMP Index", name: "SHANGHAI COMP" },
          { ticker: "HSI Index", name: "HANG SENG" },
          { ticker: "NIFTY Index", name: "NIFTY 50" },
          { ticker: "MEXBOL Index", name: "MEXICO BOLSA" },
          { ticker: "JALSH Index", name: "JSE AFRICA" },
          { ticker: "KOSPI Index", name: "KOSPI" },
          { ticker: "TWSE Index", name: "TAIEX" }
        ]
      },
      dm_currencies: {
        title: "G10 / DEVELOPED CURRENCIES",
        panel: "fx",
        rows: [
          { ticker: "DXY Curncy", name: "DOLLAR INDEX" },
          { ticker: "EURUSD Curncy", name: "EUR-USD" },
          { ticker: "GBPUSD Curncy", name: "GBP-USD" },
          { ticker: "USDJPY Curncy", name: "USD-JPY" },
          { ticker: "USDCHF Curncy", name: "USD-CHF" },
          { ticker: "USDCAD Curncy", name: "USD-CAD" },
          { ticker: "AUDUSD Curncy", name: "AUD-USD" },
          { ticker: "NZDUSD Curncy", name: "NZD-USD" }
        ]
      },
      em_currencies: {
        ...
        panel: "fx",
        rows: [
          { ticker: "USDBRL Curncy", name: "USD-BRL" },
          { ticker: "USDCNY Curncy", name: "USD-CNY" },
          { ticker: "USDMXN Curncy", name: "USD-MXN" },
          { ticker: "USDZAR Curncy", name: "USD-ZAR" },
          { ticker: "USDTRY Curncy", name: "USD-TRY" },
          { ticker: "USDINR Curncy", name: "USD-INR" },
          { ticker: "USDKRW Curncy", name: "USD-KRW" },
          { ticker: "USDPLN Curncy", name: "USD-PLN" }
        ]
      },
      commodities: {
        title: "KEY COMMODITY FUTURES",
        panel: "alpha",
        rows: [
          { ticker: "XAU Curncy", name: "GOLD SPOT" },
          { ticker: "XAG Curncy", name: "SILVER SPOT" },
          { ticker: "CL1 Comdty", name: "WTI CRUDE" },
          { ticker: "CO1 Comdty", name: "BRENT CRUDE" },
          { ticker: "NG1 Comdty", name: "NAT GAS" },
          { ticker: "HG1 Comdty", name: "COPPER" },
          { ticker: "W 1 Comdty", name: "WHEAT" },
          { ticker: "S 1 Comdty", name: "SOYBEAN" }
        ]
      },
      buffett_portfolio: {
        title: "BUFFETT (BERKSHIRE) HOLDINGS",
        panel: "alpha",
        rows: [
          { ticker: "AAPL US Equity", name: "APPLE INC" },
          { ticker: "BAC US Equity", name: "BANK OF AMER" },
          { ticker: "AXP US Equity", name: "AMER EXPRESS" },
          { ticker: "KO US Equity", name: "COCA-COLA" },
          { ticker: "CVX US Equity", name: "CHEVRON" },
          { ticker: "OXY US Equity", name: "OCCIDENTAL" },
          { ticker: "KHC US Equity", name: "KRAFT HEINZ" },
          { ticker: "MCO US Equity", name: "MOODYS" }
        ]
      },
      personal_watchlist: {
        ...
        panel: "alpha",
        rows: [
          { ticker: "NVDA US Equity", name: "NVIDIA" },
          { ticker: "MSFT US Equity", name: "MICROSOFT" },
          { ticker: "TSLA US Equity", name: "TESLA" },
          { ticker: "META US Equity", name: "META" },
          { ticker: "AMD US Equity", name: "AMD" },
          { ticker: "PLTR US Equity", name: "PALANTIR" },
          { ticker: "COIN US Equity", name: "COINBASE" },
          { ticker: "PBR US Equity", name: "PETROBRAS" }
        ]
      }
    },
    yields: {
      us_treasuries: {
        ...
        rows: [
          ...
          { tenor: "5Y", last: 4.4, chg: -0.01 },
          { tenor: "10Y", last: 4.35, chg: 0.01 },
          { tenor: "30Y", last: 4.5, chg: 0.02 }
        ]
      },
      brazil_di: {
        title: "BRAZIL FUTURES (DI)",
        rows: [
          { tenor: "Jan25", last: 10.4, chg: -0.05 },
          { tenor: "Jan26", last: 10.55, chg: -0.03 },
          { tenor: "Jan27", last: 10.8, chg: 0.02 },
          { tenor: "Jan29", last: 11.2, chg: 0.05 }
        ]
      }
    },
    yield_curves: {
      tenors: ["3M", "6M", "1Y", "2Y", "5Y", "10Y", "30Y"],
      us: [5.38, 5.2, 4.9, 4.75, 4.4, 4.35, 4.5],
      br: [10.55, 10.6, 10.5, 10.8, 11.2, 11.5, 11.8]
    }
  };

  // src/typescript/screens/markets-dashboard.ts
  var data = markets_data_default;
  var r = (min, max) => parseFloat((Math.random() * (max - min) + min).toFixed(2));
  ...
  var PERF_FORMAT = (v2) => `${v2 >= 0 ? "+" : ""}${v2.toFixed(2)}%`;
  var COLUMNS = [
  ...
  var YIELD_COLUMNS = [
    ...
    { key: "last", label: "Yld", numeric: true, format: (v2) => v2.toFixed(2) },
    {
      key: "chg",
      label: "Chg",
      numeric: true,
      signed: true,
      format: (v2) => `${v2 >= 0 ? "+" : ""}${v2.toFixed(2)}`
    }
  ];
  function renderMarketsDashboard(host, _ctx) {
  ...
  function renderPanel(num, name, cmd, children, flatBody = false) {
  ...
  function renderRatesBody() {
    ...
    for (const k2 of Object.keys(data.yields)) {
      const y2 = data.yields[k2];
      const cell = el("div");
      cell.appendChild(el("div", { class: "mkt-section__title" }, [y2.title]));
      cell.appendChild(renderDataTable({ columns: YIELD_COLUMNS, rows: y2.rows }));
      tables.appendChild(cell);
    }
    wrap.appendChild(tables);
    return wrap;
  }
  function renderYieldCurve(c2) {
    ...
    legend.innerHTML = `<span class="t-amber"><span class="swatch" style="background:var(--color-accent)"></span>US</span><span class="t-pos"><span class="swatch" style="background:var(--color-positive)"></span>BR</span>`;
    wrap.appendChild(legend);
    const W2 = 400, H2 = 160;
    const padL = 30, padR = 30, padT = 25, padB = 20;
    const minR = 3, maxR = 13;
    const xs2 = (i) => padL + i / (c2.tenors.length - 1) * (W2 - padL - padR);
    const ys2 = (v2) => H2 - padB - (v2 - minR) / (maxR - minR) * (H2 - padT - padB);
    const path = (vs2) => "M " + vs2.map((v2, i) => `${xs2(i)},${ys2(v2)}`).join(" L ");
    ...
    for (const yv of [4, 6, 8, 10, 12]) {
      ...
      ln2.setAttribute("x1", String(padL));
      ln2.setAttribute("x2", String(W2 - padR));
      ln2.setAttribute("y1", String(y2));
      ln2.setAttribute("y2", String(y2));
      ln2.setAttribute("stroke", "var(--color-grid)");
      ln2.setAttribute("stroke-dasharray", "2 2");
      ln2.setAttribute("stroke-width", "0.5");
      svg.appendChild(ln2);
      const tx = document.createElementNS(svgNS, "text");
      tx.setAttribute("x", String(padL - 4));
      tx.setAttribute("y", String(y2 + 2));
      tx.setAttribute("text-anchor", "end");
      tx.setAttribute("fill", "var(--color-text-muted)");
      tx.setAttribute("font-size", "9");
      tx.textContent = String(yv);
      svg.appendChild(tx);
    }
    for (const [vals, color] of [[c2.br, "var(--color-positive)"], [c2.us, "var(--color-accent)"]]) {
      const p2 = document.createElementNS(svgNS, "path");
      p2.setAttribute("d", path(vals));
      ...
      for (let i = 0; i < vals.length; i++) {
        ...
        rect.setAttribute("x", String(xs2(i) - 1.5));
        rect.setAttribute("y", String(ys2(vals[i]) - 1.5));
    ...
    for (let i = 0; i < c2.tenors.length; i++) {
      const tx = document.createElementNS(svgNS, "text");
      tx.setAttribute("x", String(xs2(i)));
      tx.setAttribute("y", String(H2 - 5));
      tx.setAttribute("text-anchor", "middle");
      tx.setAttribute("fill", "var(--color-accent)");
      tx.setAttribute("font-size", "10");
      tx.setAttribute("font-weight", "700");
      tx.textContent = c2.tenors[i];
      svg.appendChild(tx);
    }
  ...
  function renderLineChart(opts) {
    ...
    if (opts.label)
      wrap.appendChild(el("div", { class: "chart__header" }, [opts.label, el("span", { class: "t-muted" }, [`${opts.points.length} pts`])]));
  ...
  function paint(canvas, pts) {
    const dpr = typeof devicePixelRatio !== "undefined" ? devicePixelRatio : 1;
    const w2 = canvas.clientWidth || 600, h2 = canvas.clientHeight || 320;
    canvas.width = w2 * dpr;
    ...
    const xs2 = (x2) => padL + (x2 - minX) / Math.max(1e-9, maxX - minX) * innerW;
    const ys2 = (y2) => padT + (1 - (y2 - minY) / (maxY - minY)) * innerH;
    ...
    for (let i = 0; i <= 4; i++) {
      ...
      ctx.fillText(v2.toFixed(2), padL - 4, y2);
    }
    ctx.strokeStyle = accent;
    ctx.lineWidth = 1.25;
    ctx.beginPath();
    pts.forEach((p2, i) => {
      const x2 = xs2(p2.x), y2 = ys2(p2.y);
      if (i === 0)
        ctx.moveTo(x2, y2);
      else
        ctx.lineTo(x2, y2);
  ...
  function renderPortfolio(host, _ctx) {
    host.appendChild(el("h2", {}, ["Portfolio"]));
    const points = Array.from({ length: 30 }, (_2, i) => ({
      x: i,
      y: 1e5 + i * 850 + Math.sin(i * 0.6) * 1200
    }));
    host.appendChild(renderLineChart({ points, label: "EQUITY CURVE \u2014 synthetic" }));
  }

  // src/typescript/screens/trading.ts
  function renderTrading(host, _ctx) {
  ...
  // src/typescript/charts/candlestick.ts
  var lwcPromise = null;
  function lwc() {
    if (!lwcPromise)
  ...
  function renderCandleChart(opts) {
    const wrap = el("div", { class: "chart chart--candle" });
    if (opts.label)
      wrap.appendChild(el("div", { class: "chart__header" }, [opts.label, el("span", { class: "t-muted" }, [`${opts.bars.length} bars`])]));
  ...
  // src/typescript/screens/crypto.ts
  function renderCrypto(host, _ctx) {
    host.appendChild(el("h2", {}, ["Crypto"]));
    const bars = [];
    let last = 67e3;
    const start = Math.floor(Date.now() / 1e3) - 20 * 60;
    for (let i = 0; i < 20; i++) {
  ...
  // src/typescript/screens/economics.ts
  function renderEconomics(host, _ctx) {
  ...
  // src/typescript/screens/settings.ts
  function renderSettings(host, ctx) {
    ...
    host.appendChild(el("div", { class: "field" }, [
      ...
      el("div", { class: "u-row" }, [
        ...
        (() => {
          const btn = el("button", { class: "btn", type: "button" }, ["CYCLE THEME (CTRL+T)"]);
  ...
  // src/typescript/screens/developer-datahub.ts
  function renderDeveloperDataHub(host, ctx) {
    ...
    void ctx.api.topics().then((topics) => {
      ...
      host.appendChild(renderDataTable({
        columns: [
          ...
          { key: "in_flight", label: "In-flight", format: (v2) => v2 ? "\u25CF" : "\u2014" }
        ],
        rows: topics,
  ...
  // src/typescript/screens/mcp-inspector.ts
  function renderMcpInspector(host, ctx) {
    ...
    void ctx.api.mcpTools().then((tools) => {
      ...
      for (const t of tools)
        list.appendChild(renderTool(t, ctx));
    }).catch((err) => {
      loading.remove();
      list.appendChild(renderError(err.message));
    });
  }
  function renderTool(t, ctx) {
    ...
    const callBtn = el("button", { class: "btn", type: "button" }, ["CALL TOOL"]);
    callBtn.addEventListener("click", () => {
      let args = {};
      try {
        args = JSON.parse(argsField.value || "{}");
      } catch (e2) {
        replace(out, `parse error: ${e2.message}`);
        return;
      }
      replace(out, "CALLING\u2026");
      ctx.api.callMcpTool(t.name, args).then((res) => replace(out, JSON.stringify(res, null, 2))).catch((err) => replace(out, `error: ${err.message}`));
    });
  ...
  // src/typescript/screens/auth-profile.ts
  function renderAuthProfile(host, ctx) {
  ...
  // src/typescript/screens/registry.ts
  ...
  function buildRegistry() {
    const out = [];
    for (const c2 of screen_registry_default.custom) {
      const render = CUSTOM_RENDERERS[c2.id];
      if (!render)
        throw new Error(`screen-registry: missing renderer for custom id "${c2.id}"`);
      out.push({ id: c2.id, title: c2.title, category: c2.category, source: "custom", render });
    }
    for (const s of screen_specs_default.specs) {
    ...
    for (const e2 of out) {
      if (seen.has(e2.id))
        throw new Error(`screen-registry: duplicate id "${e2.id}"`);
      seen.add(e2.id);
    }
    return out;
  }
  ...
  var App = class {
    constructor() {
      ...
      __publicField(this, "functionBar");
      __publicField(this, "statusBar");
      __publicField(this, "screens", []);
      __publicField(this, "screensById", /* @__PURE__ */ new Map());
      __publicField(this, "currentScreenId", "");
      __publicField(this, "currentThemeId", "");
    }
    async mount(root2) {
      const themesIdx = loadThemesIndex();
      this.currentThemeId = readSavedThemeId() ?? themesIdx.default;
      if (!themesIdx.themes.find((t) => t.id === this.currentThemeId))
        this.currentThemeId = themesIdx.default;
      ...
      clear(root2);
      root2.appendChild(this.commandBar.node);
      root2.appendChild(this.nav.node);
      root2.appendChild(this.panel.node);
      root2.appendChild(this.functionBar.node);
      root2.appendChild(this.statusBar.node);
      ...
      this.ws.open();
      this.pollStatus();
      setInterval(() => this.pollStatus(), 1e4);
      window.addEventListener("keydown", (e2) => this.handleKey(e2));
    ...
    activate(id) {
      ...
      try {
        screen.render(mount.body, ctx);
      } catch (err) {
        console.error(`[fin-terminal] screen ${id} render error`, err);
        mount.body.textContent = `screen ${id} render error: ${err.message}`;
      }
    ...
    handleKey(e2) {
      if (e2.ctrlKey && (e2.key === "t" || e2.key === "T")) {
        e2.preventDefault();
        this.cycleTheme();
        return;
      }
      if (e2.key === "F1" || e2.key === "F2" || e2.key === "F3" || e2.key === "F4" || e2.key === "F5" || e2.key === "F6" || e2.key === "F7" || e2.key === "F8" || e2.key === "F9" || e2.key === "F10" || e2.key === "F11" || e2.key === "F12") {
        const id = this.functionBar.resolveKey(e2.key);
        if (id) {
          e2.preventDefault();
          this.activate(id);
        }
    ...
    cycleTheme() {
      ...
      if (this.currentScreenId)
        this.activate(this.currentScreenId);
    }
    applyCurrentTheme() {
    ...
    async pollStatus() {
      try {
        ...
        this.statusBar.update({ topics: info.hub_topics, latency_ms: dt2, build: `${BUILD_VERSION} / api ${info.version}` });
      } catch {
  ...
  if (!root) {
    ...
    void new App().mount(root).catch((err) => {
      ...
      root.textContent = `boot error: ${err.message}`;
    });
  }
})();
