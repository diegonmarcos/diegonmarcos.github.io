...
function MapControls($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    })}${attr("aria-label", store_get($$store_subs ??= {}, "$isGlobeView", isGlobeView) ? "Switch to flat view" : "Switch to 3D tilt")}${attr("title", store_get($$store_subs ??= {}, "$isGlobeView", isGlobeView) ? "Flat view" : "3D tilt")}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3L2 8l10 5 10-5-10-5z"></path><path d="M2 15l10 5 10-5"></path><path d="M2 11.5l10 5 10-5"></path></svg></button></div>`);
