...
echo "🚀 Setting up hybrid folder structure..."

# Create numbered directories
echo "📁 Creating numbered directories..."
mkdir -p 0.spec
mkdir -p 1.1.ops
...
echo "✅ Hybrid folder structure created successfully!"
echo ""
echo "📂 Structure:"
...
```
myprofile/
├── 0.spec/              # Product specs (you're here!)
├── 1.1.ops/             # CI/CD (GitHub Actions later)
├── 1.2.analytics/       # Matomo config (later)
├── 1.3.svelte/          # Main SvelteKit source
│   ├── lib/
│   │   ├── components/
│   │   ├── services/
│   │   ├── types/       # ← Also accessible via 2.3.ts/
│   │   └── utils/
│   ├── routes/
│   ├── styles/          # ← Also accessible via 2.2.sass/
│   └── app.html
├── 2.1.assets/          # Static files (images, icons, fonts)
├── 2.2.sass/ → 1.3.svelte/styles/     # Symlink
├── 2.3.ts/   → 1.3.svelte/lib/types/  # Symlink
