...
# ║                                                                  ║
# ║   Source : 1_cicd/src/scripts/front-sw-rollout.sh
...
INIT_SCRIPT="$REPO_ROOT/1_cicd/dist/scripts/front-sw-init.sh"
[ -x "$INIT_SCRIPT" ] || INIT_SCRIPT="$REPO_ROOT/1_cicd/src/scripts/front-sw-init.sh"
...
# `9_others` and `_*` are tooling / hidden, not projects.
if [ "$#" -eq 0 ]; then
