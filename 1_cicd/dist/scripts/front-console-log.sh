...
# ║                                                                  ║
# ║   Source : 1_cicd/src/scripts/front-console-log.sh
...
# `9_others/src/templates/console-log-snippet.html` so the markup is
...
SNIPPET="$REPO_ROOT/1_cicd/dist/templates/console-log-snippet.html"
[ -f "$SNIPPET" ] || SNIPPET="$REPO_ROOT/9_others/src/templates/console-log-snippet.html"
...
TS_SRC="$REPO_ROOT/1_cicd/dist/templates/console-logs.ts"
[ -f "$TS_SRC" ] || TS_SRC="$REPO_ROOT/9_others/src/templates/console-logs.ts"
