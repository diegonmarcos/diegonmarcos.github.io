...
- **Type**: A
- **Name**: analytics
- **Value**: 144.24.205.254
- **TTL**: 300 (or auto)

### 4. Configure Nginx Proxy Manager
1. Access: http://144.24.205.254:81
2. Default login:
...
- **Nginx Proxy Manager**: http://144.24.205.254:81
- **SSH**: ssh -i ~/.ssh/matomo_key ubuntu@144.24.205.254
