...
# ║                                                                  ║
# ║   Source : 1_configs/src/gha/scripts/_engine.sh
...
_run() {
    local s="$REPO_ROOT/1_configs/dist/scripts/$1"
    [ -x "$s" ] || s="$REPO_ROOT/1_configs/src/gha/scripts/$1"
...
_sync_root_manifest() {
    ...
    local gen="$repo_root/1_configs/dist/scripts/front-gen-root-pkg.sh"
    [ -x "$gen" ] || gen="$repo_root/1_configs/src/gha/scripts/front-gen-root-pkg.sh"
...
mod_esbuild_sw() {
    ...
    local engine="$REPO_ROOT/1_configs/dist/scripts/front-sw-build.sh"
    [ -x "$engine" ] || engine="$REPO_ROOT/1_configs/src/gha/scripts/front-sw-build.sh"
...
# engine `1_configs/dist/scripts/front-sw-register.sh` so build.json
...
mod_sw_register() {
    ...
    local engine="$REPO_ROOT/1_configs/dist/scripts/front-sw-register.sh"
    [ -x "$engine" ] || engine="$REPO_ROOT/1_configs/src/gha/scripts/front-sw-register.sh"
...
# `1_configs/dist/scripts/front-pwa-icons.sh` so build.json can drive
...
mod_pwa_icons() {
    ...
    local engine="$REPO_ROOT/1_configs/dist/scripts/front-pwa-icons.sh"
    [ -x "$engine" ] || engine="$REPO_ROOT/1_configs/src/gha/scripts/front-pwa-icons.sh"
...
#
# Engine: 1_configs/{src,dist}/scripts/front-data-json-js-wrapper.sh
...
mod_data_wrap() {
    ...
    local engine="$REPO_ROOT/1_configs/dist/scripts/front-data-json-js-wrapper.sh"
    [ -x "$engine" ] || engine="$REPO_ROOT/1_configs/src/gha/scripts/front-data-json-js-wrapper.sh"
...
run_build() {
    ...
    while [ "$i" -lt "$step_n" ]; do
        ...
        case "$_mod" in
            ...
            console_log)  _e="$REPO_ROOT/1_configs/dist/scripts/front-console-log.sh"; \
                          [ -x "$_e" ] || _e="$REPO_ROOT/1_configs/src/gha/scripts/front-console-log.sh"; \
