"use strict";
(() => {
  // a-Portals/linktree/src/typescript/modules/ascii-anim.ts
  var FRAMES = [
    `
  \u250C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510
  \u2502  \u2554\u2550\u2550\u2557  \u250C\u2500\u2500\u2510  \u2502
  ...
  // a-Portals/linktree/src/typescript/modules/loader.ts
  var CRITICAL_ASSETS = [
  ...
  // a-Portals/linktree/src/typescript/modules/status/diagnostics.ts
  ...
  // a-Portals/linktree/src/typescript/modules/status/modal.ts
  ...
  // a-Portals/linktree/src/typescript/utils/dom.ts
  ...
  // a-Portals/linktree/src/typescript/modules/collapsible.ts
  ...
  // a-Portals/linktree/src/typescript/modules/videoBackground.ts
  var VIDEOS = [
    "public/videos/background.mp4",
    "public/videos/background2.mp4",
    "public/videos/background3.mp4",
  ...
  function setCSSProperty2(el3, varName, varValue) {
  ...
  function elementChildren(element, selector) {
    ...
    return children.filter((el3) => el3.matches(selector));
  }
  function elementIsChildOfSlot(el3, slot) {
    const elementsQueue = [slot];
    while (elementsQueue.length > 0) {
      const elementToCheck = elementsQueue.shift();
      if (el3 === elementToCheck) {
        return true;
      }
      elementsQueue.push(...elementToCheck.children, ...elementToCheck.shadowRoot ? elementToCheck.shadowRoot.children : [], ...elementToCheck.assignedElements ? elementToCheck.assignedElements() : []);
    }
  }
  function elementIsChildOf(el3, parent) {
    const window2 = getWindow();
    let isChild = parent.contains(el3);
    if (!isChild && window2.HTMLSlotElement && parent instanceof HTMLSlotElement) {
      const children = [...parent.assignedElements()];
      isChild = children.includes(el3);
      if (!isChild) {
        isChild = elementIsChildOfSlot(el3, parent);
      }
    }
    return isChild;
  }
  ...
  function elementOffset(el3) {
    const window2 = getWindow();
    const document2 = getDocument();
    const box = el3.getBoundingClientRect();
    const body = document2.body;
    const clientTop = el3.clientTop || body.clientTop || 0;
    const clientLeft = el3.clientLeft || body.clientLeft || 0;
    const scrollTop = el3 === window2 ? window2.scrollY : el3.scrollTop;
    const scrollLeft = el3 === window2 ? window2.scrollX : el3.scrollLeft;
    return {
  ...
  function makeElementsArray(el3) {
    return (Array.isArray(el3) ? el3 : [el3]).filter((e) => !!e);
  }
  ...
  function setInnerHTML(el3, html) {
    if (html === void 0) {
      html = "";
    }
    if (typeof trustedTypes !== "undefined") {
      el3.innerHTML = trustedTypes.createPolicy("html", {
        createHTML: (s) => s
      }).createHTML(html);
    } else {
      el3.innerHTML = html;
  ...
  function updateProgress2(translate2) {
    const swiper = this;
  ...
  function loopFix(_temp) {
    ...
    if (typeof activeSlideIndex === "undefined") {
      activeSlideIndex = swiper.getSlideIndex(slides.find((el3) => el3.classList.contains(params.slideActiveClass)));
    } else {
  ...
  function Keyboard(_ref) {
    ...
    function handle(event2) {
      ...
      if (swiper.params.keyboard.onlyInViewport && (isPageUp || isPageDown || isArrowLeft || isArrowRight || isArrowUp || isArrowDown)) {
        ...
        const el3 = swiper.el;
        const swiperWidth = el3.clientWidth;
        const swiperHeight = el3.clientHeight;
        const windowWidth = window2.innerWidth;
        const windowHeight = window2.innerHeight;
        const swiperOffset = elementOffset(el3);
        if (rtl)
          swiperOffset.left -= el3.scrollLeft;
  ...
  function Navigation(_ref) {
    ...
    function getEl(el3) {
      ...
      if (el3 && typeof el3 === "string" && swiper.isElement) {
        res = swiper.el.querySelector(el3) || swiper.hostEl.querySelector(el3);
        if (res)
          return res;
      }
      if (el3) {
  ...
  function effectVirtualTransitionEnd(_ref) {
    ...
    const getSlide = (el3) => {
      if (!el3.parentElement) {
        const slide2 = swiper.slides.find((slideEl) => slideEl.shadowRoot && slideEl.shadowRoot === el3.parentNode);
        return slide2;
      }
  ...
  function EffectCreative(_ref) {
    ...
    const setTransition2 = (duration) => {
      ...
      transformElements.forEach((el3) => {
        ...
        el3.querySelectorAll(".swiper-slide-shadow").forEach((shadowEl) => {
  ...
  // a-Portals/linktree/src/typescript/modules/carousel.ts
  var selectedCarousel = "professional";
  var professionalSwiper;
  var personalSwiper;
  var personalToolsSwiper;
  var professionalRow;
  var personalRow;
  var personalToolsRow;
  var professionalPrev;
  var professionalNext;
  var personalPrev;
  var personalNext;
  var personalToolsPrev;
  var personalToolsNext;
  ...
  function getCarouselSet(type) {
    if (type === "professional") {
      ...
      return { swiper: personalToolsSwiper, row: personalToolsRow, prev: personalToolsPrev, next: personalToolsNext, el: querySelector(".personal-tools-swiper") };
    }
    return { swiper: personalSwiper, row: personalRow, prev: personalPrev, next: personalNext, el: querySelector(".personal-swiper") };
  }
  var allTypes = ["professional", "personal", "personalTools"];
  ...
  function personalToolsTrackpadHandler(e) {
  ...
  function initTwoFingerSwipe() {
    ...
    const types = ["professional", "personal", "personalTools"];
  ...
  function initKeyboardNavigation() {
    const order = ["professional", "personal", "personalTools"];
  ...
  function initCarousels() {
    const profRow = querySelector(".professional-profiles-section .carousel-row");
    const persRow = querySelector(".personal-profiles-section .carousel-row");
    const pToolsRow = querySelector(".personal-tools-section .carousel-row");
    if (!profRow || !persRow || !pToolsRow)
      return;
    ...
    const pToolsPrev = querySelector(".personal-tools-prev");
    const pToolsNext = querySelector(".personal-tools-next");
    if (!profPrev || !profNext || !persPrev || !persNext || !pToolsPrev || !pToolsNext)
      return;
  ...
  // a-Portals/linktree/src/typescript/modules/mobileScroll.ts
  var professionalRow2 = null;
  var personalRow2 = null;
  var personalToolsRow2 = null;
  ...
  function selectCarouselByScroll() {
    if (!professionalRow2 || !personalRow2 || !personalToolsRow2)
      return;
    ...
    const distances = [
      ...
      [Math.abs(viewportCenter - getElementCenterY(personalToolsRow2)), "personalTools"]
    ];
  ...
  function initMobileScrollSelection() {
    professionalRow2 = querySelector(".professional-profiles-section .carousel-row");
    personalRow2 = querySelector(".personal-profiles-section .carousel-row");
    personalToolsRow2 = querySelector(".personal-tools-section .carousel-row");
    if (!professionalRow2 || !personalRow2 || !personalToolsRow2)
      return;
  ...
  // a-Portals/linktree/src/typescript/modules/gallery.ts
  ...
  // a-Portals/linktree/src/typescript/modules/performanceMode.ts
  ...
  // a-Portals/linktree/src/typescript/modules/mindmap-overlay.ts
  ...
  // a-Portals/linktree/src/typescript/modules/vmControl.ts
  ...
  // a-Portals/linktree/src/typescript/modules/profilePicSwiper.ts
  ...
  // a-Portals/linktree/src/typescript/modules/cardSwiper.ts
    ...
    slides: [
      {
        ...
        dashboard_modifier: "tools-dashboard--4",
        columns: [
          {
            header: "Data Science",
            links: [
              { label: "Colab", url: "https://colab.research.google.com", icon: "sparkles.svg" },
              { label: "Kaggle", url: "https://kaggle.com", icon: "brain.svg" },
              { label: "HuggingFace", url: "https://huggingface.co", icon: "robot.svg" },
              { label: "PyTorch", url: "https://pytorch.org", icon: "bolt.svg" },
              { label: "TensorFlow", url: "https://tensorflow.org", icon: "bolt.svg" },
              { label: "Scikit-learn", url: "https://scikit-learn.org", icon: "code.svg" }
            ]
          },
          {
            header: "Quantum",
            links: [
              { label: "IBM Quantum", url: "https://quantum.ibm.com", icon: "rocket.svg" },
              { label: "Qiskit", url: "https://qiskit.org", icon: "code.svg" },
              { label: "Google QAI", url: "https://quantumai.google", icon: "sparkles.svg" },
              { label: "Cirq", url: "https://quantumai.google/cirq", icon: "code.svg" },
              { label: "PennyLane", url: "https://pennylane.ai", icon: "bolt.svg" },
              { label: "Braket", url: "https://aws.amazon.com/braket", icon: "rocket.svg" },
              { label: "Azure QC", url: "https://azure.microsoft.com/products/quantum", icon: "world.svg" },
              { label: "QInspire", url: "https://www.quantum-inspire.com", icon: "brain.svg" }
            ]
          },
          {
            header: "Markets",
            links: [
              { label: "Fin Terminal", url: "https://diegonmarcos.github.io/fin-terminal", icon: "database.svg" },
              { label: "GDELT News", url: "https://news.diegonmarcos.com", icon: "world.svg" },
              { label: "MarketWatch", url: "https://diegonmarcos.github.io/market_watch", icon: "database.svg" },
              { label: "CentralBank", url: "https://diegonmarcos.github.io/central_bank", icon: "database.svg" }
            ]
          },
          {
            header: "Engineer",
            links: [
              { label: "Sailytics", url: "https://diegonmarcos.github.io/sailytics", icon: "world.svg" },
              { label: "OpenRevit", url: "https://diegonmarcos.github.io/openrevit", icon: "settings.svg" }
            ]
          }
        ]
      }
  ...
  // a-Portals/linktree/src/typescript/modules/portal-render.ts
  var CFG = personal_tools_default;
  ...
  function renderToolLink(link) {
    const a = el2("a", { class: "tool-link", href: link.url, target: "_blank" });
    a.appendChild(el2("img", { class: "icon", src: `public/icons/${link.icon}` }));
    a.appendChild(document.createTextNode(link.label));
    return a;
  }
  function renderColumn(col) {
    const headerEl = col.header_url ? (() => {
      const a = el2("a", { class: "tools-column__header", href: col.header_url, target: "_blank" });
      a.appendChild(document.createTextNode(col.header));
      return a;
    })() : el2("div", { class: "tools-column__header" }, [col.header]);
    const linksWrap = el2("div", { class: "tools-column__links" });
    for (const lk of col.links)
      linksWrap.appendChild(renderToolLink(lk));
    return el2("div", { class: "tools-column" }, [headerEl, linksWrap]);
  }
  function renderToolsSlide(slide2) {
    const linkSection = el2("div", { class: "link-section" });
    linkSection.appendChild(el2("h2", { class: "section-title" }, [slide2.title]));
    if (slide2.image) {
      linkSection.appendChild(el2("img", {
        src: slide2.image.src,
        alt: slide2.image.alt ?? slide2.title,
        class: "featured-image"
      }));
    }
    const dashClass = `tools-dashboard${slide2.dashboard_modifier ? " " + slide2.dashboard_modifier : ""}`;
    const dashboard = el2("div", { class: dashClass });
    for (const col of slide2.columns)
      dashboard.appendChild(renderColumn(col));
    linkSection.appendChild(el2("div", { class: "links-container" }, [dashboard]));
    return el2("div", { class: "swiper-slide" }, [linkSection]);
  }
  function renderSlide(id) {
    const slide2 = CFG.slides.find((s) => s.id === id);
    if (!slide2)
      return null;
    if (slide2.kind === "tools")
      return renderToolsSlide(slide2);
    return null;
  }
  function initPortalRender() {
    const mounts = document.querySelectorAll("[data-portal-mount]");
  ...
  // a-Portals/linktree/src/typescript/main.ts
  function initApp() {
    initPortalRender();
