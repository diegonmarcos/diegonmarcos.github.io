...
import { initInteraction, setCallbacks, setFocusedNode, clearFocus, setRenderCallback, } from './modules/interaction';
import { initUI, showLoading, hideLoading, showLinkPanel, setOnBack, setNodes, setOnNodeSelect, setRenderCallback as setUIRenderCallback, updateCanvasSize, updateZoomIndicator, updateMinimap, updateBreadcrumb, focusOnNodeWithUI, setCurrentNode, } from './modules/ui';
...
async function init() {
    try {
        ...
        initInteraction(graphContainer, nodes, edges, view);
...
// -----------------------------------------------------------------------------
function runExpansionAnimation() {
