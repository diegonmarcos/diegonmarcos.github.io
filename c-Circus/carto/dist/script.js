...
async function dealTreeOfLife() {
    ...
    const tolContainer = document.getElementById('tolReadingContainer');
    ...
    const rowY = (row) => startY + row * rowSpacing;
    let globalZ = 300;
...
function hideMainUI() {
    const triggersRow = document.querySelector('.triggers-row');
