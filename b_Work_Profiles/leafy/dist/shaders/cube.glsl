// Cube Shader - Ambient glow effect for service cube
// Creates a soft, pulsing aura around the cube
...
void main() {
    ...
    // Alpha based on distance (transparent at edges)
    float alpha = glow * 0.6 + edge * 0.4;
