#!/bin/sh
#=====================================
# MYMOVIES BUILD SCRIPT
#=====================================
# POSIX-compliant build script for Vue 3 + Vite project
...
print_usage() {
    ...
    printf "  ${GREEN}build${NC}        # Build for production (single-file output)\n"
...
typecheck() {
    ...
    npm run typecheck || log_warning "Type checking completed with errors"
}
