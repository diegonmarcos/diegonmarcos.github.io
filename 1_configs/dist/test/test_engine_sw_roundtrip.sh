...
# ║                                                                  ║
# ║   Source : 1_configs/src/test/test_engine_sw_roundtrip.sh
...
FIXTURE="$REPO_ROOT/1_configs/src/test/fixtures/sw-min"

fail() { echo "FAIL: $1" >&2; exit 1; }
pass() { echo "  ✓ $1"; }

[ -d "$FIXTURE" ] || fail "fixture not found: $FIXTURE"
[ -x "$REPO_ROOT/1_configs/src/gha/scripts/_engine.sh" ] || fail "_engine.sh not executable"
...
ln -sf "$REPO_ROOT/1_configs/src/gha/scripts/_engine.sh" "$WORK/build.sh"
