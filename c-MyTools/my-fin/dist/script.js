(()=>{var be=Object.defineProperty;var ye=(s,e,a)=>e in s?be(s,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[e]=a;var pt=(s,e,a)=>(ye(s,typeof e!="symbol"?e+"":e,a),a);var fe={route:{path:"cashflow/categories",tab:"overview",params:{}},reportingCurrency:"EUR",period:{months:12,label:"12M"},data:null,nav:null,loading:!0,error:null},ut=class{constructor(){pt(this,"state",{...fe});pt(this,"listeners",new Set)}get(){return this.state}set(e){this.state={...this.state,...e},this.listeners.forEach(a=>a())}subscribe(e){return this.listeners.add(e),()=>this.listeners.delete(e)}},T=new ut;var _e="mock",$e="nav";function St(s){let e=globalThis.PORTAL_DATA;if(!e||!(s in e))throw new Error(`PORTAL_DATA["${s}"] not found. Make sure <script src="data-${s}.json.js"><\/script> is loaded BEFORE script.js in index.html.`);return e[s]}var mt=null,ht=null;async function Bt(){return mt||(mt=St(_e)),mt}async function At(){return ht||(ht=St($e)),ht}function xe(s){let e=window.location.hash.replace(/^#\/?/,"");if(!e)return{path:s.default,tab:gt(s,s.default),params:{}};let[a,n=""]=e.split("?"),t=new URLSearchParams(n),i=t.get("tab"),d={};for(let[p,h]of t.entries())p!=="tab"&&(d[p]=h);return Te(s,a)?{path:a,tab:i??gt(s,a),params:d}:{path:s.default,tab:gt(s,s.default),params:{}}}function vt(s,e,a){let n=new URLSearchParams;e&&n.set("tab",e);for(let[i,d]of Object.entries(a))n.set(i,d);let t=n.toString();return t?`#/${s}?${t}`:`#/${s}`}function bt(s,e=null,a={}){window.location.hash=vt(s,e,a)}function Rt(s,e){let a=Pt();if(a.path!==s){bt(s,e);return}window.location.hash=vt(s,e,a.params)}function Ht(s,e){let a=Pt(),n={...a.params,[s]:e};window.location.hash=vt(a.path,a.tab,n)}function Dt(s,e){let a=()=>e(xe(s));return window.addEventListener("hashchange",a),a(),()=>window.removeEventListener("hashchange",a)}function Te(s,e){return s.sections.some(a=>a.items.some(n=>n.route===e))}function gt(s,e){for(let a of s.sections)for(let n of a.items)if(n.route===e)return n.tabs&&n.tabs.length>0?n.tabs[0].id:null;return null}function It(s,e){for(let a of s.sections)for(let n of a.items)if(n.route===e)return{section:a,item:n};return null}function Pt(){let s=window.location.hash.replace(/^#\/?/,""),[e,a=""]=s.split("?"),n=new URLSearchParams(a),t=n.get("tab"),i={};for(let[d,p]of n.entries())d!=="tab"&&(i[d]=p);return{path:e,tab:t,params:i}}var P={housing:{label:"Accommodation",color:"#B89968",icon:"home"},food:{label:"Food & dining",color:"#6FA78A",icon:"utensils"},transport:{label:"Transport",color:"#7B95A8",icon:"car"},travel:{label:"Travel",color:"#A07B8C",icon:"plane"},entertainment:{label:"Entertainment",color:"#C89456",icon:"film"},shopping:{label:"Shopping",color:"#5F7884",icon:"bag"},health:{label:"Health",color:"#B66758",icon:"heart"},education:{label:"Education",color:"#8C7A6B",icon:"book"},utilities:{label:"Subscriptions",color:"#6E665D",icon:"plug"},taxes:{label:"Taxes",color:"#C89456",icon:"receipt"},income:{label:"Employment income",color:"#6FA78A",icon:"briefcase"},investment_income:{label:"Investment income",color:"#B89968",icon:"trending-up"},other:{label:"Other",color:"#6A6357",icon:"circle"}},W={etf_intl:{label:"International equity ETFs",color:"#B89968"},etf_br:{label:"Brazilian equity ETFs",color:"#6FA78A"},etf_bonds:{label:"Fixed-income ETFs",color:"#7B95A8"},etf_crypto:{label:"Digital-asset ETFs",color:"#A07B8C"},cash:{label:"Cash & equivalents",color:"#6E665D"}},Ft={home:'<path d="M3 9.5L12 3l9 6.5V20a2 2 0 0 1-2 2h-4v-7H9v7H5a2 2 0 0 1-2-2V9.5z"/>',utensils:'<path d="M3 2v7c0 1.1.9 2 2 2h2v11"/><path d="M7 2v20"/><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3z"/>',car:'<path d="M5 17h14M3 13l2-6h14l2 6M5 13v4M19 13v4M7 17a1 1 0 1 0 0 2 1 1 0 0 0 0-2zM17 17a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>',plane:'<path d="M17.8 19.2L16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5L3 8.7c-.2.4 0 .9.4 1.1L9 13l-2 3H4l-1 1 3 1.5 1.5 3 1-1v-3l3-2 4.4 5.6c.2.4.7.6 1.1.4l2-.6c.4-.2.6-.6.5-1.1z"/>',film:'<rect x="2" y="3" width="20" height="18" rx="2"/><line x1="2" y1="8" x2="22" y2="8"/><line x1="2" y1="16" x2="22" y2="16"/><line x1="7" y1="3" x2="7" y2="21"/><line x1="17" y1="3" x2="17" y2="21"/>',bag:'<path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/>',heart:'<path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>',book:'<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>',plug:'<path d="M9 2v6M15 2v6M6 8h12v4a6 6 0 0 1-12 0V8z"/><path d="M12 18v4"/>',receipt:'<path d="M4 2v20l3-2 3 2 3-2 3 2 3-2V2H4z"/><line x1="8" y1="7" x2="16" y2="7"/><line x1="8" y1="11" x2="16" y2="11"/><line x1="8" y1="15" x2="13" y2="15"/>',briefcase:'<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>',"trending-up":'<polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/>',circle:'<circle cx="12" cy="12" r="10"/>',expenses:'<path d="M2 12h6m4 0h10"/><circle cx="10" cy="12" r="2"/><path d="M5 6v12M19 6v12M5 18h14"/>',portfolio:'<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M7 12l3 3 7-7"/>',map:'<path d="M1 6v16l7-4 8 4 7-4V2l-7 4-8-4z"/><line x1="8" y1="2" x2="8" y2="18"/><line x1="16" y1="6" x2="16" y2="22"/>',reports:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="15" y2="17"/>',search:'<circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/>',bell:'<path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',settings:'<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/>',"arrow-up":'<polyline points="18 15 12 9 6 15"/>',"arrow-down":'<polyline points="6 9 12 15 18 9"/>',download:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/>',filter:'<polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/>',"file-text":'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/>',globe:'<circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>',shield:'<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>',award:'<circle cx="12" cy="8" r="6"/><polyline points="9 13.5 9 22 12 19 15 22 15 13.5"/>',plus:'<line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>',"chevron-down":'<polyline points="6 9 12 15 18 9"/>',"credit-card":'<rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/>',building:'<rect x="4" y="3" width="16" height="18" rx="1"/><line x1="9" y1="7" x2="9" y2="7"/><line x1="15" y1="7" x2="15" y2="7"/><line x1="9" y1="11" x2="9" y2="11"/><line x1="15" y1="11" x2="15" y2="11"/><line x1="9" y1="15" x2="9" y2="15"/><line x1="15" y1="15" x2="15" y2="15"/><line x1="10" y1="21" x2="10" y2="17"/><line x1="14" y1="21" x2="14" y2="17"/>',"home-key":'<path d="M3 9.5L12 3l9 6.5V20a2 2 0 0 1-2 2h-4v-7H9v7H5a2 2 0 0 1-2-2V9.5z"/>'};function x(s,e={}){let a=Ft[s]||Ft.circle,n='viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"',t=Object.entries(e).map(([i,d])=>`${i}="${d}"`).join(" ");return`<svg ${n} ${t}>${a}</svg>`}var yt={USD:"en-US",EUR:"de-DE",BRL:"pt-BR",GBP:"en-GB"};var Me={USD:"\u{1F1FA}\u{1F1F8}",EUR:"\u{1F1EA}\u{1F1FA}",BRL:"\u{1F1E7}\u{1F1F7}",GBP:"\u{1F1EC}\u{1F1E7}"};function Nt(s){return Me[s]}function M(s,e,a,n){return e===a?s:s*n[e]/n[a]}function o(s,e,a={}){let{signed:n=!1,abs:t=!1,decimals:i,compact:d=!1}=a,p=t?Math.abs(s):s;return new Intl.NumberFormat(yt[e],{style:"currency",currency:e,minimumFractionDigits:i??2,maximumFractionDigits:i??2,notation:d?"compact":"standard",signDisplay:n?"always":"auto"}).format(p)}function X(s,e=1){return`${s>0?"+":""}${s.toFixed(e)}%`}function I(s,e="BRL"){let a=new Date(s+"T00:00:00");return new Intl.DateTimeFormat(yt[e],{day:"2-digit",month:"short"}).format(a)}function ft(s,e="BRL"){let[a,n]=s.split("-").map(Number),t=new Date(a,n-1,1);return new Intl.DateTimeFormat(yt[e],{month:"short",year:"numeric"}).format(t)}function _t(s,e,a){let n=M(1,s,e,a),t=n<1?4:n<100?2:0;return n.toFixed(t)}var $t=["EUR","USD","BRL","GBP"],we=[{months:1,label:"1M"},{months:3,label:"3M"},{months:6,label:"6M"},{months:12,label:"12M"}],et=new Set;function Vt(s){s.innerHTML=`
  ...
  `}function jt(s){let{reportingCurrency:e,period:a}=T.get(),n=document.getElementById("topbar");n.innerHTML=`
    ...
    <div class="topbar__group">
      <div class="fx-pill" title="Live FX rates \xB7 ${s.fx.source} \xB7 ${s.fx.asOf}">
        ...
        <span class="fx-pill__rate">${_t("USD","BRL",s.fx)}</span>
      </div>
      <div class="fx-pill">
        <span class="fx-pill__pair">EUR/BRL</span>
        <span class="fx-pill__rate">${_t("EUR","BRL",s.fx)}</span>
      </div>
      ...
      <button class="currency-select" id="currency-select">
        <span class="currency-flag">${Nt(e)}</span>
  ...
  `,n.querySelector("#period-select").addEventListener("click",t=>{let i=t.target.closest("[data-months]");i&&T.set({period:{months:parseInt(i.dataset.months,10),label:i.dataset.label}})}),n.querySelector("#currency-select").addEventListener("click",()=>{let t=$t.indexOf(e);T.set({reportingCurrency:$t[(t+1)%$t.length]})})}function Ot(s,e,a){let n=document.getElementById("sidebar"),t=e.sections.map(i=>`
      <div class="nav-section ${et.has(i.id)?"is-collapsed":""}" data-section="${i.id}">
  ...
  `,n.addEventListener("click",i=>{let d=i.target,p=d.closest("[data-toggle]");if(p){let y=p.dataset.toggle;et.has(y)?et.delete(y):et.add(y);let _=n.querySelector(`[data-section="${y}"]`);_&&_.classList.toggle("is-collapsed");return}let h=d.closest("[data-route]");h&&bt(h.dataset.route)})}var Ce=["income","investment_income"];function R(s){return s.amount>0||Ce.includes(s.category)}function V(s,e){let a=new Date(s.meta.period.to);a.setMonth(a.getMonth()-e);let n=a.toISOString().slice(0,10);return s.transactions.filter(t=>t.date>=n)}function H(s,e,a){return M(s.amount,s.currency,e,a.fx)}function st(s,e,a){let n=new Map;for(let t of s){let i=t.date.slice(0,7);n.has(i)||n.set(i,{yearMonth:i,income:0,expense:0,net:0});let d=n.get(i),p=H(t,e,a);R(t)?d.income+=p:d.expense+=Math.abs(p),d.net=d.income-d.expense}return[...n.values()].sort((t,i)=>t.yearMonth.localeCompare(i.yearMonth))}function at(s,e,a){let n=new Map,t=0;for(let i of s){if(R(i))continue;let d=Math.abs(H(i,e,a));n.has(i.category)||n.set(i.category,{category:i.category,amount:0,share:0,count:0});let p=n.get(i.category);p.amount+=d,p.count+=1,t+=d}for(let i of n.values())i.share=t>0?i.amount/t:0;return[...n.values()].sort((i,d)=>d.amount-i.amount)}function qt(s,e,a){let n=new Map;for(let t of s){if(!t.location||t.location.cc==="--"||R(t))continue;let i=`${t.location.cc}|${t.location.city}`;n.has(i)||n.set(i,{city:t.location.city,country:t.location.country,cc:t.location.cc,lat:t.location.lat,lng:t.location.lng,amount:0,count:0});let d=n.get(i);d.amount+=Math.abs(H(t,e,a)),d.count+=1}return[...n.values()].sort((t,i)=>i.amount-t.amount)}function nt(s,e,a){return s.reduce((n,t)=>{let i=t.assetClass==="cash"?t.avgCost:t.quantity*t.currentPrice;return n+M(i,t.currency,e,a.fx)},0)}function Ut(s,e,a){return s.reduce((n,t)=>{let i=t.assetClass==="cash"?t.avgCost:t.quantity*t.avgCost;return n+M(i,t.currency,e,a.fx)},0)}function Z(s,e,a){let n=s.assetClass==="cash"?s.avgCost:s.quantity*s.currentPrice;return M(n,s.currency,e,a.fx)}function Gt(s,e,a){if(s.assetClass==="cash")return{value:0,pct:0};let n=M(s.quantity*s.avgCost,s.currency,e,a.fx),t=M(s.quantity*s.currentPrice,s.currency,e,a.fx);return{value:t-n,pct:n>0?(t-n)/n*100:0}}function zt(s,e,a){let n=new Map,t=0;for(let i of s){let d=Z(i,e,a);n.has(i.assetClass)||n.set(i.assetClass,{assetClass:i.assetClass,amount:0,share:0}),n.get(i.assetClass).amount+=d,t+=d}for(let i of n.values())i.share=t>0?i.amount/t:0;return[...n.values()].sort((i,d)=>d.amount-i.amount)}var Le="http://www.w3.org/2000/svg",D=(s,e={},a=[])=>{let n=document.createElementNS(Le,s);for(let[t,i]of Object.entries(e))n.setAttribute(t,String(i));return a.forEach(t=>{typeof t=="string"?n.appendChild(document.createTextNode(t)):n.appendChild(t)}),n};function Yt(s){let{data:e,width:a,height:n,yLabel:t}=s,i={l:50,r:12,t:8,b:26},d=a-i.l-i.r,p=n-i.t-i.b,h=Math.max(1,...e.flatMap(f=>[f.income,f.expense])),y=Wt(h),_=f=>i.t+p-f/y*p,u=D("svg",{class:"chart",viewBox:`0 0 ${a} ${n}`,preserveAspectRatio:"xMidYMid meet"}),c=[0,.25,.5,.75,1].map(f=>f*y);for(let f of c){let g=_(f);u.appendChild(D("line",{class:"chart__grid-line",x1:i.l,x2:a-i.r,y1:g,y2:g})),u.appendChild(D("text",{x:i.l-8,y:g+3,"text-anchor":"end"},[t(f)]))}let r=d/e.length,l=Math.min(14,r/3);return e.forEach((f,g)=>{let b=i.l+r*g+r/2,m=_(f.income);u.appendChild(D("rect",{class:"chart__bar chart__bar--income",x:b-l-1,y:m,width:l,height:i.t+p-m,rx:2}));let $=_(f.expense);u.appendChild(D("rect",{class:"chart__bar chart__bar--expense",x:b+1,y:$,width:l,height:i.t+p-$,rx:2})),(e.length<=8||g%2===0)&&u.appendChild(D("text",{x:b,y:n-8,"text-anchor":"middle"},[f.label]))}),u}function Wt(s){if(s<=0)return 1;let e=Math.pow(10,Math.floor(Math.log10(s))),a=s/e;return(a<=1?1:a<=2?2:a<=5?5:10)*e}function q(s){let{segments:e,size:a,thickness:n=18}=s,t=a/2-4,i=t-n,d=a/2,p=a/2,h=e.reduce((u,c)=>u+c.value,0)||1,y=D("svg",{class:"chart",viewBox:`0 0 ${a} ${a}`,width:a,height:a});y.appendChild(D("circle",{class:"chart__donut-track",cx:d,cy:p,r:(t+i)/2,fill:"none","stroke-width":n,stroke:"rgba(255,255,255,0.04)"}));let _=-Math.PI/2;return e.forEach(u=>{if(u.value<=0)return;let c=u.value/h*Math.PI*2,r=d+t*Math.cos(_),l=p+t*Math.sin(_),f=d+t*Math.cos(_+c),g=p+t*Math.sin(_+c),b=d+i*Math.cos(_),m=p+i*Math.sin(_),$=d+i*Math.cos(_+c),B=p+i*Math.sin(_+c),S=c>Math.PI?1:0,j=[`M ${r} ${l}`,`A ${t} ${t} 0 ${S} 1 ${f} ${g}`,`L ${$} ${B}`,`A ${i} ${i} 0 ${S} 0 ${b} ${m}`,"Z"].join(" ");y.appendChild(D("path",{d:j,fill:u.color,opacity:.92})),_+=c}),y}function Xt(s){let{values:e,labels:a,width:n,height:t,yLabel:i}=s,d={l:60,r:12,t:12,b:26},p=n-d.l-d.r,h=t-d.t-d.b,y=Math.max(...e),_=Math.min(...e),u=Wt(y),c=Math.max(0,Ee(_)),r=u-c||1,l=N=>d.t+h-(N-c)/r*h,f=D("svg",{class:"chart",viewBox:`0 0 ${n} ${t}`}),g=[0,.25,.5,.75,1].map(N=>c+N*(u-c));for(let N of g){let F=l(N);f.appendChild(D("line",{class:"chart__grid-line",x1:d.l,x2:n-d.r,y1:F,y2:F})),f.appendChild(D("text",{x:d.l-8,y:F+3,"text-anchor":"end"},[i(N)]))}let b=e.map((N,F)=>{let G=d.l+F/Math.max(1,e.length-1)*p,z=l(N);return[G,z]}),m=b.map(([N,F],G)=>`${G===0?"M":"L"} ${N.toFixed(1)} ${F.toFixed(1)}`).join(" "),$=`${m} L ${b[b.length-1][0].toFixed(1)} ${d.t+h} L ${d.l} ${d.t+h} Z`,B=`area-${Math.random().toString(36).slice(2,8)}`,S=D("defs"),j=D("linearGradient",{id:B,x1:"0",x2:"0",y1:"0",y2:"1"});j.appendChild(D("stop",{offset:"0%","stop-color":"#5B8CFF","stop-opacity":"0.20"})),j.appendChild(D("stop",{offset:"100%","stop-color":"#5B8CFF","stop-opacity":"0"})),S.appendChild(j),f.appendChild(S),f.appendChild(D("path",{class:"chart__area",d:$,fill:`url(#${B})`})),f.appendChild(D("path",{class:"chart__line",d:m,fill:"none"}));let tt=Math.ceil(a.length/8);return a.forEach((N,F)=>{if(F%tt!==0&&F!==a.length-1)return;let G=d.l+F/Math.max(1,a.length-1)*p;f.appendChild(D("text",{x:G,y:t-8,"text-anchor":"middle"},[N]))}),f}function Ee(s){if(s<=0)return 0;let e=Math.pow(10,Math.floor(Math.log10(s))),a=s/e;return(a>=5?5:a>=2?2:1)*e}function E(s,e){return!s.tabs||s.tabs.length===0?"":`
    <nav class="view-tabs" data-tabbar="${s.route}">
      ${s.tabs.map(a=>`
        <button class="view-tabs__tab ${a.id===e?"is-active":""}" data-tab="${a.id}">${a.label}</button>
      `).join("")}
    </nav>
  `}function C(s,e){s.querySelectorAll("[data-tabbar]").forEach(a=>{a.addEventListener("click",n=>{let t=n.target.closest("[data-tab]");t&&Rt(e,t.dataset.tab)})})}function Kt(s,e,a,n){let{reportingCurrency:t,period:i}=T.get(),d=V(e,i.months),p=st(d,t,e),h=at(d,t,e),y=p.reduce((m,$)=>m+$.income,0),_=p.reduce((m,$)=>m+$.expense,0),u=p.filter(m=>m.expense>100),c=u.length?u.reduce((m,$)=>m+$.expense,0)/u.length:0,r=p[p.length-1],l=p[p.length-2],f=l&&l.expense>0?(r.expense-l.expense)/l.expense*100:0,g=y>0?(y-_)/y*100:0;s.innerHTML=`
    <div class="view fade-in">
      ...
      <section class="grid-4">
        ${rt("positive","Net savings",o(y-_,t,{decimals:0}),X(g,1)+" rate")}
        ${rt("brand","Avg monthly",o(c,t,{decimals:0}),`${u.length} months`)}
        ${rt("violet","This month",o(r?.expense||0,t,{decimals:0}),X(f,1)+" vs last")}
        ${rt("gold","Top category",h[0]?P[h[0].category].label:"\u2014",h[0]?o(h[0].amount,t,{decimals:0}):"")}
      </section>
  ...
  `;let b=s.querySelector("#tab-content");if(n==="overview"){b.innerHTML=`
    ...
    `,b.querySelector("#line").appendChild(Xt({values:p.map(m=>m.expense),labels:p.map(m=>ft(m.yearMonth,t).split(" ")[0]),width:1100,height:260,yLabel:m=>o(m,t,{decimals:0,compact:!0})})),b.querySelector("#heat").innerHTML=ke(d,p,h.slice(0,8),t,e));C(s,a.route)}function Zt(s,e){return s.map(a=>`
  ...
  `).join("")}function ke(s,e,a,n,t){return`<div style="overflow:auto"><table class="tbl">
  ...
  `;let u=s.querySelector("#tab-content");if(n==="cities"){u.innerHTML=`
    ...
    `).join(""),c.addEventListener("click",l=>{let f=l.target.closest("[data-idx]");if(!f)return;let g=p[parseInt(f.dataset.idx,10)];O&&g&&O.flyTo([g.lat,g.lng],7,{duration:.9}),c.querySelectorAll(".is-active").forEach(b=>b.classList.remove("is-active")),f.classList.add("is-active")}),requestAnimationFrame(()=>Se(p,t,r))}else n==="countries"&&(u.innerHTML=`
      <section class="grid-3">
    ...
    `);C(s,a.route)}function Se(s,e,a){if(!(typeof L>"u")){O&&(O.remove(),O=null),O=L.map("leaflet-map",{zoomControl:!0,worldCopyJump:!0,minZoom:2}).setView([47,5],4),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"&copy; OpenStreetMap",maxZoom:18}).addTo(O);for(let n of s){let t=10+Math.round(n.amount/a*18),i=t>20?"map-pin--lg":t>14?"map-pin--md":"",d=L.divIcon({html:`<div class="map-pin ${i}"></div>`,className:"map-pin-wrap",iconSize:[t,t],iconAnchor:[t/2,t/2]});L.marker([n.lat,n.lng],{icon:d}).bindPopup(`
      <div class="map-popup">
    ...
    `).addTo(O)}}}function K(s,e,a,n=""){return`<div class="kpi kpi--${s}"><div class="kpi__label">${e}</div><div class="kpi__value">${a}</div>${n?`<div class="kpi__caption">${n}</div>`:""}</div>`}function Q(s){return s.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function Qt(s,e,a,n){let{reportingCurrency:t,period:i}=T.get(),d=V(e,i.months),p=new Map(e.accounts.map(c=>[c.id,c])),h=d;n==="expenses"?h=d.filter(c=>!R(c)):n==="incomes"&&(h=d.filter(c=>R(c)));let y=[...h].sort((c,r)=>r.date.localeCompare(c.date)),_=h.filter(R).reduce((c,r)=>c+H(r,t,e),0),u=h.filter(c=>!R(c)).reduce((c,r)=>c+Math.abs(H(r,t,e)),0);s.innerHTML=`
    <div class="view fade-in">
      <header class="view__head">
        <div class="view__title">
          <span class="t-eyebrow">A \xB7 Cashflow</span>
      ...
      <article class="card card--flush">
        ...
        <div style="overflow:auto; padding: 8px 0 12px">
          <table class="tbl">
            ...
            <tbody>
              ${y.slice(0,120).map(c=>{let r=P[c.category],l=p.get(c.accountId),f=o(c.amount,c.currency,{abs:!0}),g=o(Math.abs(H(c,t,e)),t,{abs:!0}),b=R(c);return`
                  <tr>
                    ...
                    <td>
                      <div class="tbl-cell">
                        ...
                        <span class="tbl-cell__main">
                          <span class="tbl-cell__title">${it(c.merchant)}</span>
                          <span class="tbl-cell__meta">${c.note?it(c.note):""}</span>
                        </span>
                      </div>
                    </td>
                    <td><span class="tag" style="--tag-color:${r.color}"><span class="tag__dot"></span>${r.label}</span></td>
                    <td class="dim">${c.location&&c.location.cc!=="--"?`${it(c.location.city)} <span class="t-dim">\xB7 ${c.location.cc}</span>`:'<span class="t-dim">\u2014</span>'}</td>
                    <td class="dim">${l?it(l.institution):""}</td>
  ...
  `,C(s,a.route)}function Be(s){return s==="expenses"?"Expense ledger":s==="incomes"?"Income ledger":"All transactions"}function xt(s,e,a,n=""){return`<div class="kpi kpi--${s}"><div class="kpi__label">${e}</div><div class="kpi__value">${a}</div>${n?`<div class="kpi__caption">${n}</div>`:""}</div>`}function it(s){return s.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}var te={Salary:"#34D399","13th salary":"#22D3EE","US ETF distributions":"#5B8CFF","EU ETF distributions":"#C084FC","BR ETF distributions":"#F472B6",Other:"#5E6884"};function ee(s,e,a,n){let{reportingCurrency:t,period:i}=T.get(),d=V(e,i.months).filter(R),p=(g,b)=>b==="income"&&g.includes("13\xBA")?"13th salary":b==="income"?"Salary":g.includes("VTI")||g.includes("VOO")||g.includes("BND")?"US ETF distributions":g.includes("VWCE")||g.includes("IWDA")?"EU ETF distributions":g.includes("IVVB")||g.includes("BOVA")||g.includes("HASH")?"BR ETF distributions":"Other",h=new Map;for(let g of d){let b=p(g.merchant,g.category);h.has(b)||h.set(b,{label:b,amount:0,count:0});let m=h.get(b);m.amount+=H(g,t,e),m.count+=1}let y=[...h.values()].sort((g,b)=>b.amount-g.amount),_=y.reduce((g,b)=>g+b.amount,0),u=y.filter(g=>g.label==="Salary"||g.label==="13th salary"),c=y.filter(g=>g.label!=="Salary"&&g.label!=="13th salary"),r=y;n==="active"?r=u:n==="passive"&&(r=c),s.innerHTML=`
    <div class="view fade-in">
      <header class="view__head">
        <div class="view__title">
      ...
      <section class="grid-3">
        ...
        ${Tt("brand","Active",o(u.reduce((g,b)=>g+b.amount,0),t,{decimals:0}),`${(u.reduce((g,b)=>g+b.amount,0)/_*100).toFixed(1)}% of total`)}
        ${Tt("violet","Passive",o(c.reduce((g,b)=>g+b.amount,0),t,{decimals:0}),`${(c.reduce((g,b)=>g+b.amount,0)/_*100).toFixed(1)}% of total`)}
      </section>
  ...
  `;let l=s.querySelector("#donut"),f=r.map(g=>({label:g.label,value:g.amount,color:te[g.label]||"#5E6884"}));l.appendChild(q({segments:f,size:220,thickness:32})),l.insertAdjacentHTML("beforeend",`<div class="donut-wrap__center"><div class="donut-wrap__label">Total</div><div class="donut-wrap__value">${o(r.reduce((g,b)=>g+b.amount,0),t,{decimals:0,compact:!0})}</div></div>`),s.querySelector("#leg").innerHTML=r.map(g=>`
    <div class="chart-legend__item" style="display:flex; align-items:center; justify-content:space-between; width:100%">
      <span style="display:flex; align-items:center; gap:8px">
        <span class="chart-legend__item-dot" style="background:${te[g.label]||"#5E6884"}"></span>
  ...
  `).join(""),C(s,a.route)}function Tt(s,e,a,n=""){return`<div class="kpi kpi--${s}"><div class="kpi__label">${e}</div><div class="kpi__value">${a}</div>${n?`<div class="kpi__caption">${n}</div>`:""}</div>`}function se(s,e,a,n){let{reportingCurrency:t}=T.get(),i=nt(e.holdings,t,e),d=Ut(e.holdings,t,e),p=i-d,h=d>0?p/d*100:0,y=zt(e.holdings,t,e);s.innerHTML=`
    <div class="view fade-in">
      <header class="view__head">
        <div class="view__title">
          <span class="t-eyebrow">B \xB7 Assets & Incomes</span>
      ...
      <section class="grid-4">
        ${ot("brand","Net worth",o(i,t,{decimals:0}),`${e.holdings.length} positions`)}
        ${ot(p>=0?"positive":"gold","P&L",o(p,t,{decimals:0,signed:!0}),X(h,1)+" unrealised")}
        ${ot("violet","Cost basis",o(d,t,{decimals:0,compact:!0}),"Aggregate book value")}
        ${ot("gold","Cash",o(y.find(u=>u.assetClass==="cash")?.amount||0,t,{decimals:0,compact:!0}),"USD/EUR/GBP/BRL")}
      </section>
  ...
  `;let _=s.querySelector("#tab-content");if(n==="allocation"){_.innerHTML=`
      ...
      <article class="card card--flush">
        ...
        <div style="overflow:auto">
          <table class="tbl">
            ...
            <tbody>
              ${u.map(c=>{let r=W[c.assetClass],l=Z(c,t,e),{value:f,pct:g}=Gt(c,t,e),b=i>0?l/i*100:0,m=c.assetClass==="cash";return`<tr>
    ...
    `}C(s,a.route)}function ot(s,e,a,n=""){return`<div class="kpi kpi--${s}"><div class="kpi__label">${e}</div><div class="kpi__value">${a}</div>${n?`<div class="kpi__caption">${n}</div>`:""}</div>`}function ae(s,e,a,n){let{reportingCurrency:t,period:i}=T.get(),d=V(e,i.months).filter(R),p=d;n==="salary"?p=d.filter(u=>u.category==="income"):n==="dividends"&&(p=d.filter(u=>u.category==="investment_income"));let h=[...p].sort((u,c)=>c.date.localeCompare(u.date)),y=p.reduce((u,c)=>u+H(c,t,e),0),_=new Map(e.accounts.map(u=>[u.id,u]));s.innerHTML=`
    <div class="view fade-in">
      <header class="view__head">
        <div class="view__title">
          <span class="t-eyebrow">B \xB7 Assets & Incomes</span>
      ...
      <section class="grid-3">
        ...
        ${Mt("gold","Latest",h[0]?I(h[0].date,t):"\u2014",h[0]?o(Math.abs(H(h[0],t,e)),t,{decimals:0}):"")}
      </section>
          ...
          <table class="tbl">
            ...
            <tbody>
              ${h.map(u=>{let c=P[u.category],r=_.get(u.accountId);return`<tr>
                  ...
                  <td><div class="tbl-cell"><span class="tbl-cell__icon" style="--cell-color:${c.color}; --cell-bg:${c.color}22">${x(c.icon)}</span><span class="tbl-cell__main"><span class="tbl-cell__title">${wt(u.merchant)}</span><span class="tbl-cell__meta">${u.note?wt(u.note):""}</span></span></div></td>
                  <td><span class="tag" style="--tag-color:${c.color}"><span class="tag__dot"></span>${c.label}</span></td>
                  <td class="dim">${r?wt(r.institution):""}</td>
                  <td class="num"><span class="t-pos">+${o(u.amount,u.currency,{abs:!0})}</span> <span class="fx-tag">${u.currency}</span></td>
                  <td class="num">${o(H(u,t,e),t)}</td>
                </tr>`}).join("")}
            </tbody>
          </table>
        </div>
  ...
  `,C(s,a.route)}function Mt(s,e,a,n=""){return`<div class="kpi kpi--${s}"><div class="kpi__label">${e}</div><div class="kpi__value">${a}</div>${n?`<div class="kpi__caption">${n}</div>`:""}</div>`}function wt(s){return s.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function re(s,e,a,n){let{reportingCurrency:t,period:i}=T.get(),d=e.accounts.filter(m=>m.type==="credit_card"),p=new Date;p.setDate(p.getDate()-30);let h=p.toISOString().slice(0,10),y=e.transactions.filter(m=>d.some($=>$.id===m.accountId)&&m.date>=h&&!R(m)),_=V(e,i.months).filter(m=>d.some($=>$.id===m.accountId)&&!R(m)),u=new Map;for(let m of d)u.set(m.id,{count:0,outstanding:0,ytd:0});for(let m of y){let $=u.get(m.accountId);$.outstanding+=Math.abs(H(m,t,e)),$.count+=1}for(let m of _){let $=u.get(m.accountId);$.ytd+=Math.abs(H(m,t,e))}let c=[...u.values()].reduce((m,$)=>m+$.outstanding,0),r=[...u.values()].reduce((m,$)=>m+$.ytd,0),l=new Map,f=new Map;for(let m of _){let $=m.date.slice(0,7);l.has(m.merchant)||l.set(m.merchant,new Set),l.get(m.merchant).add($),f.set(m.merchant,(f.get(m.merchant)||0)+Math.abs(H(m,t,e)))}let g=[...l.entries()].filter(([m,$])=>$.size>=6).map(([m,$])=>({merchant:m,months:$.size,total:f.get(m)})).sort((m,$)=>$.total-m.total);s.innerHTML=`
    <div class="view fade-in">
      <header class="view__head">
        <div class="view__title">
      ...
      <section class="grid-3">
        ${Ct("Outstanding \xB7 30d",o(c,t,{decimals:0}),`${y.length} charges`,"warning")}
  ...
  `;let b=s.querySelector("#tab-content");n==="outstanding"?b.innerHTML=`
    ...
    `:n==="by-card"?b.innerHTML=d.map(m=>{let $=y.filter(B=>B.accountId===m.id).slice(0,30);return`
        <article class="card card--flush" style="margin-bottom: 16px">
          ...
          <div style="overflow:auto">
            <table class="tbl">
              ...
              <tbody>
                ${$.map(B=>{let S=P[B.category];return`<tr>
                    <td class="dim">${I(B.date,t)}</td>
                    <td>${ne(B.merchant)}</td>
      ...
      <article class="card card--flush">
        ...
        <div style="overflow:auto">
          <table class="tbl">
            ...
            <tbody>
              ${g.map(m=>`<tr>
                <td><strong>${ne(m.merchant)}</strong></td>
    ...
    `),C(s,a.route)}function Ct(s,e,a="",n){return`<div class="kpi"><div class="kpi__label">${s}</div><div class="kpi__value">${e}</div>${a?`<div class="kpi__caption">${a}</div>`:""}</div>`}function ne(s){return s.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function ie(s,e,a,n){let{reportingCurrency:t}=T.get(),i=e.realEstate||[],d=i.reduce((r,l)=>r+M(l.marketValue*l.ownershipPct/100,l.currency,t,e.fx),0),p=i.reduce((r,l)=>r+(l.mortgage?M(l.mortgage.outstandingBalance*l.ownershipPct/100,l.mortgage.currency,t,e.fx):0),0),h=d-p,y=d>0?p/d*100:0,_=i.reduce((r,l)=>r+(l.monthlyRent?M(l.monthlyRent,l.currency,t,e.fx):0),0),u=i.reduce((r,l)=>r+(l.mortgage?M(l.mortgage.monthlyPayment,l.mortgage.currency,t,e.fx):0),0);s.innerHTML=`
    <div class="view fade-in">
      <header class="view__head">
        <div class="view__title">
      ...
      <section class="grid-4">
        ${ct("Aggregate market value",o(d,t,{decimals:0,compact:!0}),`${i.length} properties`)}
        ${ct("Outstanding mortgage debt",o(p,t,{decimals:0,compact:!0}))}
        ${ct("Net equity",o(h,t,{decimals:0,compact:!0}),`LTV ${y.toFixed(1)}%`)}
        ${ct("Monthly rent / debt service",`${o(_,t,{decimals:0})} / ${o(u,t,{decimals:0})}`,`Net ${o(_-u,t,{decimals:0,signed:!0})}`)}
      </section>
  ...
  `;let c=s.querySelector("#tab-content");n==="portfolio"?c.innerHTML=`
      ...
      <article class="card card--flush">
        ...
        <div style="overflow:auto">
          <table class="tbl">
            ...
            <tbody>
              ${i.filter(r=>r.monthlyRent).map(r=>{let l=r.marketValue*r.ownershipPct/100,f=r.monthlyRent,g=r.monthlyHoa||0,b=r.mortgage?r.mortgage.monthlyPayment:0,m=f-g-b,$=f*12/l*100,B=m*12/l*100;return`<tr>
    ...
    `),C(s,a.route)}function ct(s,e,a=""){return`<div class="kpi"><div class="kpi__label">${s}</div><div class="kpi__value">${e}</div>${a?`<div class="kpi__caption">${a}</div>`:""}</div>`}function U(s){return s.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}var Lt={margin_loan:"Margin loan",securities_backed_credit:"Securities-backed credit",derivative_notional:"Derivative notional",fx_forward:"FX forward"};function oe(s,e,a,n){let{reportingCurrency:t}=T.get(),i=e.leverage||[],d=i.reduce((r,l)=>r+M(l.notional,l.currency,t,e.fx),0),p=i.reduce((r,l)=>r+M(l.collateralValue,l.collateralCurrency,t,e.fx),0),h=p>0?d/p*100:0,y=i.reduce((r,l)=>r+M(l.monthlyCost,l.currency,t,e.fx),0),_=i.filter(r=>r.rate!==null),u=_.length>0?_.reduce((r,l)=>r+(l.rate||0)*M(l.notional,l.currency,t,e.fx),0)/_.reduce((r,l)=>r+M(l.notional,l.currency,t,e.fx),0):0;s.innerHTML=`
    <div class="view fade-in">
      <header class="view__head">
        <div class="view__title">
      ...
      <section class="grid-4">
        ${lt("Aggregate notional",o(d,t,{decimals:0,compact:!0}),`${i.length} positions`)}
        ${lt("Collateral value",o(p,t,{decimals:0,compact:!0}))}
        ${lt("Blended LTV",h.toFixed(1)+"%","Aggregate exposure")}
        ${lt("Monthly carry",o(y,t,{decimals:0}),`Blended rate ${u.toFixed(2)}%`)}
      </section>
  ...
  `;let c=s.querySelector("#tab-content");n==="positions"?c.innerHTML=`
      ...
      <article class="card card--flush">
        ...
        <div style="overflow:auto">
          <table class="tbl">
            ...
            <tbody>
              ${i.map(r=>{let l=M(r.monthlyCost,r.currency,t,e.fx);return`<tr>
                  <td><span class="badge badge--gold">${Lt[r.type]||r.type}</span></td>
                  <td>${Et(r.counterparty)}</td>
                  <td class="num">${o(r.notional,r.currency,{decimals:0})}</td>
                  <td class="num">${r.rate!==null?r.rate.toFixed(2)+"%":'<span class="t-dim">\u2014</span>'}</td>
    ...
    `),C(s,a.route)}function lt(s,e,a=""){return`<div class="kpi"><div class="kpi__label">${s}</div><div class="kpi__value">${e}</div>${a?`<div class="kpi__caption">${a}</div>`:""}</div>`}function Et(s){return s.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function ce(s,e,a,n){let{reportingCurrency:t,period:i}=T.get(),d=V(e,i.months),p=st(d,t,e),h=at(d,t,e),y=p.reduce((g,b)=>g+b.income,0),_=p.reduce((g,b)=>g+b.expense,0),u=y-_,c=d.filter(g=>g.category==="income").reduce((g,b)=>g+H(b,t,e),0),r=d.filter(g=>g.category==="investment_income").reduce((g,b)=>g+H(b,t,e),0),l=nt(e.holdings,t,e);s.innerHTML=`
    <div class="view fade-in">
      <header class="view__head">
        <div class="view__title">
  ...
  `;let f=s.querySelector("#tab-content");if(n==="income-stmt")f.innerHTML=`
    ...
    `;else if(n==="balance"){let g=e.holdings.find(S=>S.ticker==="CASH-USD")?.avgCost||0,b=e.holdings.find(S=>S.ticker==="CASH-EUR")?.avgCost||0,m=e.holdings.find(S=>S.ticker==="CASH-GBP")?.avgCost||0,$=e.holdings.find(S=>S.ticker==="CASH-BRL")?.avgCost||0,B=l-e.holdings.filter(S=>S.assetClass==="cash").reduce((S,j)=>S+j.avgCost*e.fx[j.currency]/e.fx[t],0);f.innerHTML=`
      <article class="card">
    ...
    `);C(s,a.route)}function k(s,e,a="",n=!1,t=!1){return n?`<tr style="background: rgba(255,255,255,0.02)"><td colspan="2"><strong style="text-transform: uppercase; font-size: 0.72rem; letter-spacing: 0.10em; color: var(--c-text-tertiary, #5E6884)">${s}</strong></td></tr>`:t?`<tr style="border-top: 1px solid rgba(255,255,255,0.10)"><td><strong>${s}</strong></td><td class="num"><strong class="${a}">${e}</strong></td></tr>`:`<tr><td>${s}</td><td class="num ${a}">${e}</td></tr>`}function le(s,e,a,n){let{route:t}=T.get(),i=e.fx,d=new Set;for(let v of e.transactions)d.add(parseInt(v.date.slice(0,4),10));let p=[...d].sort((v,w)=>w-v),y=new Date(e.meta.period.to).getFullYear(),_=p.find(v=>v<y)??p[0]??y,u=parseInt(t.params.year||String(_),10),c=`${u}-01-01`,r=`${u}-12-31`,l=e.transactions.filter(v=>v.date>=c&&v.date<=r),f=u===y,g=u<y,b=l.length===0,m=e.holdings.map(v=>{let w=v.assetClass==="cash"?v.avgCost:v.quantity*v.currentPrice,A=M(w,v.currency,"BRL",i);return{holding:v,native:w,valBrl:A}}).sort((v,w)=>w.valBrl-v.valBrl),$=m.reduce((v,w)=>v+w.valBrl,0),B=l.filter(v=>v.category==="income"&&v.amount>0).reduce((v,w)=>v+M(w.amount,w.currency,"BRL",i),0),S=l.filter(v=>v.category==="investment_income"&&v.merchant.startsWith("Distribution \xB7 IVVB")).reduce((v,w)=>v+M(w.amount,w.currency,"BRL",i),0),j=l.filter(v=>v.category==="investment_income"&&!v.merchant.startsWith("Distribution \xB7 IVVB")).reduce((v,w)=>v+M(w.amount,w.currency,"BRL",i),0),tt=Math.min(B*.14,9e3),N=B-tt,F=Math.max(0,Ae(N)),z=F*.95-F,Y=e.darfs.filter(v=>v.yearMonth.startsWith(String(u))),ge=Y.reduce((v,w)=>v+w.taxOwed,0),ve=Y.filter(v=>v.paid).reduce((v,w)=>v+w.taxOwed,0);s.innerHTML=`
    <div class="view fade-in">
      <header class="view__head">
        <div class="view__title">
        ...
        <div class="view__actions">
          <div class="seg-control" id="year-switcher">
            ${p.map(v=>{let w=v===y?"in-progress":v<y?"historical":"future";return`<span class="seg-control__btn ${v===u?"is-active":""}" data-year="${v}" title="${w}">${v}${v===y?" \xB7":""}</span>`}).join("")}
          </div>
  ...
  `,s.querySelector("#year-switcher").addEventListener("click",v=>{let w=v.target.closest("[data-year]");w&&Ht("year",w.dataset.year)});let J=s.querySelector("#tab-content");if(b){J.innerHTML=`
      <article class="card">
    ...
    `,C(s,a.route);return}if(n==="summary")J.innerHTML=`
      ...
      <article class="card report-section">
        ...
        <div style="overflow:auto">
          <table class="tbl">
            ...
            <tbody>
              ${m.map(v=>`<tr>
                <td><span class="fx-tag">${Re(v.holding.assetClass)}</span></td>
              ...
              ${(e.realEstate||[]).map(v=>`<tr>
                ...
                <td><div class="tbl-cell"><span class="tbl-cell__icon" style="--cell-color:#B89968">${x("building")}</span><span class="tbl-cell__main"><span class="tbl-cell__title">${dt(v.name)}</span><span class="tbl-cell__meta">${dt(v.address)} \xB7 ${v.ownershipPct}%</span></span></div></td>
                <td><span class="fx-tag">${v.cc}</span></td>
                <td class="num dim">${o(v.acquisitionCost*v.ownershipPct/100,v.currency,{decimals:0})}</td>
                <td class="num">${o(M(v.acquisitionCost*v.ownershipPct/100,v.currency,"BRL",i),"BRL",{decimals:0})}</td>
              </tr>`).join("")}
    ...
    `;else if(n==="income"){let v=l.filter(A=>A.category==="investment_income"&&A.merchant.startsWith("Distribution \xB7 IVVB")),w=l.filter(A=>A.category==="investment_income"&&!A.merchant.startsWith("Distribution \xB7 IVVB"));J.innerHTML=`
      <article class="card report-section">
        ...
        <div style="overflow:auto">
          <table class="tbl">
            ...
            <tbody>${v.length===0?`<tr><td colspan="4" class="dim center" style="text-align:center; padding: 24px">No entries for ${u}</td></tr>`:v.map(A=>`<tr><td class="dim">${I(A.date,"BRL")}</td><td>${dt(A.merchant)}</td><td class="num dim">${o(A.amount,A.currency)}</td><td class="num">${o(M(A.amount,A.currency,"BRL",i),"BRL")}</td></tr>`).join("")}</tbody>
          </table>
        </div>
      </article>
      <article class="card report-section">
        ...
        <div style="overflow:auto">
          <table class="tbl">
            <thead><tr><th>Date</th><th>Source</th><th class="num">Native amount</th><th class="num">BRL amount</th></tr></thead>
            <tbody>${w.length===0?`<tr><td colspan="4" class="dim" style="text-align:center; padding: 24px">No entries for ${u}</td></tr>`:w.map(A=>`<tr><td class="dim">${I(A.date,"BRL")}</td><td>${dt(A.merchant)}</td><td class="num dim">${o(A.amount,A.currency)}</td><td class="num">${o(M(A.amount,A.currency,"BRL",i),"BRL")}</td></tr>`).join("")}</tbody>
          </table>
        </div>
      </article>
  ...
  `;let t=s.querySelector("#tab-content");n==="templates"?t.innerHTML=`
    ...
    <div class="view fade-in">
      ...
      <section class="grid-3">
        ...
        ${kt("positive","Paid YTD",o(t.filter(h=>h.status==="paid").reduce((h,y)=>h+y.amountBrl,0),"BRL",{decimals:0}),`${t.filter(h=>h.status==="paid").length} payments`)}
        ${kt("brand","Upcoming events",String(t.filter(h=>h.status==="scheduled").length),"in calendar")}
      </section>

      <section id="tab-content"></section>
    </div>
  `;let p=s.querySelector("#tab-content");n==="calendar"?p.innerHTML=me(t):n==="vouchers"?p.innerHTML=pe(t.filter(h=>h.type==="CAPGAINS")):n==="property"&&(p.innerHTML=pe(t.filter(h=>h.type==="PROPERTY"))),C(s,a.route)}function me(s){return`
    <article class="card card--flush">
  ...
  `}function pe(s){return s.length===0?`<article class="card"><div class="empty-state">${x("receipt")}<h3 class="t-h2">No events in this category yet</h3></div></article>`:me(s)}function Ie(s){return s==="paid"?'<span class="badge badge--positive"><span class="badge__dot"></span>Paid</span>':s==="pending"?'<span class="badge badge--warning"><span class="badge__dot"></span>Pending</span>':'<span class="badge badge--neutral"><span class="badge__dot"></span>Scheduled</span>'}function kt(s,e,a,n=""){return`<div class="kpi kpi--${s}"><div class="kpi__label">${e}</div><div class="kpi__value">${a}</div>${n?`<div class="kpi__caption">${n}</div>`:""}</div>`}var Pe={"cashflow/categories":Kt,"cashflow/map":Jt,"cashflow/tables":Qt,"assets/sources":ee,"assets/portfolio":se,"assets/incomes":ae,"liabilities/credit-cards":re,"liabilities/real-estate":ie,"liabilities/leverage":oe,"accounting/general":ce,"accounting/tax-return":le,"accounting/reports":de,"accounting/taxes":ue};async function Fe(){let s=document.getElementById("app");Vt(s);let e=document.getElementById("main");e.innerHTML='<div class="view"><div class="empty-state"><div class="skeleton" style="width: 320px; height: 32px"></div></div></div>';let a,n;try{[a,n]=await Promise.all([Bt(),At()])}catch(t){e.innerHTML=`<div class="view"><div class="empty-state"><h3 class="t-h2">Could not load data</h3><p class="t-meta">${t.message}</p></div></div>`;return}T.set({data:a,nav:n,loading:!1}),T.subscribe(()=>he()),Dt(n,t=>T.set({route:t})),he()}function he(){let{data:s,nav:e,route:a}=T.get();if(!s||!e)return;jt(s),Ot(s,e,a.path);let n=document.getElementById("main"),t=It(e,a.path);if(!t){n.innerHTML='<div class="view"><div class="empty-state"><h3 class="t-h2">Unknown route</h3></div></div>';return}let i=Pe[a.path];if(!i){n.innerHTML=`<div class="view"><div class="empty-state"><h3 class="t-h2">${t.item.label}</h3><p class="t-meta">View not yet wired.</p></div></div>`;return}i(n,s,t.item,a.tab||(t.item.tabs?.[0]?.id??""))}Fe();})();
