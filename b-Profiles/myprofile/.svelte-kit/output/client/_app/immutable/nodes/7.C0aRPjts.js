import{a as O,f as M}from"../chunks/TcwDEmaU.js";import{i as ee,n as te}from"../chunks/UAQ4T5Ep.js";import{ac as re,N as P,ad as ae,u as oe,r as ie,O as se,z as V,a9 as b,i as ne,A as G,a0 as H,b as a,B as J,a1 as D,C as S,G as A,F as le,f as y,E as X,m as ce}from"../chunks/CFxgbuDx.js";import{b as q}from"../chunks/BuDxADCf.js";import{d as de,a as ue,s as fe}from"../chunks/DaMykeKc.js";import{i as me}from"../chunks/BWcEFERt.js";import{e as ve,a as he,i as pe,r as ye}from"../chunks/2Nb7aSMw.js";function ge(t,m,i=m){var e=new WeakSet;re(t,"input",async c=>{var d=c?t.defaultValue:t.value;if(d=W(t)?Y(d):d,i(d),P!==null&&e.add(P),await ae(),d!==(d=m())){var h=t.selectionStart,u=t.selectionEnd,g=t.value.length;if(t.value=d??"",u!==null){var p=t.value.length;h===u&&u===g&&p>g?(t.selectionStart=p,t.selectionEnd=p):(t.selectionStart=h,t.selectionEnd=Math.min(u,p))}}}),(se&&t.defaultValue!==t.value||oe(m)==null&&t.value)&&(i(W(t)?Y(t.value):t.value),P!==null&&e.add(P)),ie(()=>{var c=m();if(t===document.activeElement){var d=P;if(e.has(d))return}W(t)&&c===Y(t.value)||t.type==="date"&&!c&&!t.value||c!==t.value&&(t.value=c??"")})}function W(t){var m=t.type;return m==="number"||m==="range"}function Y(t){return t===""?null:+t}var we=M('<div class="terminal-loading"><span class="blink">Scanning your digital footprint...</span></div>'),be=M("<div> </div>"),Se=M('<div class="terminal-ai-container"><div class="terminal-header"><div class="terminal-dots"><span class="dot red"></span> <span class="dot yellow"></span> <span class="dot green"></span></div> <span class="terminal-title">AI_TERMINAL // VISITOR ANALYSIS</span></div> <div class="terminal-body"><!> <!> <div class="terminal-input-line"><span class="prompt">visitor@dnm:~$</span> <input type="text" class="terminal-input" placeholder="Type something..."/> <span class="cursor blink"></span></div></div></div>');function Ae(t,m){V(m,!0);let i=b(ne([])),e=b(""),c=b(!1),d=b(!0),h=b(null),u=b(null);const g=["Why do programmers prefer dark mode? Because light attracts bugs!","A SQL query walks into a bar, walks up to two tables and asks... 'Can I join you?'","Why do Java developers wear glasses? Because they don't C#!","There are only 10 types of people in the world: those who understand binary and those who don't.","Why was the JavaScript developer sad? Because he didn't Node how to Express himself!","A programmer's wife tells him: 'Go to the store and buy a loaf of bread. If they have eggs, buy a dozen.' He comes back with 12 loaves of bread.","Why do programmers hate nature? It has too many bugs!","!false - It's funny because it's true!","How many programmers does it take to change a light bulb? None, that's a hardware problem!","Why did the developer go broke? Because he used up all his cache!","What's a programmer's favorite hangout place? Foo Bar!","Why do programmers always mix up Halloween and Christmas? Because Oct 31 == Dec 25!","Algorithm: A word used by programmers when they don't want to explain what they did.","There's no place like 127.0.0.1","I would tell you a UDP joke, but you might not get it.","A TCP packet walks into a bar and says 'I'd like a beer.' The bartender replies 'You want a beer?' The TCP packet says 'Yes, I want a beer.'","Why do Python programmers have low self-esteem? They're constantly comparing their self to others.","The best thing about a Boolean is that even if you're wrong, you're only off by a bit.","Debugging: Being the detective in a crime movie where you are also the murderer.","It works on my machine! Then we'll ship your machine."];function p(){const r=navigator.userAgent;return r.includes("Chrome")?"Chrome":r.includes("Firefox")?"Firefox":r.includes("Safari")?"Safari":r.includes("Edge")?"Edge":"Unknown"}function E(){const r=navigator.platform;return r.includes("Win")?"Windows":r.includes("Mac")?"macOS":r.includes("Linux")?"Linux":"Unknown"}async function F(){try{let r=parseInt(localStorage.getItem("visitCount")||"0")+1;localStorage.setItem("visitCount",r.toString()),y(u,{city:"Unknown",country:"Unknown",browser:p(),os:E(),screenSize:`${window.screen.width}x${window.screen.height}`,language:navigator.language,visitCount:r,timezone:Intl.DateTimeFormat().resolvedOptions().timeZone},!0),a(u).city="Your City",a(u).country="Your Country"}catch{}y(d,!1)}function U(){if(!a(u))return[];const{city:r,country:n,browser:l,os:k,screenSize:$,language:j,visitCount:N,timezone:z}=a(u),K=["> INITIALIZING AI PERSONALITY MODULE...","> SCANNING VISITOR DATA...","> READING COOKIES & ANALYTICS...","",`Hello there, mysterious visitor from ${r}, ${n}!`,""],Q=[`I see you're using ${l} on ${k}... Bold choice! ${l==="Chrome"?"Did you enjoy feeding all your RAM to Google today?":l==="Firefox"?"Did the fox tell you any secrets?":l==="Safari"?"Did Apple approve this visit?":"Did your browser survive the journey here?"}`,"",`Hmm, your screen is ${$}... ${parseInt($.split("x")[0])>1920?"Fancy display! Are you a designer or just really into spreadsheets?":"Cozy screen! Perfect for coding in a coffee shop, right?"}`,"",`Your timezone says ${z}... ${z.includes("America")?"Ah, coding at weird hours I see!":z.includes("Europe")?"European efficiency! Or European procrastination?":z.includes("Asia")?"The future is NOW where you are!":"Time is just a construct anyway!"}`,"",`This is visit #${N}. ${N===1?"First time here? Don't worry, I only judge a little.":N<5?"Back again? I'm flattered!":"Visit #"+N+"?! Are you stalking me or should I be worried?"}`,"",`Your browser language is '${j}'... ${j.startsWith("en")?"English speaker! Or at least your browser thinks so.":"Ooh, international visitor! Fancy!"}`,""],Z=["> ANALYTICS REPORT:","","Oh, and I'm also tracking your every move with Matomo analytics!","Every click, every scroll, every hover... I see it all.","","Your session has a unique visitor ID stored in cookies.","Don't worry, it's self-hosted - your data stays with me, not Big Tech!","","I can see: page views, time spent, scroll depth, button clicks...","Basically, I know you read this far. Impressive attention span!","","> FUN FACT: This site uses first-party cookies only.","> No third-party trackers stalking you across the web!","",`Your referrer? ${typeof document<"u"&&document.referrer?`You came from: ${document.referrer}`:"Direct visit - you typed the URL yourself or used a bookmark!"}`,"","> This demo shows how much data websites can collect about you.","> All analytics here are privacy-respecting and GDPR compliant.","> Type anything below and I'll respond with programmer humor!",""];return[...K,...Q,...Z]}async function o(r,n){y(c,!0);let l="";for(const k of r)l+=k,a(i)[a(i).length-1]={type:n,text:l},await new Promise($=>setTimeout($,15)),L();y(c,!1)}function f(r,n){y(i,[...a(i),{type:n,text:r}],!0),L()}async function v(r){for(const n of r)n===""?f("","ai"):n.startsWith(">")?(f("","system"),await o(n,"system")):(f("","ai"),await o(n,"ai")),await new Promise(l=>setTimeout(l,100))}async function s(){if(!a(e).trim()||a(c))return;const r=a(e);f(`$ ${r}`,"user"),y(e,""),await new Promise(l=>setTimeout(l,300));const n=g[Math.floor(Math.random()*g.length)];f("","ai"),await o(`> ${n}`,"ai")}function L(){a(h)&&(a(h).scrollTop=a(h).scrollHeight)}function C(r){r.key==="Enter"&&s()}G(async()=>{await F();const r=U();await v(r)});var _=Se(),I=D(S(_),2),w=S(I);{var B=r=>{var n=we();O(r,n)};me(w,r=>{a(d)&&r(B)})}var T=D(w,2);ve(T,17,()=>a(i),pe,(r,n)=>{var l=be(),k=S(l,!0);A(l),H(()=>{he(l,1,`terminal-line ${a(n).type??""}`),fe(k,a(n).text)}),O(r,l)});var x=D(T,2),R=D(S(x),2);ye(R),le(2),A(x),A(I),q(I,r=>y(h,r),()=>a(h)),A(_),H(()=>R.disabled=a(c)),ue("keyup",R,C),ge(R,()=>a(e),r=>y(e,r)),O(t,_),J()}de(["keyup"]);var _e=M('<div class="syslog-page svelte-rfjvxy"><canvas class="shader-bg svelte-rfjvxy"></canvas> <div class="terminal-overlay svelte-rfjvxy"><!></div></div>');function Fe(t,m){V(m,!1),G(()=>{te.setPage("syslog")});let i=ce(),e=null,c;const d=`
  ...
  `;function u(o,f,v){const s=o.createShader(f);return s?(o.shaderSource(s,v),o.compileShader(s),o.getShaderParameter(s,o.COMPILE_STATUS)?s:(console.error("Shader error:",o.getShaderInfoLog(s)),o.deleteShader(s),null)):null}function g(o,f,v){const s=o.createProgram();return!s||(o.attachShader(s,f),o.attachShader(s,v),o.linkProgram(s),!o.getProgramParameter(s,o.LINK_STATUS))?null:s}G(()=>{if(e=a(i).getContext("webgl",{antialias:!1,alpha:!1,powerPreference:"high-performance"}),!e)return;const o=u(e,e.VERTEX_SHADER,d),f=u(e,e.FRAGMENT_SHADER,h);if(!o||!f)return;const v=g(e,o,f);if(!v)return;e.useProgram(v);const s=new Float32Array([-1,-1,1,-1,-1,1,1,1]),L=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,L),e.bufferData(e.ARRAY_BUFFER,s,e.STATIC_DRAW);const C=e.getAttribLocation(v,"a_position");e.enableVertexAttribArray(C),e.vertexAttribPointer(C,2,e.FLOAT,!1,0,0);const _=e.getUniformLocation(v,"u_time"),I=e.getUniformLocation(v,"u_resolution"),w=()=>{const x=Math.min(window.devicePixelRatio,1.25);X(i,a(i).width=window.innerWidth*x),X(i,a(i).height=window.innerHeight*x),e.viewport(0,0,a(i).width,a(i).height)};w(),window.addEventListener("resize",w);const B=performance.now(),T=()=>{e&&(e.uniform1f(_,(performance.now()-B)/1e3),e.uniform2f(I,a(i).width,a(i).height),e.drawArrays(e.TRIANGLE_STRIP,0,4),c=requestAnimationFrame(T))};return T(),()=>{cancelAnimationFrame(c),window.removeEventListener("resize",w)}}),ee();var p=_e(),E=S(p);q(E,o=>y(i,o),()=>a(i));var F=D(E,2),U=S(F);Ae(U,{}),A(F),A(p),O(t,p),J()}export{Fe as component};
