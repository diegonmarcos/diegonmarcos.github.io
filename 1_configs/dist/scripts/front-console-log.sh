...
# ║                                                                  ║
# ║   Source : 1_configs/src/gha/scripts/front-console-log.sh
...
# `1_configs/src/templates/console-log-snippet.html` so the markup is
...
SNIPPET="$REPO_ROOT/1_configs/dist/templates/console-log-snippet.html"
[ -f "$SNIPPET" ] || SNIPPET="$REPO_ROOT/1_configs/src/templates/console-log-snippet.html"
...
TS_SRC="$REPO_ROOT/1_configs/dist/templates/console-logs.ts"
[ -f "$TS_SRC" ] || TS_SRC="$REPO_ROOT/1_configs/src/templates/console-logs.ts"
