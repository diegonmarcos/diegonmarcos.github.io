...
# ║                                                                  ║
# ║   Source : 1_cicd/src/scripts/build.sh
...
cmd_deps() {
    ...
    local gen="$SCRIPT_DIR/1_cicd/dist/scripts/front-gen-root-pkg.sh"
    [ -x "$gen" ] || gen="$SCRIPT_DIR/1_cicd/src/scripts/front-gen-root-pkg.sh"
    "$gen" "$SCRIPT_DIR"
