...
// Create DOM Elements
// -----------------------------------------------------------------------------
export function createNodeElements(nodes) {
...
export function createEdgeElements(edges) {
    const svg = edgesSvg;
    if (!svg)
        return;
    // Clear existing
...
// -----------------------------------------------------------------------------
export function render(nodes, edges, view) {
    if (!graphWorld || !edgesSvg || !graphContainer)
        return;
...
export function getNodeAtPoint(x, y) {
    ...
    if (el?.closest('.node')) {
        return el.closest('.node').dataset.nodeId || null;
    }
    return null;
}
// -----------------------------------------------------------------------------
