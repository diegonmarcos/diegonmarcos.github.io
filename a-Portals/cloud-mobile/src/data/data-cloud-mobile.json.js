  ...
  "sections": {
    ...
    "suite": {
      ...
      "phone": {
        ...
        "appGroups": [
          { "title": "AI", "apps": ["Claude", "Gemini", "Termux"], "folders": [
            { "label": "Files Editor (IDE)", "apps": ["X-plore", "My Files", "Google Docs", "Git Sync", "Acode", "Turbo Editor"] }
          ]},
          { "title": "Communications", "apps": ["FairEmail", "K-9 Mail", "Mattermost", "Beeper", "Dialer", "Phone"], "folders": [
            { "label": "Others", "apps": ["Samsung Email", "WhatsApp Business", "Gmail", "Telegram", "Instagram", "LinkedIn"] }
          ]},
          { "title": "Data Apps", "apps": ["Obsidian", "Gallery", "Calendar", "Contacts", "Tidal", "Bitwarden"] },
          { "title": "Tools Primary", "apps": ["Brave", "News", "Maps", "Wallet", "Translate", "Clock", "Calculator"] },
          { "title": "Tools Dashboards", "apps": ["Cloud SuperApp"] },
          { "title": "Configs", "apps": ["Play Store", "F-Droid", "Settings"] }
        ]
      }
    },
