...
# ║                                                                  ║
# ║   Source : 1_configs/src/gha/scripts/front-sw-init.sh
...
#      (1_configs/src/templates/script-service-worker.ts)
...
TEMPLATE="$REPO_ROOT/1_configs/src/templates/script-service-worker.ts"
