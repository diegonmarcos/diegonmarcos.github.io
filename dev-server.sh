...
handle_request() {
    ...
    if [ "$MIME_TYPE" = "text/html" ]; then
        # HTML file - inject dev tools before </body>
        CONTENT=$($CAT "$FILE_PATH" | $AWK '
            BEGIN { injected = 0 }
            tolower($0) ~ /<\/body>/ {
                if (!injected) {
                    print "<!-- AUTO-INJECTED DEV TOOLS -->"
                    print "<script>"
                    print "(function() {"
                    ...
                    print "    eruda.init();"
                    print "    console.log(\"%c[DEV] Eruda DevTools loaded\", \"color:green;font-weight:bold\");"
                    print "  };"
                    ...
                    print "  };"
                    print ""
                    print "  console.log = function() { o.log.apply(console, arguments); sendLog(\"log\", arguments); };"
                    print "  console.error = function() { o.error.apply(console, arguments); sendLog(\"error\", arguments); };"
                    print "  console.warn = function() { o.warn.apply(console, arguments); sendLog(\"warn\", arguments); };"
                    print "  console.info = function() { o.info.apply(console, arguments); sendLog(\"info\", arguments); };"
                    print ""
                    ...
                    print "  });"
                    print ""
                    print "  console.log(\"%c[DEV] Console + Network logging enabled\", \"color:blue;font-weight:bold\");"
                    print "})();"
                    print "</script>"
                    injected = 1
                }
            ...
            END {
                if (!injected) {
                    print "<!-- HTML without </body> tag - appending dev tools -->"
                    print "<script>"
                    print "(function() {"
                    print "  var s = document.createElement(\"script\");"
                    print "  s.src = \"//cdn.jsdelivr.net/npm/eruda\";"
                    print "  s.onload = function() { eruda.init(); };"
                    print "  document.head.appendChild(s);"
                    print "})();"
                    print "</script>"
                }
