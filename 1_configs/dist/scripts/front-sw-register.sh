...
# ║                                                                  ║
# ║   Source : 1_configs/src/gha/scripts/front-sw-register.sh
...
# `1_configs/src/templates/sw-register-snippet.html` so the markup is
...
SNIPPET="$REPO_ROOT/1_configs/dist/templates/sw-register-snippet.html"
[ -f "$SNIPPET" ] || SNIPPET="$REPO_ROOT/1_configs/src/templates/sw-register-snippet.html"
