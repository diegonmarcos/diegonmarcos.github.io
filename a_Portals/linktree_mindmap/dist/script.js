"use strict";(()=>{var Le={physics:{repulsion:0,attraction:0,centerGravity:0,damping:.98,ambientForce:0,ambientFrequency:.002,minVelocity:0,maxVelocity:1},visual:{nodeRadiusByDepth:[45,32,24,16,12],glowIntensityByDepth:[1,.8,.6,.4,.25],opacityByDepth:[1,.95,.85,.7,.5],breatheDuration:4e3,particleCount:80}};var A={levelSpacing:280,siblingSpacing:120,minZoom:.2,maxZoom:2.5,defaultZoom:1,panEasing:.12,hoverFadeSpeed:.15,expansionDuration:2e3,expansionEasing:.08};var Ge={root:{id:"dnm",label:"DNM",fullLabel:"Diego Nepomuceno Marcos",icon:"user",color:"#2196F3",children:["professional","personal"]},nodes:{professional:{id:"professional",label:"Professional",icon:"briefcase",color:"#4CAF50",children:["profile-pro","repos","nexus"]},personal:{id:"personal",label:"Personal",icon:"heart",color:"#E91E63",children:["profile-personal","deving","tools","circus"]},"profile-pro":{id:"profile-pro",label:"Profile",icon:"user",color:"#4CAF50",children:["contact-pro","profiles-pro","ventures","curriculum"]},repos:{id:"repos",label:"Repos",icon:"brand-github",color:"#4CAF50",children:["github-overview","cs-repos","eng-finance-repos"]},nexus:{id:"nexus",label:"Nexus",icon:"rocket",color:"#4CAF50",children:["nexus-contact","nexus-venture"]},"profile-personal":{id:"profile-personal",label:"Profile",icon:"user",color:"#E91E63",children:["contact-personal","profiles-personal","my-media","my-endurance","my-maps","my-bucket"]},deving:{id:"deving",label:"Deving",icon:"code",color:"#E91E63",children:["cloud-portal","ai-tools","inbox-tools","productivity-tools","dev-tools"]},tools:{id:"tools",label:"Tools",icon:"settings",color:"#E91E63",children:["health-tools","finance-tools","content-tools"]},circus:{id:"circus",label:"Circus",icon:"sparkles",color:"#E91E63",children:["games","video","audio"]},"contact-pro":{id:"contact-pro",label:"Contact",icon:"mail",color:"#81C784",links:[{label:"Email",url:"mailto:me@diegonmarcos.com",icon:"mail"},{label:"LinkedIn",url:"https://linkedin.com/in/diegonmarcos",icon:"brand-linkedin"},{label:"vCard",url:"public/diegonmarcos-contact_photo.vcf",icon:"user",download:!0}]},"profiles-pro":{id:"profiles-pro",label:"Profiles",icon:"world",color:"#81C784",links:[{label:"Landpage",url:"https://diegonmarcos.com/",icon:"world"},{label:"LinkedIn",url:"https://linkedin.com/in/diegonmarcos",icon:"brand-linkedin"},{label:"Github",url:"https://github.com/diegonmarcos",icon:"brand-github"}]},ventures:{id:"ventures",label:"Ventures",icon:"rocket",color:"#81C784",links:[{label:"Nexus",url:"https://diegonmarcos.github.io/nexus/",icon:"rocket"}]},curriculum:{id:"curriculum",label:"Curriculum",icon:"file-type-pdf",color:"#81C784",links:[{label:"CV (web)",url:"https://diegonmarcos.github.io/cv_web",icon:"file-type-html"},{label:"CV (pdf)",url:"https://diegonmarcos.github.io/cv_pdf",icon:"file-type-pdf"}]},"github-overview":{id:"github-overview",label:"Overview",icon:"brand-github",color:"#81C784",links:[{label:"Github",url:"https://github.com/diegonmarcos",icon:"brand-github"}]},"cs-repos":{id:"cs-repos",label:"Computer Science",icon:"brain",color:"#81C784",links:[{label:"Back-End",url:"https://github.com/diegonmarcos/back-System",icon:"settings"},{label:"Cyber-Security",url:"https://github.com/diegonmarcos/cyber-Cyberwarfare",icon:"bolt"},{label:"DevOps",url:"https://github.com/diegonmarcos/ops-Tooling",icon:"git-branch"},{label:"Front-End",url:"https://github.com/diegonmarcos/diegonmarcos.github.io",icon:"world"},{label:"ARM Mobile",url:"https://github.com/diegonmarcos/front-android-Portfolio",icon:"device-desktop"},{label:"Data Science",url:"https://github.com/diegonmarcos/ml-DataScience",icon:"brain"}]},"eng-finance-repos":{id:"eng-finance-repos",label:"Engineering & Finance",icon:"database",color:"#81C784",links:[{label:"Civil Engineer",url:"https://github.com/diegonmarcos/cveng_AFrame",icon:"settings"},{label:"Macro Economics",url:"https://github.com/diegonmarcos/ecoqt-thesis1",icon:"world-longitude"},{label:"Quant Finance",url:"https://github.com/diegonmarcos/ecoqt-thesis2",icon:"database"}]},"nexus-contact":{id:"nexus-contact",label:"Contact",icon:"mail",color:"#81C784",links:[{label:"Email",url:"mailto:me@diegonmarcos.com",icon:"mail"},{label:"LinkedIn",url:"https://linkedin.com/in/diegonmarcos",icon:"brand-linkedin"}]},"nexus-venture":{id:"nexus-venture",label:"Venture",icon:"rocket",color:"#81C784",links:[{label:"Website",url:"https://diegonmarcos.github.io/nexus/",icon:"rocket"},{label:"Slides",url:"https://diegonmarcos.github.io/nexus/slides",icon:"slideshow"}]},"contact-personal":{id:"contact-personal",label:"Contact",icon:"send",color:"#F48FB1",links:[{label:"Telegram",url:"https://t.me/diegonmarcos",icon:"send"},{label:"WhatsApp",url:"https://wa.me/34634769833",icon:"brand-whatsapp"}]},"profiles-personal":{id:"profiles-personal",label:"Profiles",icon:"user",color:"#F48FB1",links:[{label:"MyProfile",url:"https://diegonmarcos.github.io/myprofile",icon:"user"}]},"my-media":{id:"my-media",label:"Media",icon:"headphones",color:"#F48FB1",links:[{label:"TIDAL",url:"https://tidal.com/@diegonmarcos",icon:"headphones"},{label:"YouTube",url:"https://www.youtube.com/@diegonmarcos1",icon:"brand-youtube"},{label:"Pinterest",url:"https://www.pinterest.com/diegonmarcos",icon:"slideshow"},{label:"Instagram",url:"https://www.instagram.com/diegonmarcos",icon:"brand-instagram"}]},"my-endurance":{id:"my-endurance",label:"Endurance",icon:"bike",color:"#F48FB1",links:[{label:"Komoot",url:"https://www.komoot.com/user/2474200810898/routes",icon:"christmas-tree"},{label:"Strava",url:"https://www.strava.com/athletes/4662170",icon:"bike"}]},"my-maps":{id:"my-maps",label:"Maps",icon:"map-pin-2",color:"#F48FB1",links:[{label:"NomadMania",url:"https://nomadmania.com/profile/73889",icon:"brand-google-maps"},{label:"Google Maps",url:"https://www.google.com/maps/d/u/0/edit?mid=1Wpors-fGHMZOYPx41nDtyF9vXOJcpsY",icon:"map-pin-2"},{label:"Earth",url:"https://earth.google.com/earth/d/1WF5_9NDew9IB5xkTqXPpm9e9n8JM0a3H",icon:"world-longitude"}]},"my-bucket":{id:"my-bucket",label:"Bucket List",icon:"checklist",color:"#F48FB1",links:[{label:"50 Things",url:"https://bucketlistjourney.net/my-bucket-list",icon:"checklist"}]},"cloud-portal":{id:"cloud-portal",label:"Cloud Portal",icon:"settings",color:"#F48FB1",links:[{label:"Portal",url:"https://diegonmarcos.github.io/cloud",icon:"settings"}]},"ai-tools":{id:"ai-tools",label:"AI",icon:"robot",color:"#F48FB1",links:[{label:"Chat Multi-Model",url:"https://diegonmarcos.github.io/cloud/products.html",icon:"robot"},{label:"WebIDE",url:"https://diegonmarcos.github.io/cloud/products.html",icon:"device-desktop"}]},"inbox-tools":{id:"inbox-tools",label:"Inbox",icon:"mail",color:"#F48FB1",links:[{label:"Mail&Cal",url:"https://diegonmarcos.github.io/mymail",icon:"mail"},{label:"MyFeed",url:"https://diegonmarcos.github.io/myfeed",icon:"file-stack"}]},"productivity-tools":{id:"productivity-tools",label:"Productivity",icon:"file-stack",color:"#F48FB1",links:[{label:"Drive&Suite",url:"https://diegonmarcos.github.io/mydrive",icon:"file-stack"},{label:"JSON Vision",url:"https://diegonmarcos.github.io/json-vision",icon:"database"}]},"dev-tools":{id:"dev-tools",label:"DEV",icon:"git-branch",color:"#F48FB1",links:[{label:"API Endpoints",url:"https://diegonmarcos.github.io/cloud/api",icon:"git-branch"},{label:"MCP Tools",url:"https://diegonmarcos.github.io/cloud/mcp",icon:"settings"}]},"health-tools":{id:"health-tools",label:"Health",icon:"heart",color:"#F48FB1",links:[{label:"Feed Yourself",url:"https://diegonmarcos.github.io/feed_yourself",icon:"brain"},{label:"Health Tracker",url:"https://diegonmarcos.github.io/health_tracker",icon:"heart"}]},"finance-tools":{id:"finance-tools",label:"Finance",icon:"database",color:"#F48FB1",links:[{label:"Market Watch",url:"https://diegonmarcos.github.io/market_watch",icon:"database"},{label:"Central Bank",url:"https://diegonmarcos.github.io/central_bank",icon:"database"}]},"content-tools":{id:"content-tools",label:"Content",icon:"map-pin-2",color:"#F48FB1",links:[{label:"MyMaps",url:"https://diegonmarcos.github.io/mymaps",icon:"map-pin-2"}]},games:{id:"games",label:"Games",icon:"device-gamepad",color:"#F48FB1",links:[{label:"MyGames",url:"https://diegonmarcos.github.io/mygames",icon:"device-gamepad"}]},video:{id:"video",label:"Video",icon:"brand-youtube",color:"#F48FB1",links:[{label:"MyVideos",url:"https://diegonmarcos.github.io/myvideos",icon:"video"},{label:"MyMovies",url:"https://diegonmarcos.github.io/mymovies/",icon:"brand-youtube"}]},audio:{id:"audio",label:"Audio",icon:"headphones",color:"#F48FB1",links:[{label:"MyMusic",url:"https://diegonmarcos.github.io/mymusic/",icon:"headphones"}]}}};async function De(){return Promise.resolve(Ge)}function Re(e){let n=[],t=[],o=new Map,i=He(e.root,0,null);n.push(i),o.set(i.id,i);function a(r,s,d){s&&s.forEach(l=>{let h=e.nodes[l];if(!h){console.warn(`Node not found: ${l}`);return}let u=He(h,d,r);n.push(u),o.set(u.id,u),r.children.push(u),t.push({source:r,target:u,highlighted:!1,opacity:1}),a(u,h.children,d+1),h.links&&h.links.length>0&&(!h.children||h.children.length===0)&&h.links.forEach((m,E)=>{let g=At(m,`${u.id}-link-${E}`,d+1,u);n.push(g),o.set(g.id,g),u.children.push(g),t.push({source:u,target:g,highlighted:!1,opacity:1})})})}return a(i,e.root.children,1),{nodes:n,edges:t}}function At(e,n,t,o){let i=Le.visual,a=Math.min(t,i.nodeRadiusByDepth.length-1);return{id:n,label:e.label,fullLabel:e.label,icon:e.icon,color:o.color,depth:t,parent:o,children:[],links:[e],x:0,y:0,vx:0,vy:0,targetX:0,targetY:0,radius:i.nodeRadiusByDepth[a],opacity:1,glowIntensity:i.glowIntensityByDepth[a],highlighted:!1,hovered:!1,focused:!1,breathePhase:Math.random()*Math.PI*2,breatheScale:1}}function He(e,n,t){let o=Le.visual,i=Math.min(n,o.nodeRadiusByDepth.length-1);return{id:e.id,label:e.label,fullLabel:e.fullLabel,icon:e.icon,color:e.color,depth:n,parent:t,children:[],links:e.links||[],x:0,y:0,vx:0,vy:0,targetX:0,targetY:0,radius:o.nodeRadiusByDepth[i],opacity:1,glowIntensity:o.glowIntensityByDepth[i],highlighted:!1,hovered:!1,focused:!1,breathePhase:Math.random()*Math.PI*2,breatheScale:1}}function It(e){let n=[],t=e.parent;for(;t;)n.push(t),t=t.parent;return n}function _t(e){let n=[];function t(o){o.children.forEach(i=>{n.push(i),t(i)})}return t(e),n}function $(e,n,t){if(!t){e.forEach(l=>{l.highlighted=!1,l.opacity=1}),n.forEach(l=>{l.highlighted=!1,l.opacity=1});return}let o=It(t),i=_t(t),a=new Set([t,...o,...i]),r=new Map;r.set(t,0),o.forEach((l,h)=>{r.set(l,h+1)});function s(l,h){l.children.forEach(u=>{r.has(u)||(r.set(u,h),s(u,h+1))})}s(t,1);let d=Math.max(...Array.from(r.values()),1);e.forEach(l=>{if(l.highlighted=a.has(l),l.highlighted){let h=r.get(l)||0;l.opacity=Math.max(.3,1-h/(d+1)*.7)}else l.opacity=.08}),n.forEach(l=>{if(l.highlighted=a.has(l.source)&&a.has(l.target),l.highlighted){let h=r.get(l.source)||0,u=r.get(l.target)||0,m=(h+u)/2;l.opacity=Math.max(.3,1-m/(d+1)*.7)}else l.opacity=.03})}var I=null,F=null,w=null,ue=new Map,we=new Map;function Xe(e){if(I=e,F=document.getElementById("graph-world"),w=document.getElementById("edges-svg"),!F||!w){console.error("Graph DOM elements not found");return}Ye(),window.addEventListener("resize",Ye)}function Ye(){if(!w||!I)return;let e=I.clientWidth,n=I.clientHeight;w.setAttribute("viewBox",`0 0 ${e} ${n}`),w.style.width=`${e}px`,w.style.height=`${n}px`}function he(){return{width:I?.clientWidth||window.innerWidth,height:I?.clientHeight||window.innerHeight}}function Ve(e){F&&(F.innerHTML="",ue.clear(),e.forEach((n,t)=>{let o=document.createElement("div");o.className=`node node--depth-${Math.min(n.depth,5)}`,o.dataset.nodeId=n.id,o.style.setProperty("--node-color",n.color),o.style.setProperty("--enter-delay",String(t)),o.style.setProperty("--icon-url",`url(public/icons/${n.icon}.svg)`),o.style.backgroundImage="none";let i=document.createElement("img");i.className="node-icon",i.src=`public/icons/${n.icon}.svg`,i.alt="",i.draggable=!1,o.appendChild(i);let a=document.createElement("span");if(a.className="node-label",a.textContent=n.label,o.appendChild(a),n.children.length>0&&n.depth<3){let r=document.createElement("span");r.className="node-badge",r.textContent=String(n.children.length),o.appendChild(r)}F.appendChild(o),ue.set(n.id,o)}))}function ze(e){if(!w)return;w.innerHTML="",we.clear();let n=document.createElementNS("http://www.w3.org/2000/svg","defs");w.appendChild(n),e.forEach((t,o)=>{let i=`edge-gradient-${o}`,a=document.createElementNS("http://www.w3.org/2000/svg","linearGradient");a.id=i,a.setAttribute("gradientUnits","userSpaceOnUse");let r=document.createElementNS("http://www.w3.org/2000/svg","stop");r.setAttribute("offset","0%"),r.setAttribute("stop-color",t.source.color);let s=document.createElementNS("http://www.w3.org/2000/svg","stop");s.setAttribute("offset","100%"),s.setAttribute("stop-color",t.target.color),a.appendChild(r),a.appendChild(s),n.appendChild(a);let d=document.createElementNS("http://www.w3.org/2000/svg","path");d.className.baseVal="edge",d.setAttribute("stroke",`url(#${i})`),d.dataset.sourceId=t.source.id,d.dataset.targetId=t.target.id,w.appendChild(d),we.set(`${t.source.id}-${t.target.id}`,d)})}function T(e,n,t){if(!F||!w||!I)return;let o=I.clientWidth/2,i=I.clientHeight/2;F.style.transform=`
    translate(${o+t.x}px, ${i+t.y}px)
    scale(${t.scale})
    translate(${-o}px, ${-i}px)
  `,w.style.transform=F.style.transform,e.forEach(a=>{let r=ue.get(a.id);r&&(r.style.left=`${a.x}px`,r.style.top=`${a.y}px`,r.classList.toggle("highlighted",a.highlighted),r.classList.toggle("dimmed",!a.highlighted&&e.some(s=>s.highlighted)),r.classList.toggle("focused",a.focused),!a.highlighted&&!a.hovered?r.style.opacity=String(a.opacity):r.style.opacity="1")}),n.forEach(a=>{let r=we.get(`${a.source.id}-${a.target.id}`);if(r){let{source:s,target:d}=a,l=(s.x+d.x)/2,h=(s.y+d.y)/2,u=d.x-s.x,m=d.y-s.y,E=Math.sqrt(u*u+m*m),g=E*.15,C=-m/E,z=u/E,Z=l+C*g,j=h+z*g;r.setAttribute("d",`M ${s.x} ${s.y} Q ${Z} ${j} ${d.x} ${d.y}`);let de=r.getAttribute("stroke")?.match(/url\(#(.+)\)/)?.[1];if(de){let R=w?.querySelector(`#${de}`);R&&(R.setAttribute("x1",String(s.x)),R.setAttribute("y1",String(s.y)),R.setAttribute("x2",String(d.x)),R.setAttribute("y2",String(d.y)))}r.classList.toggle("highlighted",a.highlighted)}})}function $e(e){return ue.get(e)}function We(e,n,t){let o=e.find(a=>a.depth===0);if(!o)return;o.x=o.targetX=n,o.y=o.targetY=t,Ue(o,n,t,0,Math.PI*2,0,180)}function Oe(e,n,t){if(e.length===0)return 1;let o=1/0,i=-1/0,a=1/0,r=-1/0;e.forEach(g=>{let C=g.radius+30;o=Math.min(o,g.targetX-C),i=Math.max(i,g.targetX+C),a=Math.min(a,g.targetY-C),r=Math.max(r,g.targetY+C)});let s=i-o,d=r-a,l=n*.9,h=t*.9,u=l/s,m=h/d,E=Math.min(u,m,1);return Math.max(E,A.minZoom)}function Ue(e,n,t,o,i,a,r){if(e.children.length===0)return;let s=r*(a+1),d=e.children.length,l=i/d;e.children.forEach((h,u)=>{let m=o+l*u+l/2;h.x=h.targetX=n+Math.cos(m)*s,h.y=h.targetY=t+Math.sin(m)*s,Ue(h,n,t,o+l*u,l,a+1,r)})}function qe(){return{x:0,y:0,scale:A.defaultZoom,targetX:0,targetY:0,targetScale:A.defaultZoom}}function Ze(e,n,t,o){let i=t/2,a=o/2;n.targetX=i-e.x,n.targetY=a-e.y,n.targetScale=Math.min(1.5,A.maxZoom)}var je=1;function Ke(e){je=e}function J(e){e.targetX=0,e.targetY=0,e.targetScale=je}function Je(e){e.targetScale=Math.min(e.targetScale*1.3,A.maxZoom)}function Qe(e){e.targetScale=Math.max(e.targetScale/1.3,A.minZoom)}function ke(e,n,t,o,i,a){let r=e.targetScale,s=Math.max(A.minZoom,Math.min(A.maxZoom,r*(1-o*.001))),d=i/2,l=a/2,h=n-d,u=t-l,m=s-r;e.targetX-=(h-e.targetX)*(m/r),e.targetY-=(u-e.targetY)*(m/r),e.targetScale=s}var b={hoveredNode:null,focusedNode:null,draggingNode:null,isPanning:!1,panStartX:0,panStartY:0,lastMouseX:0,lastMouseY:0},v=null,G=[],W=[],p=null,Q=null,ee=null,Me=null,Se=0,me=!1;function tt(e){Me=e}function Y(){Me&&Me()}function nt(e,n,t,o){v=e,G=n,W=t,p=o,G.forEach(i=>{let a=$e(i.id);a&&(a.addEventListener("click",r=>{r.stopPropagation(),Q&&Q(i)}),a.addEventListener("mouseenter",()=>{b.hoveredNode=i,i.hovered=!0,$(G,W,i),Y()}),a.addEventListener("mouseleave",()=>{i.hovered=!1,b.hoveredNode=null,b.focusedNode||$(G,W,null),Y()}))}),v.addEventListener("mousedown",Ft),v.addEventListener("mousemove",Gt),v.addEventListener("mouseup",et),v.addEventListener("mouseleave",et),v.addEventListener("wheel",Ht,{passive:!1}),v.addEventListener("dblclick",Dt),v.addEventListener("click",i=>{let a=i.target;(a===v||a.id==="graph-world"||a.id==="edges-svg"||a.tagName==="svg"||a.tagName==="path")&&ee&&ee()}),v.addEventListener("touchstart",Rt,{passive:!1}),v.addEventListener("touchmove",Yt,{passive:!1}),v.addEventListener("touchend",Xt,{passive:!1})}function ot(e,n){Q=e,ee=n}function Ft(e){e.target.closest(".node")||(b.isPanning=!0,b.panStartX=e.clientX,b.panStartY=e.clientY,v&&(v.style.cursor="grabbing"))}function Gt(e){if(!b.isPanning||!p)return;let n=e.clientX-b.panStartX,t=e.clientY-b.panStartY;p.x+=n,p.y+=t,p.targetX=p.x,p.targetY=p.y,b.panStartX=e.clientX,b.panStartY=e.clientY,Y()}function et(){b.isPanning=!1,v&&(v.style.cursor="grab")}function Ht(e){if(e.preventDefault(),!p||!v)return;let n=v.getBoundingClientRect(),t=e.clientX-n.left,o=e.clientY-n.top;ke(p,t,o,e.deltaY,v.clientWidth,v.clientHeight),p.x=p.targetX,p.y=p.targetY,p.scale=p.targetScale,Y()}function Dt(e){e.target.closest(".node")||p&&(J(p),p.x=p.targetX,p.y=p.targetY,p.scale=p.targetScale,b.focusedNode=null,$(G,W,null),Y())}function Rt(e){let n=e.target;if(n.closest(".node")){let o=n.closest(".node")?.dataset.nodeId,i=G.find(a=>a.id===o);i&&Q&&(e.preventDefault(),Q(i));return}if(!(n.closest("#ui-overlay")&&!n.closest("#graph-container"))){if(e.preventDefault(),e.touches.length===1)b.isPanning=!0,b.panStartX=e.touches[0].clientX,b.panStartY=e.touches[0].clientY,me=!1;else if(e.touches.length===2){b.isPanning=!1;let t=e.touches[0],o=e.touches[1];Se=Math.hypot(o.clientX-t.clientX,o.clientY-t.clientY)}}}function Yt(e){if(!p||!v)return;let n=e.target;if(!(n.closest("#ui-overlay")&&!n.closest("#graph-container"))){if(e.preventDefault(),me=!0,e.touches.length===1&&b.isPanning){let t=e.touches[0],o=t.clientX-b.panStartX,i=t.clientY-b.panStartY;p.x+=o,p.y+=i,p.targetX=p.x,p.targetY=p.y,b.panStartX=t.clientX,b.panStartY=t.clientY,Y()}else if(e.touches.length===2){let t=e.touches[0],o=e.touches[1],i=Math.hypot(o.clientX-t.clientX,o.clientY-t.clientY),a=(t.clientX+o.clientX)/2,r=(t.clientY+o.clientY)/2,s=v.getBoundingClientRect(),d=(Se-i)*2;ke(p,a-s.left,r-s.top,d,v.clientWidth,v.clientHeight),p.x=p.targetX,p.y=p.targetY,p.scale=p.targetScale,Se=i,Y()}}}function Xt(e){let n=e.target;!me&&e.changedTouches.length===1&&!n.closest(".node")&&!n.closest("#ui-overlay")&&ee&&ee(),b.isPanning=!1,me=!1}function Ne(e){b.focusedNode=e,e&&$(G,W,e)}function Te(){b.focusedNode=null,$(G,W,null)}var Vt=null,zt=null,$t=null,Wt=null,M=null,pe=null,Be=null,te=null,it=null,q=null,at=null,rt=null,lt=null,st=null,be=null,Ce=null,ie=null,Pe=null,S=null,k=null,fe=null,ge=null,ne=null,O=null,P=null,ct=null,H=null,c=null,ae=0,re=0,_=[],U=null,le=null,X=null,N=null;function ut(e,n,t){c=e,ae=n,re=t,Vt=document.getElementById("tooltip"),zt=document.getElementById("tooltip-title"),$t=document.getElementById("tooltip-subtitle"),Wt=document.getElementById("tooltip-badge"),M=document.getElementById("link-panel"),pe=document.getElementById("link-panel-icon"),Be=document.getElementById("link-panel-title"),te=document.getElementById("link-panel-links"),it=document.getElementById("link-panel-close"),q=document.getElementById("btn-back"),at=document.getElementById("btn-home"),rt=document.getElementById("btn-reset"),lt=document.getElementById("btn-zoom-in"),st=document.getElementById("btn-zoom-out"),be=document.getElementById("btn-fullscreen"),Ce=document.getElementById("zoom-indicator"),ie=document.getElementById("loading"),Pe=document.getElementById("search-container"),S=document.getElementById("search-input"),k=document.getElementById("search-results"),fe=document.getElementById("breadcrumb"),ge=document.getElementById("breadcrumb-nav"),ne=document.getElementById("minimap-canvas"),O=document.getElementById("minimap-viewport"),P=document.getElementById("keyboard-hints"),ct=document.getElementById("hints-close"),H=document.createElement("div"),H.className="panel-backdrop",document.getElementById("ui-overlay")?.appendChild(H),it?.addEventListener("click",Ae),H?.addEventListener("click",Ae),rt?.addEventListener("click",ve),at?.addEventListener("click",ve),lt?.addEventListener("click",Et),st?.addEventListener("click",xt),be?.addEventListener("click",Lt),q?.addEventListener("click",Qt),ct?.addEventListener("click",vt),S?.addEventListener("input",qt),S?.addEventListener("focus",()=>Pe?.classList.add("focused")),S?.addEventListener("blur",()=>{setTimeout(()=>{Pe?.classList.remove("focused"),k&&(k.hidden=!0)},200)}),document.addEventListener("keydown",en),D()}function ht(e){_=e}function mt(e){le=e}function pt(e){X=e}function ft(e){N=e}function gt(e,n){ae=e,re=n}function bt(){ie&&(ie.hidden=!1)}function Ie(){ie&&(ie.hidden=!0)}function D(){if(Ce&&c){let e=Math.round(c.scale*100);Ce.textContent=`${e}%`}}function B(e){if(!fe||!ge)return;if(!e){fe.hidden=!0;return}let n=[],t=e;for(;t;)n.unshift(t),t=t.parent;ge.innerHTML=n.map((o,i)=>{let a=i===n.length-1,r=o.label;return a?`<span class="breadcrumb-current" style="color: ${o.color}">${r}</span>`:`<button class="breadcrumb-item" data-node-id="${o.id}" style="--accent: ${o.color}">${r}</button><span class="breadcrumb-sep">\u203A</span>`}).join(""),ge.querySelectorAll(".breadcrumb-item").forEach(o=>{o.addEventListener("click",()=>{let i=o.dataset.nodeId,a=_.find(r=>r.id===i);a&&X&&X(a)})}),fe.hidden=!1}function ye(e){if(!M||!Be||!te||!H)return;U=e,M.style.setProperty("--panel-accent",e.color),pe&&(pe.innerHTML=`<img src="public/icons/${e.icon}.svg" alt="">`,pe.style.backgroundColor=e.color),Be.textContent=e.fullLabel||e.label,te.innerHTML="";let n=Ot(e.links);Object.entries(n).forEach(([t,o])=>{if(Object.keys(n).length>1&&o.length>0){let i=document.createElement("div");i.className="link-group-header",i.textContent=t,te.appendChild(i)}o.forEach(i=>{let a=Ut(i,e.color);te.appendChild(a)})}),H.classList.add("visible"),M.hidden=!1,requestAnimationFrame(()=>{M?.classList.add("visible")}),B(e)}function Ot(e){let n={};return e.forEach(t=>{let o="Links",i=t.url.toLowerCase();i.includes("mailto:")||i.includes("linkedin")||i.includes("telegram")||i.includes("whatsapp")?o="Contact":i.includes("github")?o="Code":(t.download||i.includes(".pdf")||i.includes(".vcf"))&&(o="Downloads"),n[o]||(n[o]=[]),n[o].push(t)}),n}function Ae(){!M||!H||(M.classList.remove("visible"),H.classList.remove("visible"),setTimeout(()=>{M&&!M.classList.contains("visible")&&(M.hidden=!0)},300))}function Ut(e,n){let t=document.createElement("a");return t.className="link-card",t.href=e.url,t.target="_blank",t.rel="noopener noreferrer",t.style.setProperty("--link-accent",n),e.download&&(t.download=""),t.innerHTML=`
    <div class="link-icon">
  ...
  `,t.addEventListener("click",o=>{let i=t.getBoundingClientRect(),a=document.createElement("span");a.className="ripple",a.style.left=`${o.clientX-i.left}px`,a.style.top=`${o.clientY-i.top}px`,t.appendChild(a),setTimeout(()=>a.remove(),600)}),t}function qt(){if(!S||!k)return;let e=S.value.toLowerCase().trim();if(e.length<2){k.hidden=!0;return}let n=_.filter(t=>t.label.toLowerCase().includes(e)||t.fullLabel&&t.fullLabel.toLowerCase().includes(e));if(n.length===0){k.innerHTML='<div class="search-empty">No results found</div>',k.hidden=!1;return}k.innerHTML=n.slice(0,8).map(t=>`
      <button class="search-result" data-node-id="${t.id}">
        ...
        <span class="search-result-path">${Zt(t)}</span>
      </button>
    `).join(""),k.querySelectorAll(".search-result").forEach(t=>{t.addEventListener("click",()=>{let o=t.dataset.nodeId,i=_.find(a=>a.id===o);i&&X&&(X(i),S.value="",k.hidden=!0,S.blur())})}),k.hidden=!1}function Zt(e){let n=[],t=e.parent;for(;t;)n.unshift(t.label),t=t.parent;return n.join(" \u203A ")}function jt(e){let n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return n?{r:parseInt(n[1],16),g:parseInt(n[2],16),b:parseInt(n[3],16)}:{r:255,g:255,b:255}}function V(e,n){if(!ne||!O||!c)return;let t=ne.getContext("2d");if(!t)return;let o=ne.width,i=ne.height;t.clearRect(0,0,o,i);let a=1/0,r=-1/0,s=1/0,d=-1/0;e.forEach(f=>{a=Math.min(a,f.x),r=Math.max(r,f.x),s=Math.min(s,f.y),d=Math.max(d,f.y)});let l=20,h=r-a+l*2,u=d-s+l*2,m=Math.min(o/h,i/u),E=(o-h*m)/2-a*m+l*m,g=(i-u*m)/2-s*m+l*m,C=n.some(f=>f.highlighted);n.forEach(f=>{if(f.highlighted){let K=t.createLinearGradient(f.source.x*m+E,f.source.y*m+g,f.target.x*m+E,f.target.y*m+g);K.addColorStop(0,f.source.color),K.addColorStop(1,f.target.color),t.strokeStyle=K,t.lineWidth=1}else C?(t.strokeStyle="rgba(100,100,100,0.15)",t.lineWidth=.4):(t.strokeStyle="rgba(255,255,255,0.2)",t.lineWidth=.5);t.beginPath(),t.moveTo(f.source.x*m+E,f.source.y*m+g),t.lineTo(f.target.x*m+E,f.target.y*m+g),t.stroke()});let z=e.some(f=>f.highlighted);e.forEach(f=>{let K=f.x*m+E,Bt=f.y*m+g,Ct=Math.max(2,f.radius*m*.3);if(f.highlighted)t.shadowBlur=8,t.shadowColor=f.color,t.fillStyle=f.color;else if(z)t.shadowBlur=0,t.fillStyle="rgba(100, 100, 100, 0.3)";else{t.shadowBlur=0;let xe=jt(f.color);t.fillStyle=`rgba(${xe.r}, ${xe.g}, ${xe.b}, 0.8)`}t.beginPath(),t.arc(K,Bt,Ct,0,Math.PI*2),t.fill()});let Z=ae/c.scale*m,j=re/c.scale*m,de=(-c.x/c.scale+ae/2/c.scale)*m+E-Z/2,R=(-c.y/c.scale+re/2/c.scale)*m+g-j/2;O.style.width=`${Math.min(o,Z)}px`,O.style.height=`${Math.min(i,j)}px`,O.style.left=`${Math.max(0,Math.min(o-Z,de))}px`,O.style.top=`${Math.max(0,Math.min(i-j,R))}px`}function Kt(){P&&(P.hidden=!1,requestAnimationFrame(()=>P?.classList.add("visible")))}function vt(){P&&(P.classList.remove("visible"),setTimeout(()=>{P&&(P.hidden=!0)},300),localStorage.setItem("mindmap-hints-shown","true"))}function Jt(){q&&(q.hidden=!1)}function yt(){q&&(q.hidden=!0)}function ve(){c&&(J(c),c.x=c.targetX,c.y=c.targetY,c.scale=c.targetScale,yt(),B(null),D(),le&&le(),N&&N())}function Et(){c&&(Je(c),c.scale=c.targetScale,D(),N&&N())}function xt(){c&&(Qe(c),c.scale=c.targetScale,D(),N&&N())}function Lt(){document.fullscreenElement?(document.exitFullscreen(),be?.classList.remove("active")):(document.documentElement.requestFullscreen(),be?.classList.add("active"))}function Qt(){c&&(J(c),c.x=c.targetX,c.y=c.targetY,c.scale=c.targetScale,yt(),B(null),D(),le&&le(),N&&N())}var oe=-1;function en(e){if(document.activeElement===S){e.key==="Escape"&&(S?.blur(),k&&(k.hidden=!0));return}if(e.key==="/"||e.key==="s"){e.preventDefault(),S?.focus();return}if(e.key==="f"){Lt();return}e.key==="Escape"&&(M&&!M.hidden?Ae():P&&!P.hidden?vt():c&&ve()),(e.key==="+"||e.key==="=")&&Et(),(e.key==="-"||e.key==="_")&&xt(),(e.key==="0"||e.key==="r")&&ve(),["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"].includes(e.key)&&(e.preventDefault(),tn(e.key)),e.key==="Enter"&&U&&U.links.length>0&&ye(U),e.key==="?"&&Kt()}function tn(e){if(_.length===0)return;if(oe<0){oe=0,dt(_[0]);return}let n=_[oe],t=null;switch(e){case"ArrowUp":n.parent&&(t=n.parent);break;case"ArrowDown":n.children.length>0&&(t=n.children[0]);break;case"ArrowLeft":case"ArrowRight":if(n.parent){let o=n.parent.children,r=(o.indexOf(n)+(e==="ArrowRight"?1:-1)+o.length)%o.length;t=o[r]}break}t&&(oe=_.indexOf(t),dt(t))}function dt(e){U=e,B(e),X&&X(e)}function _e(e){U=e,e&&(oe=_.indexOf(e),B(e))}function wt(e){c&&(Ze(e,c,ae,re),c.x=c.targetX,c.y=c.targetY,c.scale=c.targetScale,Jt(),B(e),D(),_e(e),e.links.length>0&&ye(e),N&&N())}var kt=`
...
`;var Ee=class{constructor(n){this.starProgram=null;this.nebulaProgram=null;this.stars=[];this.starCount=1500;this.animationId=null;this.startTime=Date.now();this.starLocations={};this.nebulaLocations={};this.starBuffer=null;this.nebulaBuffer=null;this.animate=()=>{let n=(Date.now()-this.startTime)/1e3;this.gl.clearColor(0,0,.05,1),this.gl.clear(this.gl.COLOR_BUFFER_BIT),this.gl.enable(this.gl.BLEND),this.gl.blendFunc(this.gl.SRC_ALPHA,this.gl.ONE_MINUS_SRC_ALPHA),this.renderNebula(n),this.renderStars(n),this.animationId=requestAnimationFrame(this.animate)};this.canvas=document.createElement("canvas"),this.canvas.id="galaxy-canvas",this.canvas.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100vw;
