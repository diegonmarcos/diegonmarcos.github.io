...
# ║                                                                  ║
# ║   Source : 1_cicd/src/scripts/front-sw-register.sh
...
# `9_others/src/templates/sw-register-snippet.html` so the markup is
...
SNIPPET="$REPO_ROOT/1_cicd/dist/templates/sw-register-snippet.html"
[ -f "$SNIPPET" ] || SNIPPET="$REPO_ROOT/9_others/src/templates/sw-register-snippet.html"
