...
# ║                                                                  ║
# ║   Source : 1_configs/src/gha/scripts/front-sw-rollout.sh
...
INIT_SCRIPT="$REPO_ROOT/1_configs/dist/scripts/front-sw-init.sh"
[ -x "$INIT_SCRIPT" ] || INIT_SCRIPT="$REPO_ROOT/1_configs/src/gha/scripts/front-sw-init.sh"
...
# `1_configs` and `_*` are tooling / hidden, not projects.
if [ "$#" -eq 0 ]; then
