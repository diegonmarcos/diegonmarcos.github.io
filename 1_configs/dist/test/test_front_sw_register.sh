...
# ║                                                                  ║
# ║   Source : 1_configs/src/test/test_front_sw_register.sh
...
ENGINE="$REPO_ROOT/1_configs/src/gha/scripts/front-sw-register.sh"
SNIPPET="$REPO_ROOT/1_configs/src/templates/sw-register-snippet.html"
