...
# ║                                                                  ║
# ║   Source : 9_others/test/test_engine_sw_roundtrip.sh
...
[ -x "$REPO_ROOT/1_cicd/src/scripts/_engine.sh" ] || fail "_engine.sh not executable"
...
ln -sf "$REPO_ROOT/1_cicd/src/scripts/_engine.sh" "$WORK/build.sh"
